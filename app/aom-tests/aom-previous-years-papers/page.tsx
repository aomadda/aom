...
const AOMPreviousYearsPapersPage = () => {
  const pathname = usePathname()

  return (
    <div className="min-h-screen bg-linear-to-br from-rose-50 via-orange-50 to-amber-50 py-8 sm:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center sm:mb-12">
          <h1 className="mb-4 bg-linear-to-r from-rose-600 via-orange-600 to-amber-600 bg-clip-text text-3xl font-bold text-transparent sm:mb-6 sm:text-4xl md:text-5xl lg:text-6xl">
            AOM Previous Years Papers
          </h1>
          ...
          {papers.map((paper) => {
            ...
            return (
              <Link key={paper.href} href={paper.href} className="group">
                ...
                >
                  <div className={`relative overflow-hidden bg-linear-to-r ${paper.color} p-4 sm:p-6`}>
                  ...
                  <div className="flex flex-1 flex-col p-4 sm:p-6">
                    ...
                    <div className="mt-auto border-t border-gray-200 pt-4">
                      <div
                        className={`inline-flex items-center bg-linear-to-r ${paper.color} bg-clip-text text-sm font-semibold text-transparent`}
                      >
                        Open test
                        <svg
        ...
        <div className="mt-12 text-center">
          <div className="inline-block rounded-xl border border-white/20 bg-white/60 p-6 shadow-lg backdrop-blur-sm">
            <p className="text-sm text-gray-600">
              <span className="font-semibold text-rose-600">{papers.length}</span> AOM previous
              years papers available
            </p>
          </div>
        </div>
      </div>
...
export default AOMPreviousYearsPapersPage
