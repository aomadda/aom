...
const comparisonRows = [
  {
    sno: '1.',
    slip: 'Protects the block section.',
    catch: 'It protects station section/station.',
  },
  {
    sno: '2.',
    slip: 'It is provided where falling gradient towards block section is steeper than 1 in 100.',
    catch: 'It is provided where falling gradient towards station (section) is steeper than 1 in 80.',
  },
  {
    sno: '3.',
    slip: 'It prevents vehicles at station escaping onto the main line.',
    catch: 'It catches vehicles from adjacent station or block section.',
  },
  {
    sno: '4.',
    slip: 'It is a short siding.',
    catch: 'It is a lengthy siding.',
  },
  {
    sno: '5.',
    slip: 'Outermost point of the station will be a trailing point if provided.',
    catch: 'Outermost point of the station will be a facing point if provided.',
  },
]

const commonPoints = [
  'Normal setting points is for Slip/Catch siding.',
  'Both sidings shall not be used for shunting or stabling purpose.',
  'Interlocking with block instrument is compulsory.',
  'Key can be extracted only when Block Instrument is in TCF/TGT.',
  'Operation procedure of these shall be incorporated in SWR.',
]

const CatchSlipSidingPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <CornerDownRight className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Differences Between Slip Siding and Catch Siding (G.R./S.R. 3.50)
            </h1>
        ...
        >
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-6 sm:px-8 sm:py-7">
            ...
            <h2 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Common Points for Both Slip Siding and Catch Siding
            </h2>
          </header>

          <ol className="space-y-3 px-5 py-7 sm:px-8 sm:py-9">
            {commonPoints.map((text, index) => (
              <li
                key={index}
...
export default CatchSlipSidingPage
