...
const points: Point[] = [
  {
    text: 'On a double line section, if for any reason other than introduction of temporary single line working, it becomes necessary to run a train against the established direction of traffic, the line shall be blocked.',
  },
  {
    text: 'The authority is in form No. T/J.602 which contains the following precautions:',
    sub: [
      {
        label: 'a.',
        text: 'Speed - 15 Kmph when view is clear and 8 Kmph when view is not clear.',
      },
      { label: 'b.', text: 'Ascertain the condition of the train over the adjacent line.' },
      {
        label: 'c.',
        text: 'To look out for possible obstruction and take action accordingly.',
      },
      { label: 'd.', text: 'Report at next station.' },
    ],
  },
  {
    text: 'The SM of the other station shall not permit any obstruction outside the outermost points.',
  },
  { text: 'LP may return to same station if unsafe to proceed.' },
  {
    text: 'The Loco Pilot shall also certify in writing whether the line is clear for introduction of TSL working or not. Then SM can introduce the TSL working.',
  },
  { text: 'Only one train will be permitted.' },
  { text: 'Passenger carrying train is not allowed on Block Ticket.' },
]

const BlockTicketPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <Ticket className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
...
export default BlockTicketPage
