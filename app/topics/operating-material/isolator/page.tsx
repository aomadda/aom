...
const points = [
  "‗Switch, interconnecting section or Isolator‘ means a switch used for connecting or disconnecting adjacent elementary sections of overhead equipment.",
  'In emergency, SM shall operate switches as per specific direction of the TPC.',
  'Every Station Master shall be fully aware of the location of the isolator switches provided for the control of power supply to overhead equipment at the station or near the cabin and shall be conversant with the correct method of opening and closing the same in an emergency.',
  'Every Station Master shall be trained in the operation of section and siding switches in an emergency.',
  'The Station Masters shall be examined for their competency in operating these switches once in three years and competency certificate issued by DEE/Tr.D or his authorized Inspector.',
  'The Station Master who holds a certificate of competency shall only be posted at such stations where these switches have been provided.',
  'They shall lock the switches in the position advised by the TPC and shall not part with the key until it is cleared by the staff of the traction department.',
  'Section switches are located as indicated in the diagram annexed to SWR and general sectioning diagram.',
  'These diagrams show the distinguishing numbers of section switches, the stations they control and the location of each switch.',
]
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <ZapOff className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
