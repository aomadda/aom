...
const points = [
  'It is a self-propelled vehicle which can run on Railway track and as well as on road.',
  'It shall be treated and signaled as a train.',
  'In case of IB Signalling both the section treated as one and worked.',
  'Will run on both track and road in section where maintenance work is done.',
  'Run under supervision of SSE/SE/JE. P.Way who shall be in charge.',
  'Incharge is responsible for traffic block, protection and movement of RRV.',
  'Operator undergoes Pro. ALP training at ZRTI/MLY.',
  'Competency certificate issued valid for 3 years and renewed in the refresher course.',
  'He shall also possess heavy vehicle driving license for road vehicles.',
  "‗ON‘ tracking and ‗OFF‘ tracking can be done both at the stations and at the LC gates.",
  "‗ON‘ tracking and ‗OFF‘ tracking shall not be done during the failure of telephone communication at manned level crossing gate.",
  "The incharge shall give a message supported by PN whenever it has to be ‗off‘ track at the LC gate.",
  "If it has to be ‗on‘ tracking then the incharge shall obtain permission of SM and can place on track only after receiving PN from the SM.",
  "SM before giving permission for ‗on‘ tracking shall take necessary precautions.",
  'Maximum of seven persons including operator are permitted.',
  'Maximum Speed shall be 80 Kmph on road and 60 Kmph on rail in forward direction and 10 Kmph in reverse direction.',
]

const RailRoadVehiclePage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <CarFront className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Short Notes on RRV (Rail-cum-Road Vehicle) (S.R. 15.27.9)
            </h1>
          ...
          <div className="px-5 py-7 sm:px-8 sm:py-9">
            <div className="flex gap-2.5 rounded-2xl border border-slate-600/40 bg-slate-900/40 p-4 ring-1 ring-white/4 sm:p-5">
              ...
              <p className="text-[15px] leading-[1.75] text-slate-300 sm:text-base">
                Maximum speed shall be 80 Kmph on road and 60 Kmph on rail in forward direction and
                10 Kmph in reverse direction.
              </p>
            </div>
          </div>
        </article>
...
export default RailRoadVehiclePage
