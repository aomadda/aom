...
const items = [
  {
    roman: 'i',
    text: 'When a train leaving a station is guided by only one starting signal, it becomes the Last Stop Signal (LSS) of the station and is called the Starter.',
  },
  {
    roman: 'ii',
    text: 'Where starters are provided for individual lines, they shall be fixed so as to protect the first facing point or the fouling mark.',
  },
  {
    roman: 'iii',
    text: 'Provision of Starter is compulsory at class ‗B‘ station on double line and at a class ‗A‘ station.',
  },
  {
    roman: 'iv',
    text: 'At a station, if a single starter is provided for a group of two or more lines, it is called Common Starter.',
  },
  {
    roman: 'v',
    text: 'If a starter is provided between first starter and advanced starter at a converging junction protecting the points, it is called as Intermediate Starter.',
  },
  {
    roman: 'vi',
    text: 'If a bracketed or a single arm with a route indicator is provided at diverging lines, it is called as Routing Starter.',
  },
  {
    roman: 'vii',
    text: 'When Advanced Starter is provided, Starters (free) can be taken off for shunting purpose.',
  },
]
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <Play className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
          ...
          <ul className="space-y-3 px-5 py-8 sm:px-10 sm:py-10">
            {items.map((item, index) => (
              ...
              >
                <span className="mt-0.5 inline-flex h-7 min-w-8 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-amber-400/25 to-orange-600/25 px-1.5 text-xs font-bold text-amber-100 ring-1 ring-amber-400/35">
                  {item.roman}
                </span>
...
export default StarterSignalPage
