...
const points = [
  'In case of fire, the first duty of any railway servant is to save lives and property.',
  'The train shall be stopped at once.',
  'Detach the front portion of the vehicle behind the one on fire and move the front portion to a safe distance.',
  'Then detach the vehicle on fire and move the front portion again to a safe distance.',
  'In case of CBC coaches, the Guard or Assistant Loco Pilot, whoever nearer to the affected coach, shall unlock the CBC operating handle and open the couplings for detaching affected coaches. The CBC operating handle key is provided as personal equipment of Loco Pilot and Guard.',
  'If the train is with vestibuled stock, before isolating, vestibule connections shall be disconnected.',
  'The safety of the passengers shall first be attended to, by opening emergency windows wherever provided.',
  'The guard shall switch off electric connections.',
  'Every effort shall be made to extinguish the fire by using fire extinguishers, water and soil/sand.',
  'In electrified section, water should not be used and special type of the extinguishers shall be used. Fire extinguishers will be available in loco (4), each AC coach (2), pantry car (4), each SLR (2).',
  'If fire is not extinguished, ask for fire brigade through SM/SCOR.',
  'Fire in a goods vehicle: Efforts must be made to extinguish fire using earth, green grass, water, soda, etc.',
  'If fire cannot be extinguished, guard shall collect wagon labels and samples of goods, and make a special report.',
  'SM shall send report with brief particulars of damage to CCI, SM of destination, DRM and CCM.',
]

const FireOnTrainPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Fire on Passenger Coach in Mid-Section (G.R./S.R. 6.10)
            </h1>
...
export default FireOnTrainPage
