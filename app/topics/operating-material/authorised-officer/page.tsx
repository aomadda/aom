...
const points = [
  'Means the person who is duly empowered by general or special order of the Railway Administration, either by name or by virtue of his office, to issue instructions or to do any other thing. (G.R. 1.02(5))',
  'SR 1.02.5: The Principal Chief Operations Manager is the authorized officer and is empowered to issue, amend or alter subsidiary rules.',
  'Authorised Officer is a person empowered by Railway Administration by general or special order.',
  'Railway Administration has given power either to a particular person or a particular post.',
  'At present, PCOM Sri B. Nagya (Principal Chief Operations Manager) is the authorized officer of South-Central Railway.',
  'He is authorized to issue subsidiary rules and special instructions depending on the situation and necessity.',
]

const AuthorisedOfficerPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <BadgeCheck className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
...
export default AuthorisedOfficerPage
