...
const points = [
  ...
  'Caution Order mentioning preceding / following units & to maintain a gap of 150 mts.',
  'Each unit shall maintain 15 / 8 kmph.',
]

const IntegratedBlockPage = () => {
  return (
...
export default IntegratedBlockPage
