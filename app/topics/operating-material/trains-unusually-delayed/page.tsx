...
const points = [
  'Trains are said to be unusually delayed when a passenger carrying train does not arrive within 10 minutes and goods trains within 20 minutes after normal running time.',
  'Guard and Loco Pilot of train shall give information to nearest SM/TPC/SCOR through available means of communication.',
  'SM shall advise SM in rear and SCOR.',
  'SM shall stop trains from either end and on adjacent lines.',
  'Warn Loco Pilots and Guards proceeding on adjacent line by issuing suitable caution orders.',
  'The above action may be taken earlier also if necessary.',
  'Arrange to send competent Railway servant into block section to get information of whereabouts and condition of train and nature of assistance required.',
  'Take necessary action as situation demands.',
  'SCOR shall immediately alert stations where ART & MRT are located to be in readiness.',
]

const TrainsUnusuallyDelayedPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Trains Unusually Delayed (G.R. 6.04)
            </h1>
...
export default TrainsUnusuallyDelayedPage
