...
const points = [
  'The Loco Pilot shall keep first portion on run if possible until the rear portion comes to a stand.',
  'Loco Pilot shall sound —o —o whistle to inform Guard.',
  'If it is necessary to proceed, act as per the aspects of the gate/station signals.',
  'Guard shall apply hand brake.',
  'Loco Pilot of banking engine if available shall stop rear portion and give —o —o.',
  'The Guard shall indicate the parting by waving in repeated motions a green flag by day or a white light by night up and down vertically as high and as low as possible.',
  'If both the portions have come to a stand, the guard shall protect the rear portion as per the rules and take necessary precautions to secure the vehicles.',
  'If it is possible and safe to couple the portions, the train shall be coupled with due caution; otherwise, it shall be worked in two portions by issuing T/609.',
  'If it is necessary to proceed to station ahead, Loco Pilot shall give —o —o whistle repeatedly.',
  'SM shall admit the train on a vacant line, place 3 detonators to attract the attention of Guard and try to stop second portion by applying brakes, by heaping up earth, or divert it to a vacant loop or siding line.',
  'If SM notices train parting, he shall wave a green flag by day or a white light by night up and down vertically as high and as low as possible.',
  'Tonnage shall be jointly checked by the guard and Loco Pilot and also by SM.',
]

const TrainPartingPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Train Parted in Block Section (G.R./S.R. 6.08)
            </h1>
...
export default TrainPartingPage
