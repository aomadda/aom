...
const points = [
  'When Loco Pilot enters the block section without authority to proceed or with improper authority to proceed, he shall immediately stop the train.',
  'That train shall be treated as an obstruction in the block section and protected as such in accordance with Rule 6.03.',
  'Guard shall send the report of occurrence, explaining the circumstances, to the nearest station through Assistant Loco Pilot.',
  'When the report is sent to station in rear, the Station Master will issue PLCT to proceed to the next station, duly suspending the Block working.',
  'In case the report is sent to the station ahead, the SM shall immediately inform the Control, and SM of other end of the block section, and send Caution Order as Authority for the train to proceed to the station.',
  'On arrival of the train, the SM shall intimate the station at the other end of the section supported by a Private Number to the effect that the train has arrived complete.',
]

const LocoPilotEnteredWithoutAtpPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Loco Pilot Entered Block Section Without ATP (G.R./S.R. 6.06)
            </h1>
...
export default LocoPilotEnteredWithoutAtpPage
