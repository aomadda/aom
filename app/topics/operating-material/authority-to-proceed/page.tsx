...
const points = [
  'Means the authority given to the Loco Pilot of a train, under the system of working, to enter the block section with his train. (G.R. 1.02(6))',
  'It is the authority given to the Loco Pilot of a train, under the system of working, to enter the block section with his train.',
  'It is an important document for loco pilot. He should not start his train without possessing ATP.',
  'It may be taking off last stop signal (single line token less and double line sections) or token (single line token sections) or a line clear ticket or a written document under special instructions.',
  'Loco pilot must ensure that correct authority to proceed is issued to him.',
]

const AuthorityToProceedPage = () => {
  return (
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-amber-400/25 to-orange-600/30 ring-1 ring-amber-400/40 shadow-lg shadow-amber-950/40 animate-[soft-pulse_3.5s_ease-in-out_infinite]">
              <FileCheck className="h-7 w-7 text-amber-200" strokeWidth={1.75} />
            </div>
...
export default AuthorityToProceedPage
