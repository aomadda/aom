...
const points = [
  'When an engine is disabled, the Guard shall ascertain from the Loco Pilot whether relief engine is required or not.',
  'If the Loco Pilot expects that putting the engine in working order will take more than 5 minutes, he will request Guard to arrange for a relief engine.',
  ...
  'If Guard / Loco Pilot cannot contact Station Masters/SCOR/TPC telephonically, Assistant Loco Pilot/Guard shall walk to the nearest station or send the message through the Loco Pilot of a train proceeding on adjacent line and ask for relief engine.',
        ...
        <article className="overflow-hidden rounded-3xl border border-slate-500/30 bg-slate-900/50 shadow-[0_24px_80px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/6 backdrop-blur-xl animate-[fade-up_0.7s_ease-out]">
          <header className="relative border-b border-amber-500/15 bg-linear-to-br from-slate-900/90 via-slate-900/70 to-amber-950/30 px-5 py-8 sm:px-10 sm:py-10">
            ...
            <h1 className="text-center text-xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-100 via-orange-100 to-yellow-100 sm:text-2xl md:text-3xl leading-snug">
              Train Engine Disabled in the Block Section (S.R. 6.05)
            </h1>
...
export default TrainEngineDisabledPage
