...
const NumbersWisePage = () => {
  const numbers: NumberItem[] = [
    ...
    {
      question: 'The minimum number of Gatekeepers at a level crossing declared as Special Class of Level Crossing is ______',
      answer: '3',
      category: '3'
    },
    {
...
export default NumbersWisePage