...
const StationWorkingRulesAppendixPage = () => {
                  ...
                  {appendix.notes && appendix.notes.length > 0 && (
                    <div className="space-y-2">
                      {appendix.notes.map((note, noteIdx) => (
                        <div
                          key={noteIdx}
                          className="group p-3 rounded-lg border border-slate-700 hover:border-blue-500 hover:shadow-md transition-all duration-300 bg-linear-to-r from-slate-800 to-slate-700"
                        >
...
export default StationWorkingRulesAppendixPage