...
const CATEGORY_ID = 'commercial-department'
const CATEGORY_TITLE = 'Commercial Department'
const CATEGORY_COLOR = 'from-purple-500 to-indigo-600'
const CATEGORY_QUIZZES = commercialDepartmentQuizzes.quizzes
const RESULTS_STORAGE_KEY = 'cd_quiz_results'
const SESSION_STORAGE_KEY = 'cd_quiz_session'
...
export default function CommercialDepartmentQuiz() {
  ...
  if (!sessionReady || loadingProgress) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-purple-50 to-indigo-50 px-4">
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-purple-50 to-indigo-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            href="/quizzes"
            className="inline-flex rounded-full bg-linear-to-r from-purple-600 to-indigo-600 px-6 py-2.5 font-medium text-white"
          >
            Back to Quizzes
          </Link>
        </div>
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-purple-50 to-indigo-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-purple-500 to-indigo-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-purple-600 to-indigo-700 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-purple-700 hover:to-indigo-800 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Quizzes
              </button>
              <button
  ...
  if (isCurrentCompleted && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-purple-50 to-indigo-50 px-3 py-6 sm:px-4 sm:py-8">
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-purple-500 to-indigo-600 transition-all duration-300 ease-out sm:h-2"
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-purple-600 to-indigo-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-purple-700 hover:to-indigo-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
