...
export default function GeneralSubsidiaryRulesQuiz() {
  ...
  if (!quizActive && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 px-4 py-8 sm:px-4 sm:py-12">
      ...
      <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-2xl shadow-blue-950/10">
            <div className="relative overflow-hidden bg-linear-to-r from-slate-950 via-blue-950 to-purple-950 px-6 py-8 text-center sm:px-10 sm:py-10">
              ...
              <div className="relative mx-auto mt-4 h-1 w-16 rounded-full bg-linear-to-r from-blue-400 to-purple-300" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation ? (
                      <div className="mt-3 rounded-2xl border border-blue-100 bg-linear-to-br from-blue-50 to-purple-50 p-4">
