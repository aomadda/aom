...
export default function GeneralSubsidiaryRulesQuiz() {
  ...
  const categoryData = {
    ...
    description: 'Test your knowledge of General & Subsidiary Rules for Indian Railways',
    color: 'from-blue-500 to-blue-600',
    quizzes: generalSubsidiaryRulesQuizzes.quizzes
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'general-subsidiary-rules')
