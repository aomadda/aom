...
const CATEGORY_COLOR = 'from-red-500 to-red-600'
const CATEGORY_QUIZZES = accidentManualQuizzes.quizzes
const RESULTS_STORAGE_KEY = 'am_quiz_results'
const SESSION_STORAGE_KEY = 'am_quiz_session'
...
export default function AccidentManualQuiz() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-red-50 to-orange-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            href="/quizzes"
            className="inline-flex rounded-full bg-linear-to-r from-red-600 to-orange-600 px-6 py-2.5 font-medium text-white"
          >
            Back to Quizzes
          </Link>
        </div>
  ...
  if (!quizActive && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-red-50 to-orange-50 px-3 py-8 sm:px-4 sm:py-12">
      ...
      <div className="min-h-screen bg-linear-to-br from-red-50 to-orange-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-red-500 to-orange-600 sm:mb-6 sm:h-32 sm:w-32">
                <div className="text-center">
                  <div className="text-2xl font-bold text-white sm:text-3xl">{percentage}%</div>
                  <div className="text-xs text-red-100 sm:text-sm">Score</div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-red-600 to-red-700 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-red-700 hover:to-red-800 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Quizzes
              </button>
              <button
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-2xl shadow-rose-950/10">
            <div className="relative overflow-hidden bg-linear-to-r from-slate-950 via-rose-950 to-orange-950 px-6 py-8 text-center sm:px-10 sm:py-10">
              ...
              <div className="relative mx-auto mt-4 h-1 w-16 rounded-full bg-linear-to-r from-rose-400 to-orange-300" />
            </div>
  ...
  if (isCurrentCompleted && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-red-50 to-orange-50 px-3 py-6 sm:px-4 sm:py-8">
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="mb-3 flex flex-wrap items-center justify-center gap-2 text-gray-600 sm:mb-4">
              <span className="rounded-full bg-red-100 px-2 py-1 text-xs font-medium text-red-800 sm:px-3 sm:text-sm">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-red-500 to-orange-600 transition-all duration-300 ease-out sm:h-2"
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option, index) => {
                ...
                if (answered && isSelected && !isCorrectAnswer) {
                  ...
                  optionClasses +=
                    ' border-gray-300 hover:border-red-300 hover:bg-red-50 hover:shadow-sm cursor-pointer'
                } else {
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-red-600 to-orange-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-red-700 hover:to-orange-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
