...
import { currentAffairsQuiz } from '@/assets/general-awareness/quizzes/current-affairs';
...
export default function CurrentAffairsQuizPage() {
  ...
  const categoryData = {
    ...
    description:
      'Stay sharp on recent events, national and international news, and exam-relevant developments.',
    color: 'from-amber-600 to-orange-600',
    quizzes: currentAffairsQuiz.quizzes,
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'general-awareness-current-affairs')
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-amber-50 to-orange-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-amber-600 to-orange-600 rounded-full mb-4 sm:mb-6 shadow-lg ring-4 ring-white/80">
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation && (
                      <div className="text-sm text-orange-900 mt-2 p-2 bg-amber-50 rounded border border-amber-100">
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-50 to-orange-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex items-center justify-center text-gray-600 mb-3 sm:mb-4 flex-wrap gap-x-2 gap-y-1">
              <span className="bg-amber-100 text-orange-900 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div
                className="bg-linear-to-r from-amber-500 to-orange-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
