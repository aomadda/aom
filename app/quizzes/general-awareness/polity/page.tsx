...
import { polityQuiz } from '@/assets/general-awareness/quizzes/polity';
...
export default function PolityQuizPage() {
  ...
  const categoryData = {
    title: 'Indian Polity',
    description:
      'Test your grasp of the Indian Constitution, government structure, and core polity topics for competitive exams.',
    color: 'from-indigo-600 to-blue-600',
    quizzes: polityQuiz.quizzes,
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'general-awareness-polity')
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-indigo-50 to-blue-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            {/* Score Display */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-indigo-600 to-blue-600 rounded-full mb-4 sm:mb-6 shadow-lg ring-4 ring-white/80">
              ...
              <p className="text-gray-500 text-xs sm:text-sm mt-2">{categoryData.title} — {formatQuizLabel(currentQuizId)}</p>
            </div>
                ...
                {Object.keys(categoryData.quizzes).map((quizId) => {
                  ...
                  return (
                    <div key={quizId} className={`bg-linear-to-br from-gray-50 to-gray-100 rounded-lg py-6 lg:px-6 px-2 border-2 transition-all duration-300 transform hover:scale-105 ${
                        isCurrentQuiz ? 'border-indigo-400 shadow-lg' : 'border-gray-400 hover:shadow-lg'
                      }`}>
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 to-blue-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex items-center justify-center text-gray-600 mb-3 sm:mb-4">
              <span className="bg-indigo-100 text-indigo-900 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div 
                className="bg-linear-to-r from-indigo-500 to-blue-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option, index) => {
                ...
                if (isSelected) {
                  ...
                  optionClasses += ' border-gray-300 hover:border-indigo-300 hover:bg-indigo-50/80 hover:shadow-sm';
                }
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-6 sm:px-8 py-2 sm:py-3 bg-linear-to-r from-indigo-600 to-blue-600 text-white rounded-md sm:rounded-lg hover:from-indigo-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center text-sm sm:text-base"
            >
