...
const CATEGORY_ID = 'general-awareness-art-culture'
const CATEGORY_TITLE = 'Art & Culture'
const CATEGORY_COLOR = 'from-rose-600 to-fuchsia-600'
const CATEGORY_QUIZZES = artCultureQuizzes.quizzes
const RESULTS_STORAGE_KEY = 'ga_art_culture_quiz_results'
const SESSION_STORAGE_KEY = 'ga_art_culture_quiz_session'
...
export default function ArtCultureQuizPage() {
              ...
              >
                ...
                {isCompleted ? (
                  <button
                    ...
                    className="flex w-full items-center justify-center rounded-full bg-linear-to-r from-rose-600 to-fuchsia-600 px-4 py-2 font-medium text-white shadow-lg transition-all duration-200 hover:from-rose-700 hover:to-fuchsia-700 hover:shadow-xl sm:px-6"
                  >
                    View Results
                  </button>
                ) : (
  ...
  if (!sessionReady || loadingProgress) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-rose-50 to-fuchsia-50 px-4">
        <div className="rounded-2xl bg-white px-8 py-10 text-center shadow-xl">
          <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-b-2 border-rose-600" />
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-rose-50 to-fuchsia-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            href="/quizzes/general-awareness"
            className="inline-flex rounded-full bg-linear-to-r from-rose-600 to-fuchsia-600 px-6 py-2.5 font-medium text-white"
          >
            Back to General Awareness
          </Link>
        </div>
  ...
  if (!quizActive && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-rose-50 to-fuchsia-50 px-4 py-8 sm:px-4 sm:py-12">
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-rose-50 to-fuchsia-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-rose-600 to-fuchsia-600 sm:mb-6 sm:h-32 sm:w-32">
                <div className="text-center">
                  <div className="text-2xl font-bold text-white sm:text-3xl">{percentage}%</div>
                  <div className="text-xs text-rose-100 sm:text-sm">Score</div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-rose-600 to-fuchsia-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-rose-700 hover:to-fuchsia-700 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to General Awareness
              </button>
              <button
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-2xl shadow-rose-950/10">
            <div className="relative overflow-hidden bg-linear-to-r from-slate-950 via-rose-950 to-fuchsia-950 px-6 py-8 text-center sm:px-10 sm:py-10">
              <div className="pointer-events-none absolute -left-16 top-0 h-40 w-40 rounded-full bg-rose-500/20 blur-3xl" />
              <div className="pointer-events-none absolute -right-10 bottom-0 h-36 w-36 rounded-full bg-fuchsia-400/20 blur-3xl" />
              <h3 className="relative text-2xl font-bold tracking-tight text-white sm:text-3xl">
                Quiz Summary & Explanation
              </h3>
              <div className="relative mx-auto mt-4 h-1 w-16 rounded-full bg-linear-to-r from-rose-400 to-fuchsia-300" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation ? (
                      <div className="mt-3 rounded-2xl border border-rose-100 bg-linear-to-br from-rose-50 to-fuchsia-50 p-4">
                        <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-rose-700">
                          Explanation:
                        </div>
                        <p className="mt-1.5 whitespace-pre-line text-sm leading-relaxed text-rose-900">
                          {question.explanation}
                        </p>
                      </div>
                    ) : null}
  ...
  if (isCurrentCompleted && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-rose-50 to-fuchsia-50 px-3 py-6 sm:px-4 sm:py-8">
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-rose-600 to-fuchsia-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-rose-700 hover:to-fuchsia-700"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="mb-3 flex flex-wrap items-center justify-center gap-2 text-gray-600 sm:mb-4">
              <span className="rounded-full bg-rose-100 px-2 py-1 text-xs font-medium text-rose-800 sm:px-3 sm:text-sm">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-rose-600 to-fuchsia-600 transition-all duration-300 ease-out sm:h-2"
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option, index) => {
                ...
                if (answered && isSelected && !isCorrectAnswer) {
                  ...
                  optionClasses +=
                    ' border-gray-300 hover:border-rose-300 hover:bg-rose-50 hover:shadow-sm cursor-pointer'
                } else {
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {showCheck ? (
                          ...
                          <span className="text-xs font-medium text-gray-400 group-hover:text-rose-400">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-rose-600 to-fuchsia-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-rose-700 hover:to-fuchsia-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
