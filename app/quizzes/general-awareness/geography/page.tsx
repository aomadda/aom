...
import { geographyQuiz } from '@/assets/general-awareness/quizzes/geography';
...
export default function GeographyQuizPage() {
  ...
  const categoryData = {
    title: 'Geography',
    description:
      'Practice world geography, physical features, rivers, oceans, and map-based facts for competitive exams.',
    color: 'from-emerald-600 to-teal-600',
    quizzes: geographyQuiz.quizzes,
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'general-awareness-geography')
      ...
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-teal-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-emerald-600 to-teal-600 rounded-full mb-4 sm:mb-6 shadow-lg ring-4 ring-white/80">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              <div className="bg-emerald-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center border border-emerald-200">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-emerald-600 mb-1 sm:mb-2">{questions.length}</div>
                <div className="text-emerald-700 font-medium text-xs sm:text-sm lg:text-base">Total Questions</div>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation && (
                      <div className="text-sm text-emerald-800 mt-2 p-2 bg-emerald-50 rounded border border-emerald-100">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex items-center justify-center text-gray-600 mb-3 sm:mb-4 flex-wrap gap-x-2 gap-y-1">
              <span className="bg-emerald-100 text-emerald-900 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option, index) => {
                ...
                if (isSelected) {
                  ...
                  optionClasses += ' border-gray-300 hover:border-emerald-300 hover:bg-emerald-50/80 hover:shadow-sm';
                }
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {isSelected || (showExplanation && isCorrectAnswer) ? (
                          ...
                          <span className="text-xs font-medium text-gray-400 group-hover:text-emerald-600">{String.fromCharCode(65 + index)}</span>
                        )}
                      </div>
          ...
          <div className="flex justify-between items-center gap-3">
            ...
            <button
              ...
              className="px-6 sm:px-8 py-2 sm:py-3 bg-linear-to-r from-emerald-600 to-teal-600 text-white rounded-md sm:rounded-lg hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center text-sm sm:text-base"
            >
