...
const CATEGORY_ID = 'general-awareness-biology'
const CATEGORY_TITLE = 'Biology'
const CATEGORY_COLOR = 'from-sky-600 to-cyan-600'
const CATEGORY_QUIZZES = biologyQuiz.quizzes
const RESULTS_STORAGE_KEY = 'ga_biology_quiz_results'
const SESSION_STORAGE_KEY = 'ga_biology_quiz_session'
...
export default function BiologyQuizPage() {
              ...
              >
                ...
                {isCompleted ? (
                  <button
                    ...
                    className="flex w-full items-center justify-center rounded-full bg-linear-to-r from-sky-600 to-cyan-600 px-4 py-2 font-medium text-white shadow-lg transition-all duration-200 hover:from-sky-700 hover:to-cyan-700 hover:shadow-xl sm:px-6"
                  >
                    View Results
                  </button>
                ) : (
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-sky-50 to-cyan-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            href="/quizzes/general-awareness"
            className="inline-flex rounded-full bg-linear-to-r from-sky-600 to-cyan-600 px-6 py-2.5 font-medium text-white"
          >
            Back to General Awareness
          </Link>
        </div>
  ...
  if (!quizActive && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-sky-50 to-cyan-50 px-4 py-8 sm:px-4 sm:py-12">
      ...
      <div className="min-h-screen bg-linear-to-br from-sky-50 to-cyan-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-sky-600 to-cyan-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-sky-600 to-cyan-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-sky-700 hover:to-cyan-700 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to General Awareness
              </button>
              <button
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-sky-600 to-cyan-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-sky-700 hover:to-cyan-700"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-sky-600 to-cyan-600 transition-all duration-300 ease-out sm:h-2"
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-sky-600 to-cyan-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-sky-700 hover:to-cyan-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
