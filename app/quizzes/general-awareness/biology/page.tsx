...
import { biologyQuiz } from '@/assets/general-awareness/quizzes/biology';
...
export default function BiologyQuizPage() {
  ...
  const categoryData = {
    title: 'Biology',
    description:
      'Practice cells, genetics, physiology, and core life-science facts for competitive exams.',
    color: 'from-sky-600 to-cyan-600',
    quizzes: biologyQuiz.quizzes,
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'general-awareness-biology')
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-sky-50 to-cyan-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-sky-600 to-cyan-600 rounded-full mb-4 sm:mb-6 shadow-lg ring-4 ring-white/80">
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation && (
                      <div className="text-sm text-sky-800 mt-2 p-2 bg-sky-50 rounded border border-sky-100">
                  ...
                  return (
                    <div
                      ...
                      className={`bg-linear-to-br from-gray-50 to-gray-100 rounded-lg py-6 lg:px-6 px-2 border-2 transition-all duration-300 transform hover:scale-105 ${
                        isCurrentQuiz ? 'border-sky-400 shadow-lg' : 'border-gray-400 hover:shadow-lg'
                      }`}
                    >
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-sky-50 to-cyan-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex items-center justify-center text-gray-600 mb-3 sm:mb-4 flex-wrap gap-x-2 gap-y-1">
              <span className="bg-sky-100 text-sky-900 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div
                className="bg-linear-to-r from-sky-500 to-cyan-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option, index) => {
                ...
                if (isSelected) {
                  ...
                  optionClasses += ' border-gray-300 hover:border-sky-300 hover:bg-sky-50/80 hover:shadow-sm';
                }
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {isSelected || (showExplanation && isCorrectAnswer) ? (
                          ...
                          <span className="text-xs font-medium text-gray-400 group-hover:text-sky-600">{String.fromCharCode(65 + index)}</span>
                        )}
                      </div>
