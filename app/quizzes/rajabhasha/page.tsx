...
const CATEGORY_ID = 'rajabhasha'
const CATEGORY_TITLE = 'Rajabhasha'
const CATEGORY_COLOR = 'from-green-500 to-emerald-600'
const CATEGORY_QUIZZES = rajabhashaQuizzes.quizzes
const RESULTS_STORAGE_KEY = 'rajabhasha_quiz_results'
const SESSION_STORAGE_KEY = 'rajabhasha_quiz_session'
...
export default function RajabhashaQuiz() {
  ...
  if (!quizActive && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50 px-4 py-8 sm:px-4 sm:py-12">
