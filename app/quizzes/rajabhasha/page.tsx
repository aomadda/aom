...
import { rajabhashaQuizzes } from '@/assets/rajabhasha';
...
export default function RajabhashaQuiz() {
  ...
  const categoryData = {
    title: 'Rajabhasha',
    description: 'Test your knowledge of Official Language (Hindi) Rules and Regulations',
    color: 'from-green-500 to-emerald-600',
    quizzes: rajabhashaQuizzes.quizzes
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          const categoryCompletedQuizzes = data.recentActivity
            ?.filter((quiz: { categoryId: string; quizId: string }) => quiz.categoryId === 'rajabhasha')
