...
const QUIZ_TITLE = 'Railway Recruitment Posting Promotion'
const SESSION_STORAGE_KEY = 'railway_recruitment_posting_promotion_quiz_session'
const RESULTS_STORAGE_KEY = 'railway_recruitment_posting_promotion_quiz_results'
...
export default function RailwayRecruitmentPostingPromotionQuiz() {
  ...
  const questions = useMemo(
    () =>
      (railwayRecruitmentPostingPromotionQuizzes.quizzes[
        'railway-recruitment-posting-promotion'
      ] || []) as QuizQuestion[],
    [],
  )
