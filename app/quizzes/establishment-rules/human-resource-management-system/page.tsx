...
const QUIZ_TITLE = 'Human Resource Management System (HRMS)'
const SESSION_STORAGE_KEY = 'human-resource-management-system_quiz_session'
const RESULTS_STORAGE_KEY = 'human-resource-management-system_quiz_results'
...
export default function HumanResourceManagementSystemQuiz() {
  ...
  const questions = useMemo(
    () => (humanResourceManagementSystem['human-resource-management-system'] || []) as QuizQuestion[],
    [],
  )
