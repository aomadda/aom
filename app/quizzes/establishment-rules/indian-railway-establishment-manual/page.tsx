...
const QUIZ_TITLE = 'Indian Railway Establishment Manual'
const SESSION_STORAGE_KEY = 'indian_railway_establishment_manual_quiz_session'
const RESULTS_STORAGE_KEY = 'indian_railway_establishment_manual_quiz_results'
...
export default function IndianRailwayEstablishmentManualQuiz() {
  ...
  const questions = useMemo(
    () =>
      (indianRailwayEstablishmentManualQuizzes.quizzes['indian-railway-establishment-manual'] ||
        []) as QuizQuestion[],
    [],
  )
