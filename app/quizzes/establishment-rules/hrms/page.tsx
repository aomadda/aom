...
export default function HRMSQuiz() {
  ...
  const categoryData = {
    ...
    quizzes: {
      'hrms': (establishmentRulesQuizzes.quizzes['hrms'] as QuizQuestion[]) || []
    }
  };
  
  const currentQuizId = 'hrms';
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                ...
                className="flex-1 bg-linear-to-r from-teal-600 to-cyan-700 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-full sm:rounded-full hover:from-teal-700 hover:to-cyan-800 transition-all duration-200 font-medium shadow-lg hover:shadow-xl text-sm sm:text-base"
              >
