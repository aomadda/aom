...
const QUIZ_ID = 'hrms'
const CATEGORY_ID = 'hrms'
const QUIZ_TITLE = 'Human Resource Management System (HRMS)'
const SESSION_STORAGE_KEY = 'hrms_quiz_session'
const RESULTS_STORAGE_KEY = 'hrms_quiz_results'
...
export default function HRMSQuiz() {
  ...
  const questions = useMemo(
    () => (establishmentRulesQuizzes.quizzes['hrms'] || []) as QuizQuestion[],
    [],
  )
