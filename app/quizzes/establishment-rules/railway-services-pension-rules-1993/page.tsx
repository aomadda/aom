...
const QUIZ_TITLE = 'Railway Services Pension Rules 1993'
const SESSION_STORAGE_KEY = 'railway_services_pension_rules_1993_quiz_session'
const RESULTS_STORAGE_KEY = 'railway_services_pension_rules_1993_quiz_results'
...
export default function RailwayServicesPensionRules1993Quiz() {
  ...
  const questions = useMemo(
    () =>
      (railwayServicesPensionRules1993Quizzes.quizzes['railway-services-pension-rules-1993'] ||
        []) as QuizQuestion[],
    [],
  )
