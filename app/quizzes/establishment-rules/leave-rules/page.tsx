...
const QUIZ_ID = 'leave-rules'
const CATEGORY_ID = 'leave-rules'
const QUIZ_TITLE = 'Railway Servants (Leave) Rules 1949'
const SESSION_STORAGE_KEY = 'leave_rules_quiz_session'
const RESULTS_STORAGE_KEY = 'leave_rules_quiz_results'
...
export default function LeaveRulesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['leave-rules'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-purple-100 pt-2 text-purple-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-purple-50 to-violet-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
