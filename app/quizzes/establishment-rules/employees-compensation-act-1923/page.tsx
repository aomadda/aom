...
const QUIZ_TITLE = 'Employees Compensation Act 1923'
const SESSION_STORAGE_KEY = 'employees_compensation_act_1923_quiz_session'
const RESULTS_STORAGE_KEY = 'employees_compensation_act_1923_quiz_results'
...
export default function EmployeesCompensationAct1923Quiz() {
  ...
  const questions = useMemo(
    () =>
      (employeesCompensationAct1923Quizzes.quizzes['employees-compensation-act-1923'] ||
        []) as QuizQuestion[],
    [],
  )
