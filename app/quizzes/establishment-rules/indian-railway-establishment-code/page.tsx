...
const QUIZ_TITLE = 'Indian Railway Establishment Code'
const SESSION_STORAGE_KEY = 'indian_railway_establishment_code_quiz_session'
const RESULTS_STORAGE_KEY = 'indian_railway_establishment_code_quiz_results'
...
export default function IndianRailwayEstablishmentCodeQuiz() {
  ...
  const questions = useMemo(
    () =>
      (indianRailwayEstablishmentCodeQuizzes.quizzes['indian-railway-establishment-code'] ||
        []) as QuizQuestion[],
    [],
  )
