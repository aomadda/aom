...
const QUIZ_TITLE = 'Railway Servants (Pass) Rules 1986'
const SESSION_STORAGE_KEY = 'railway-servants-pass-rules-1986_quiz_session'
const RESULTS_STORAGE_KEY = 'railway-servants-pass-rules-1986_quiz_results'
...
export default function RailwayServantsPassRules1986Quiz() {
  ...
  const questions = useMemo(
    () =>
      (railwayServantsPassRules1986['railway-servants-pass-rules-1986'] || []) as QuizQuestion[],
    [],
  )
      ...
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-green-50 to-emerald-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            ...
            className="inline-flex rounded-full bg-linear-to-r from-green-500 to-green-600 px-6 py-2.5 font-medium text-white"
          >
      ...
      <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-green-500 to-green-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="mb-6 grid grid-cols-2 gap-4 sm:mb-8 sm:grid-cols-4 sm:gap-6">
              ...
              <div className="rounded-xl border border-green-200 bg-green-50 p-4 text-center sm:rounded-2xl sm:p-6">
                ...
                <div className="text-xs font-medium text-green-700 sm:text-sm">Total</div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-green-500 to-green-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-green-600 hover:to-green-700 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Establishment Rules
              </button>
              <button
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-2xl shadow-green-950/10">
            <div className="relative overflow-hidden bg-linear-to-r from-slate-950 via-green-950 to-emerald-950 px-6 py-8 text-center sm:px-10 sm:py-10">
              <div className="pointer-events-none absolute -left-16 top-0 h-40 w-40 rounded-full bg-green-500/20 blur-3xl" />
              ...
              <div className="relative mx-auto mt-4 h-1 w-16 rounded-full bg-linear-to-r from-green-400 to-emerald-300" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation ? (
                      <div className="mt-3 rounded-2xl border border-green-100 bg-linear-to-br from-green-50 to-emerald-50 p-4">
                        <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-green-700">
                          Explanation:
                        </div>
                        <p className="mt-1.5 text-sm leading-relaxed text-green-900">
                          {question.explanation}
                        </p>
                      </div>
                    ) : null}
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50 px-3 py-6 sm:px-4 sm:py-8">
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            <h1 className="mb-2 text-xl font-bold text-gray-800 sm:text-2xl">{QUIZ_TITLE}</h1>
            <p className="mb-1 text-sm font-medium text-green-700">This quiz is completed</p>
            <p className="mb-6 text-sm text-gray-600">
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-green-500 to-green-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-green-600 hover:to-green-700"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="mb-3 flex flex-wrap items-center justify-center gap-2 text-gray-600 sm:mb-4">
              ...
              <span
                className={`rounded-full px-2 py-1 font-mono text-xs font-semibold sm:px-3 sm:text-sm ${
                  timerUrgent ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-800'
                }`}
                aria-live="polite"
              >
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-green-500 to-green-600 transition-all duration-300 ease-out sm:h-2"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-green-500 to-green-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-green-600 hover:to-green-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
