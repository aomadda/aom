...
const QUIZ_ID = 'rest-rules'
const CATEGORY_ID = 'rest-rules'
const QUIZ_TITLE = 'Railway Servants (Rest) Rules 2005'
const SESSION_STORAGE_KEY = 'rest_rules_quiz_session'
const RESULTS_STORAGE_KEY = 'rest_rules_quiz_results'
...
export default function RestRulesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['rest-rules'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-pink-100 pt-2 text-pink-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-pink-50 to-rose-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
