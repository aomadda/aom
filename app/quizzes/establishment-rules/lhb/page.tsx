...
const QUIZ_ID = 'lhb'
const CATEGORY_ID = 'lhb'
const QUIZ_TITLE = 'Linke Hofmann Busch (LHB)'
const SESSION_STORAGE_KEY = 'lhb_quiz_session'
const RESULTS_STORAGE_KEY = 'lhb_quiz_results'
...
export default function LHBQuiz() {
  ...
  const questions = useMemo(
    () => {
      const raw =
        ((establishmentRulesQuizzes.quizzes as Record<string, QuizQuestion[]>)['lhb'] ||
          []) as QuizQuestion[]
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-orange-100 pt-2 text-orange-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-orange-50 to-amber-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
