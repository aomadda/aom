...
const QUIZ_TITLE = 'Railway Allowances'
const SESSION_STORAGE_KEY = 'railway_allowances_quiz_session'
const RESULTS_STORAGE_KEY = 'railway_allowances_quiz_results'
...
export default function RailwayAllowancesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (railwayAllowancesQuizzes.quizzes['railway-allowances'] || []) as QuizQuestion[],
    [],
  )
