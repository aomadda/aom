...
const QUIZ_ID = 'ops'
const CATEGORY_ID = 'ops'
const QUIZ_TITLE = 'Old Pension Scheme (OPS)'
const SESSION_STORAGE_KEY = 'ops_quiz_session'
const RESULTS_STORAGE_KEY = 'ops_quiz_results'
...
export default function OPSQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['ops'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-violet-100 pt-2 text-violet-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-violet-50 to-purple-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
