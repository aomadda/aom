...
const QUIZ_TITLE = 'Railway Quarters'
const SESSION_STORAGE_KEY = 'railway_quarters_quiz_session'
const RESULTS_STORAGE_KEY = 'railway_quarters_quiz_results'
...
export default function RailwayQuartersQuiz() {
  ...
  const questions = useMemo(
    () => (railwayQuartersQuizzes.quizzes['railway-quarters'] || []) as QuizQuestion[],
    [],
  )
