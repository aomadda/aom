...
const QUIZ_TITLE = 'Annual Performance Appraisal Report (APAR)'
const SESSION_STORAGE_KEY = 'annual-performance-appraisal-report_quiz_session'
const RESULTS_STORAGE_KEY = 'annual-performance-appraisal-report_quiz_results'
...
export default function AnnualPerformanceAppraisalReportQuiz() {
  ...
  const questions = useMemo(
    () =>
      (annualPerformanceAppraisalReport['annual-performance-appraisal-report'] ||
        []) as QuizQuestion[],
    [],
  )
      ...
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-teal-50 to-cyan-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            ...
            className="inline-flex rounded-full bg-linear-to-r from-teal-600 to-cyan-700 px-6 py-2.5 font-medium text-white"
          >
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-teal-600 to-cyan-700 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-teal-700 hover:to-cyan-800 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Establishment Rules
              </button>
              <button
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-teal-600 to-cyan-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-teal-700 hover:to-cyan-700"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-teal-600 to-cyan-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-teal-700 hover:to-cyan-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
