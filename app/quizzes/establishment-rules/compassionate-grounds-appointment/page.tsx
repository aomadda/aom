...
const QUIZ_TITLE = 'Compassionate Grounds Appointment (CGA)'
const SESSION_STORAGE_KEY = 'compassionate-grounds-appointment_quiz_session'
const RESULTS_STORAGE_KEY = 'compassionate-grounds-appointment_quiz_results'
...
export default function CompassionateGroundsAppointmentQuiz() {
  ...
  const questions = useMemo(
    () =>
      (compassionateGroundsAppointment['compassionate-grounds-appointment'] ||
        []) as QuizQuestion[],
    [],
  )
      ...
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-amber-50 to-orange-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            ...
            className="inline-flex rounded-full bg-linear-to-r from-amber-600 to-orange-700 px-6 py-2.5 font-medium text-white"
          >
      ...
      <div className="min-h-screen bg-linear-to-br from-amber-50 to-orange-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-amber-500 to-orange-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-amber-600 to-orange-700 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-amber-700 hover:to-orange-800 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Establishment Rules
              </button>
              <button
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-amber-500 to-orange-600 transition-all duration-300 ease-out sm:h-2"
