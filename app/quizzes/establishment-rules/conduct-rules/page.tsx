...
const QUIZ_ID = 'conduct-rules'
const CATEGORY_ID = 'conduct-rules'
const QUIZ_TITLE = 'Railway Servants (Conduct) Rules 1966'
const SESSION_STORAGE_KEY = 'conduct_rules_quiz_session'
const RESULTS_STORAGE_KEY = 'conduct_rules_quiz_results'
...
export default function ConductRulesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['conduct-rules'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-indigo-100 pt-2 text-indigo-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-indigo-50 to-slate-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
