...
const QUIZ_ID = 'ups'
const CATEGORY_ID = 'ups'
const QUIZ_TITLE = 'Unified Pension System (UPS)'
const SESSION_STORAGE_KEY = 'ups_quiz_session'
const RESULTS_STORAGE_KEY = 'ups_quiz_results'
...
export default function UPSQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['ups'] || []) as QuizQuestion[],
    [],
  )
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-rose-50 to-pink-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
