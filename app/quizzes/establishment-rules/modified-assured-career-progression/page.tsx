...
const QUIZ_TITLE = 'Modified Assured Career Progression'
const SESSION_STORAGE_KEY = 'modified_assured_career_progression_quiz_session'
const RESULTS_STORAGE_KEY = 'modified_assured_career_progression_quiz_results'
...
export default function ModifiedAssuredCareerProgressionQuiz() {
  ...
  const questions = useMemo(
    () =>
      (modifiedAssuredCareerProgressionQuizzes.quizzes['modified-assured-career-progression'] ||
        []) as QuizQuestion[],
    [],
  )
