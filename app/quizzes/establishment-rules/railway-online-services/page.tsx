...
const QUIZ_TITLE = 'Railway Online Services'
const SESSION_STORAGE_KEY = 'railway_online_services_quiz_session'
const RESULTS_STORAGE_KEY = 'railway_online_services_quiz_results'
...
export default function RailwayOnlineServicesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (railwayOnlineServicesQuizzes.quizzes['railway-online-services'] || []) as QuizQuestion[],
    [],
  )
