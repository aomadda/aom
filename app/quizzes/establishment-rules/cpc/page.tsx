...
const QUIZ_ID = 'cpc'
const CATEGORY_ID = 'cpc'
const QUIZ_TITLE = 'Central Pay Commission (CPC)'
const SESSION_STORAGE_KEY = 'cpc_quiz_session'
const RESULTS_STORAGE_KEY = 'cpc_quiz_results'
...
export default function CPCQuiz() {
  ...
  const questions = useMemo(
    () =>
      ((establishmentRulesQuizzes.quizzes as Record<string, QuizQuestion[]>)['cpc'] ||
        []) as QuizQuestion[],
    [],
  )
