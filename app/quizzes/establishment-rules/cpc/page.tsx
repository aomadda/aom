...
export default function CPCQuiz() {
  ...
  const categoryData = {
    ...
    quizzes: {
      'cpc': ((establishmentRulesQuizzes.quizzes as Record<string, QuizQuestion[]>)['cpc']) || []
    }
  };

  const currentQuizId = 'cpc';
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-emerald-100 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            {/* Score Display */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-emerald-500 to-emerald-600 rounded-full mb-4 sm:mb-6">
  ...
  if (questions.length === 0) {
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-emerald-100 py-8 sm:py-12 px-3 sm:px-4 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 mb-4">No questions available for CPC quiz yet.</p>
          <Link
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-50 to-emerald-100 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div
                className="bg-linear-to-r from-emerald-500 to-emerald-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-6 sm:px-8 py-2 sm:py-3 bg-linear-to-r from-emerald-600 to-emerald-700 text-white rounded-md sm:rounded-lg hover:from-emerald-700 hover:to-emerald-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-lg hover:shadow-xl flex items-center text-sm sm:text-base"
            >
