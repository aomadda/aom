...
const QUIZ_ID = 'pass-rules'
const CATEGORY_ID = 'pass-rules'
const QUIZ_TITLE = 'Railway Servants (Pass) Rules 1986'
const SESSION_STORAGE_KEY = 'pass_rules_quiz_session'
const RESULTS_STORAGE_KEY = 'pass_rules_quiz_results'
...
export default function PassRulesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['pass-rules'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-green-100 pt-2 text-green-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
