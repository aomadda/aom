...
const QUIZ_TITLE = 'Permanent Negotiating Machinery'
const SESSION_STORAGE_KEY = 'permanent_negotiating_machinery_quiz_session'
const RESULTS_STORAGE_KEY = 'permanent_negotiating_machinery_quiz_results'
...
export default function PermanentNegotiatingMachineryQuiz() {
  ...
  const questions = useMemo(
    () =>
      (permanentNegotiatingMachineryQuizzes.quizzes['permanent-negotiating-machinery'] ||
        []) as QuizQuestion[],
    [],
  )
