...
const QUIZ_ID = 'nps'
const CATEGORY_ID = 'nps'
const QUIZ_TITLE = 'National Pension System (NPS)'
const SESSION_STORAGE_KEY = 'nps_quiz_session'
const RESULTS_STORAGE_KEY = 'nps_quiz_results'
...
export default function NPSQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['nps'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-slate-100 pt-2 text-slate-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 to-gray-100 px-4 px-3 py-6 sm:px-4 sm:py-8">
