...
const QUIZ_TITLE = 'Staff Benefit Fund'
const SESSION_STORAGE_KEY = 'staff_benefit_fund_quiz_session'
const RESULTS_STORAGE_KEY = 'staff_benefit_fund_quiz_results'
...
export default function StaffBenefitFundQuiz() {
  ...
  const questions = useMemo(
    () => (staffBenefitFundQuizzes.quizzes['staff-benefit-fund'] || []) as QuizQuestion[],
    [],
  )
