...
const QUIZ_ID = 'rti-act-2005'
const CATEGORY_ID = 'rti-act-2005'
const QUIZ_TITLE = 'Right to Information Act 2005'
const SESSION_STORAGE_KEY = 'rti_act_2005_quiz_session'
const RESULTS_STORAGE_KEY = 'rti_act_2005_quiz_results'
...
export default function RTIAct2005Quiz() {
  ...
  const questions = useMemo(
    () => {
      const raw =
        ((establishmentRulesQuizzes.quizzes as Record<string, QuizQuestion[]>)['rti-act-2005'] ||
          []) as QuizQuestion[]
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-sky-100 pt-2 text-sky-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-sky-50 to-cyan-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
