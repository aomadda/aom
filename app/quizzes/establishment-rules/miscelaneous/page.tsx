...
const QUIZ_TITLE = 'Miscellaneous'
const SESSION_STORAGE_KEY = 'miscelaneous_quiz_session'
const RESULTS_STORAGE_KEY = 'miscelaneous_quiz_results'
...
export default function MiscellaneousQuiz() {
  ...
  const questions = useMemo(
    () => {
      const raw =
        ((establishmentRulesQuizzes.quizzes as Record<string, QuizQuestion[]>)[
          'miscelaneous'
        ] || []) as QuizQuestion[]
  ...
  if (!sessionReady || loadingProgress) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-lime-50 to-green-50 px-4">
      ...
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-lime-50 to-green-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            ...
            className="inline-flex rounded-full bg-linear-to-r from-lime-600 to-lime-700 px-6 py-2.5 font-medium text-white"
          >
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-lime-50 to-green-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-lime-500 to-lime-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="mb-6 grid grid-cols-2 gap-4 sm:mb-8 sm:grid-cols-4 sm:gap-6">
              ...
              <div className="rounded-xl border border-lime-200 bg-lime-50 p-4 text-center sm:rounded-2xl sm:p-6">
                <div className="mb-1 text-2xl font-bold text-lime-600 sm:text-3xl">
                  {questions.length}
                </div>
                <div className="text-xs font-medium text-lime-700 sm:text-sm">Total</div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-lime-600 to-lime-700 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-lime-700 hover:to-lime-800 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Establishment Rules
              </button>
              <button
  ...
  if (completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-lime-50 to-green-50 px-3 py-6 sm:px-4 sm:py-8">
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            ...
            <p className="mb-1 text-sm font-medium text-lime-700">This quiz is completed</p>
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-lime-600 to-lime-700 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-lime-700 hover:to-lime-800"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-lime-500 to-lime-600 transition-all duration-300 ease-out sm:h-2"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-lime-600 to-lime-700 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-lime-700 hover:to-lime-800 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
