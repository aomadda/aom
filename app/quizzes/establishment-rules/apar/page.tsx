...
const SESSION_STORAGE_KEY = 'apar_quiz_session'
const RESULTS_STORAGE_KEY = 'apar_quiz_results'
...
export default function APARQuiz() {
  ...
  const questions = useMemo(
    () => (establishmentRulesQuizzes.quizzes['apar'] || []) as QuizQuestion[],
    [],
  )
