...
const QUIZ_TITLE = 'Trade Union Act 1926'
const SESSION_STORAGE_KEY = 'trade_union_act_1926_quiz_session'
const RESULTS_STORAGE_KEY = 'trade_union_act_1926_quiz_results'
...
export default function StaffBenefitFundQuiz() {
  ...
  const questions = useMemo(
    () => (tradeUnionAct1926Quizzes.quizzes['trade-union-act-1926'] || []) as QuizQuestion[],
    [],
  )
