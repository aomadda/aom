...
const QUIZ_ID = 'discipline-appeal-rules'
const CATEGORY_ID = 'discipline-appeal-rules'
const QUIZ_TITLE = 'Railway Servants (Discipline & Appeal) Rules 1968'
const SESSION_STORAGE_KEY = 'discipline_appeal_rules_quiz_session'
const RESULTS_STORAGE_KEY = 'discipline_appeal_rules_quiz_results'
...
export default function DisciplineAppealRulesQuiz() {
  ...
  const questions = useMemo(
    () =>
      (establishmentRulesQuizzes.quizzes['discipline-appeal-rules'] ||
        []) as QuizQuestion[],
    [],
  )
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-blue-50 to-slate-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
