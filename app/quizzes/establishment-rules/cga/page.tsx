...
export default function CGAQuiz() {
  ...
  const categoryData = {
    ...
    quizzes: {
      'cga': (establishmentRulesQuizzes.quizzes['cga'] as QuizQuestion[]) || []
    }
  };
  
  const currentQuizId = 'cga';
      ...
      <div className="min-h-screen bg-linear-to-br from-amber-50 to-orange-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            {/* Score Display */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-amber-500 to-orange-600 rounded-full mb-4 sm:mb-6">   
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                ...
                className="flex-1 bg-linear-to-r from-amber-600 to-orange-700 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-full sm:rounded-full hover:from-amber-700 hover:to-orange-800 transition-all duration-200 font-medium shadow-lg hover:shadow-xl text-sm sm:text-base"
              >
