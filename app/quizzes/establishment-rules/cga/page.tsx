...
const QUIZ_ID = 'cga'
const CATEGORY_ID = 'cga'
const QUIZ_TITLE = 'Compassionate Grounds Appointment (CGA)'
const SESSION_STORAGE_KEY = 'cga_quiz_session'
const RESULTS_STORAGE_KEY = 'cga_quiz_results'
...
export default function CGAQuiz() {
  ...
  const questions = useMemo(
    () => (establishmentRulesQuizzes.quizzes['cga'] || []) as QuizQuestion[],
    [],
  )
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-amber-100 pt-2 text-amber-800">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-amber-50 to-orange-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
