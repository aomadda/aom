...
export default function AccountsQuiz() {
  ...
  const categoryData = {
    title: 'Accounts',
    description: 'Test your knowledge of Accounts Rules for Railway Finance',
    color: 'from-amber-500 to-yellow-600',
    quizzes: {
      'accounts': (financialRulesQuizzes.quizzes['accounts'] as QuizQuestion[]) || []
    }
  };
  
  const currentQuizId = 'accounts';
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-amber-50 to-yellow-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            {/* Score Display */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-amber-500 to-yellow-600 rounded-full mb-4 sm:mb-6">   
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              <div className="bg-amber-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center border border-amber-200">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-amber-600 mb-1 sm:mb-2">{questions.length}</div>
                <div className="text-amber-700 font-medium text-xs sm:text-sm lg:text-base">Total Questions</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button
                ...
                className="flex-1 bg-linear-to-r from-amber-600 to-amber-700 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-full sm:rounded-full hover:from-amber-700 hover:to-amber-800 transition-all duration-200 font-medium shadow-lg hover:shadow-xl text-sm sm:text-base"
              >
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-50 to-yellow-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div 
                className="bg-linear-to-r from-amber-500 to-yellow-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
            ...
            <div className="space-y-2 sm:space-y-3">
              {currentQ.options.map((option: string, index: number) => {
                ...
                if (isSelected) {
                  ...
                  optionClasses += ' border-gray-300 hover:border-amber-300 hover:bg-amber-50 hover:shadow-sm';
                }
