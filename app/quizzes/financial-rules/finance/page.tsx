...
const QUIZ_TITLE = 'Finance'
const SESSION_STORAGE_KEY = 'finance_quiz_session'
const RESULTS_STORAGE_KEY = 'finance_quiz_results'
...
export default function FinanceQuiz() {
  ...
  const questions = useMemo(
    () =>
      (financialRulesQuizzes.quizzes['finance'] || []) as QuizQuestion[],
    [],
  )
  ...
  if (!sessionReady || loadingProgress) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-emerald-50 to-green-50 px-4">
      ...
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-emerald-50 to-green-50 px-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            ...
            className="inline-flex rounded-full bg-linear-to-r from-emerald-500 to-green-600 px-6 py-2.5 font-medium text-white"
          >
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-green-50 px-3 py-8 sm:px-4 sm:py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6 rounded-2xl bg-white p-6 shadow-2xl sm:mb-8 sm:rounded-3xl sm:p-8">
            <div className="mb-6 text-center sm:mb-8">
              <div className="mb-4 inline-flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-emerald-500 to-green-600 sm:mb-6 sm:h-32 sm:w-32">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                ...
                className="flex-1 rounded-full bg-linear-to-r from-emerald-500 to-green-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-emerald-600 hover:to-green-700 hover:shadow-xl sm:px-6 sm:py-3 sm:text-base"
              >
                Back to Financial Rules
              </button>
              <button
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-2xl shadow-emerald-950/10">
            <div className="relative overflow-hidden bg-linear-to-r from-slate-950 via-emerald-950 to-green-950 px-6 py-8 text-center sm:px-10 sm:py-10">
              ...
              <div className="relative mx-auto mt-4 h-1 w-16 rounded-full bg-linear-to-r from-emerald-400 to-green-300" />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {question.explanation ? (
                      <div className="mt-3 rounded-2xl border border-emerald-100 bg-linear-to-br from-emerald-50 to-green-50 p-4">
                        <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-emerald-700">
                          Explanation:
                        </div>
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-green-50 px-4 py-6 sm:px-4 sm:py-8">
  ...
  if (completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-green-50 px-3 py-6 sm:px-4 sm:py-8">
        <div className="mx-auto max-w-3xl">
          <div className="rounded-xl bg-white p-6 text-center shadow-lg sm:p-8">
            <h1 className="mb-2 text-xl font-bold text-gray-800 sm:text-2xl">{QUIZ_TITLE}</h1>
            ...
            <button
              ...
              className="rounded-full bg-linear-to-r from-emerald-500 to-green-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-emerald-600 hover:to-green-700"
            >
              View Results
            </button>
          </div>
        ...
        <div className="rounded-xl bg-white p-4 shadow-lg sm:rounded-2xl sm:p-6 lg:p-8">
          <div className="mb-6 text-center sm:mb-8">
            ...
            <div className="h-1.5 w-full rounded-full bg-gray-200 sm:h-2">
              <div
                className="h-1.5 rounded-full bg-linear-to-r from-emerald-500 to-green-600 transition-all duration-300 ease-out sm:h-2"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-linear-to-r from-emerald-500 to-green-600 px-6 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-emerald-600 hover:to-green-700 hover:shadow-xl sm:rounded-lg sm:px-8 sm:py-3 sm:text-base"
            >
