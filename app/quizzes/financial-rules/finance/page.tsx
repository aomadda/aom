...
export default function FinanceQuiz() {
  ...
  const categoryData = {
    title: 'Finance',
    description: 'Test your knowledge of Finance Rules for Railway',
    color: 'from-emerald-500 to-green-600',
    quizzes: {
      'finance': (financialRulesQuizzes.quizzes['finance'] as QuizQuestion[]) || []
    }
  };
  
  const currentQuizId = 'finance';
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-green-50 py-8 sm:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            {/* Score Display */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-emerald-500 to-green-600 rounded-full mb-4 sm:mb-6">   
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-50 to-green-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 sm:h-2">
              <div 
                className="bg-linear-to-r from-emerald-500 to-green-600 h-1.5 sm:h-2 rounded-full transition-all duration-300 ease-out"
