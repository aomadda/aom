...
export default function TendersQuiz() {
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-lg bg-white/70 p-3 text-sm">
                      ...
                      {question.explanation ? (
                        <div className="border-t border-teal-100 pt-2 text-teal-700">
  ...
  if (!quizActive && !completed && !showResults) {
    return (
      <div className="min-h-screen bg-linear-to-br from-teal-50 to-cyan-50 px-4 px-3 py-6 sm:px-4 sm:py-8">
