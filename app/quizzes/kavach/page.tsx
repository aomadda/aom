...
import { kavachQuizzes } from '@/assets/kavach';
...
export default function KavachQuiz() {
  ...
  // Get the category data - kavach has a different structure
  interface KavachQuestion {
    question: string;
    options: string[];
  ...
  const categoryData = {
    title: 'Kavach',
    description: 'Test your knowledge of Kavach (Train Collision Avoidance System) for Indian Railways',
    color: 'from-emerald-500 to-teal-600',
    quizzes: {
      'kavach': kavachQuizzes.kavach.map((q: KavachQuestion) => ({
        question: q.question,
        options: q.options,
