                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-lg lg:p-6 p-2 border border-white/10">
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Section c */}
                      <div className="bg-gradient-to-r from-green-500/10 to-green-600/5 rounded-xl lg:p-5 p-3 border border-green-400/30 hover:border-green-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20">
                        ...
                        <div className="lg:ml-16 ml-2 space-y-3">
                          {/* i) Item */}
                          <div className="bg-white/5 rounded-lg p-3 border border-green-300/20">
                            <div className="flex gap-2 items-start">
                              <span className="text-yellow-300 font-semibold text-lg">i)</span>
                              <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                                <span className="text-green-300 font-semibold">&apos;Line clear&apos;</span> will be indicated on the <span className="text-green-300 font-semibold">TCF dial</span> of <span className="text-green-300 font-semibold">Y&apos;s block instrument</span>.
                              </p>
                            </div>
                          </div>
                          {/* ii) Item */}
                          <div className="bg-white/5 rounded-lg p-3 border border-green-300/20">
                            <div className="flex gap-2 items-start">
                              ...
                              <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                                <span className="text-green-300 font-semibold">&apos;Line clear&apos;</span> will be indicated on the <span className="text-green-300 font-semibold">TGT dial</span> of <span className="text-green-300 font-semibold">X&apos;s block instrument</span>, and
                              </p>
                            </div>
                          </div>
                          {/* iii) Item */}
                          <div className="bg-white/5 rounded-lg p-3 border border-green-300/20">
                            <div className="flex gap-2 items-start">
                              <span className="text-yellow-300 font-semibold text-lg">iii)</span>
                              <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                                Lock on <span className="text-blue-300 font-semibold">Last Stop Signal</span> of <span className="text-green-300 font-semibold">&apos;X&apos;</span> will be released.
                              </p>
                            </div>
                          </div>
                        </div>
