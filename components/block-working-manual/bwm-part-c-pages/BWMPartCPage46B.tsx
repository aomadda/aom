...
const BWMPartCPage46B: React.FC = () => {
  return (
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-lg lg:p-6 p-2 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">6.2. Lorries, Push Trollies, Cycle Trollies, Motor Trollies, Dollies and Rail-cum-Road vehicle.</h3>
...
export default BWMPartCPage46B