...
const BWMAnnexurePage4A: React.FC = () => {
  return (
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-lg lg:p-6 p-2 border border-white/10">
                    <h4 className="text-indigo-300 font-semibold lg:text-xl text-lg mb-4">1.6. Counter &apos;Line clear&apos; enquiry during interruption of control phone:</h4>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="group relative bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-xl lg:p-5 p-3 hover:from-blue-500/20 hover:to-indigo-500/20 transition-all duration-300 shadow-lg hover:shadow-blue-500/20">
                        <div className="flex items-start gap-4">
                          ...
                          <p className="text-gray-100 lg:text-lg text-base leading-relaxed flex-1 pt-1">
                            When &apos;Y&apos; receives &apos;Line clear enquiry&apos; from &apos;X&apos;, if &apos;Line clear&apos; is required for a more important train waiting at &apos;Y&apos;, &apos;Y&apos; should send a counter &apos;Line clear enquiry&apos;.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-xl lg:p-5 p-3 hover:from-purple-500/20 hover:to-indigo-500/20 transition-all duration-300 shadow-lg hover:shadow-purple-500/20">
                        <div className="flex items-start gap-4">
                          ...
                          <p className="text-gray-100 lg:text-lg text-base leading-relaxed flex-1 pt-1">
                            &apos;Y&apos; should write in red ink in column A of the inward portion of T/B.1425 the words &apos;Cancelled&apos;. He shall then record the &apos;Counter Line clear enquiry&apos; in column A of outward portion of T/A1425 (fresh form) and inform &apos;X&apos;. Station Master at &apos;X&apos; shall write the words &apos;Cancelled&apos; in red ink in column A of outward portion of T/A1425. &apos;X&apos; shall then record in column A of inward portion of T/A.1425 (fresh form) and inform &apos;Y&apos;.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          <span className="text-blue-300 font-semibold">Note :</span> Refer Chapter II for Precedence of trains.
                        </p>
                      </div>
                    </div>
                  </div>
...
export default BWMAnnexurePage4A