...
const BWMPartBPage61A: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Unusual Occurrences During Train Passage</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">5.7. &apos; Stop and examine train&apos; signal:</h3>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Unusual Occurrence at Station in Advance
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              When the Station Master at <span className="text-green-300 font-semibold">&apos;X&apos;</span> observes anything unusual (other than the Tail lamp or Tail board missing) on a train during its passage through his station, such as goods falling off, a vehicle on fire, broken axle or hanging coupling etc., rendering it necessary to stop such trains at the next station, the <span className="text-red-400 font-semibold">&apos;Stop and examine train&apos;</span> signal shall be sent to <span className="text-green-300 font-semibold">&apos;Y&apos;</span>, the station in advance intimating the nature of the irregularity observed. The Station Master at <span className="text-green-300 font-semibold">&apos;Y&apos;</span> shall acknowledge this signal by repeating it. He shall examine the train on arrival, stopping run through trains out of course for the purpose and take remedial action. On ensuring that the line is clear, he shall send to the station <span className="text-green-300 font-semibold">&apos;X&apos;</span> the <span className="text-blue-300 font-semibold">&apos;Train out of the block section&apos;</span> signal, which will be an intimation that all is right.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Damage or Obstruction to Block Section in Rear
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              If the Station Master at <span className="text-green-300 font-semibold">&apos;X&apos;</span> observing the unusual occurrence suspects that it would have caused damage or obstruction to the block section in rear, he shall inform the Station Master <span className="text-green-300 font-semibold">&apos;W&apos;</span> in rear, the nature of irregularity. Both the Station Masters should issue <span className="text-yellow-300 font-semibold">caution orders</span> for trains entering the block section until it is confirmed that all is right.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default BWMPartBPage61A