...
const BWMPartBPage60A: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Error Detection and Correction</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">5.5. &apos;Signal given in error&apos; signal:</h3>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            ...
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              When incorrect beats have been given or whenever beats received are not understood, the Station Master detecting this irregularity shall give the <span className="text-red-400 font-semibold">&apos;Signal given in error&apos;</span> signal. After this has been acknowledged, the signal, which ought to have been sent, shall be distinctly repeated.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Block Working Suspension
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              If the error mentioned above is not rectified even after repeating the signal, <span className="text-red-400 font-semibold">block working shall be suspended</span>.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default BWMPartBPage60A