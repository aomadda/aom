      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4">CAUTION ORDERS</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">4.1. Caution order (G.R. 4.09):</h3>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            ...
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              Sub-rule (a) does not apply in the case of long continued repairs when fixed signals are provided at an adequate distance short of such place and have been notified to the running staff concerned.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Format of Caution Order
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              The <span className="text-green-300 font-semibold">Caution Order</span> referred to in sub-rule (1) shall be on <span className="text-blue-300 font-semibold">white paper with green font</span> and be made out and signed in full:
                            </p>
                            
                            <div className="bg-yellow-500/10 border border-yellow-400/30 rounded-lg p-4">
                              <p className="text-yellow-200 lg:text-base text-sm leading-relaxed">
                                <span className="font-bold">Provided that</span> as a temporary measure the <span className="text-green-300 font-semibold">Caution Order</span> may be on <span className="text-blue-300 font-semibold">white paper with a green band running diagonally across the form</span>.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          <span className="font-bold text-yellow-300">Note:</span> See Appendix I to G&SR for Special Instructions regarding issue of Caution Orders.
                        </p>
                      </div>
                    </div>
