      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Emergency Procedures for Train Parting</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">5.9. &apos;Train divided&apos; signal:</h3>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Immediate Action and Safeguarding
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              During the passage of a train through the station <span className="text-green-300 font-semibold">&apos;Y&apos;</span>, if it is observed that some portion of the train is missing, <span className="text-green-300 font-semibold">&apos;Y&apos;</span> should not exhibit a Stop hand signal but should endeavor to attract the attention of the Driver or the Guard by shouting and gesticulating or by other means. The station <span className="text-green-300 font-semibold">&apos;Y&apos;</span> should send the <span className="text-red-400 font-semibold">&apos;train divided&apos;</span> signal to the station <span className="text-green-300 font-semibold">&apos;X&apos;</span> in rear and <span className="text-red-400 font-semibold">&apos;Train passed without tail lamp/ flashing tail lamp or tail board&apos;</span> signal to the station <span className="text-green-300 font-semibold">&apos;Z&apos;</span> in advance. The Station Master <span className="text-green-300 font-semibold">&apos;X&apos;</span> receiving the <span className="text-red-400 font-semibold">&apos;Train divided&apos;</span> signal should immediately take action to safeguard vehicles or train on the line, especially, if the gradient is a falling one. He shall not give <span className="text-blue-300 font-semibold">&apos;Line clear&apos;</span> for a following train at stations where handle type block instruments are provided. At stations where push button block instruments are in use, he must remove the shunt key to prevent the block instrument being operated at the other end and keep it in his personal custody. If a train is already in the block section, he should stop it at the First Stop Signal and inform the Driver of the impending danger. If this train can be received and berthed on a line, this can be done, before the run away vehicles are sighted and it is safe to do so.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Relief Engine Sending
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              If parting has occurred, a relief engine should be sent after a lapse of <span className="text-yellow-300 font-semibold">30 minutes</span> more than the running time of the slowest speed goods train, which has to be calculated from the time of the receipt of the <span className="text-red-400 font-semibold">&apos;Train divided&apos;</span> signal.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              Clearing the Block Section
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              After the block section is cleared the <span className="text-blue-300 font-semibold">&apos;Train out of block section&apos;</span> or <span className="text-blue-300 font-semibold">&apos;Obstruction removed&apos;</span> signal shall be sent.
                            </p>
                          </div>
                        </div>
                      </div>
