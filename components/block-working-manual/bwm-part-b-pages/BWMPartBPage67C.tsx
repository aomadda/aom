...
const BWMPartBPage67C: React.FC = () => {
  return (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="lg:text-5xl text-2xl font-bold bg-gradient-to-r from-white via-blue-100 to-indigo-100 bg-clip-text text-transparent mb-6 animate-fade-in">
              Block Section Clear During Test
            </h1>
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Testing Requirements for Block Instruments</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">7.3. Block Section to be clear during test:</h3>
                    
                    <div className="space-y-4">
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          The <span className="text-green-300 font-semibold">block instrument</span> and <span className="text-green-300 font-semibold">apparatus</span> connected with them shall be tested only when the <span className="text-green-300 font-semibold">block instrument</span> is displaying <span className="text-yellow-300 font-semibold">&apos;Line closed&apos;</span> condition.
                        </p>
                      </div>
                    </div>
...
export default BWMPartBPage67C