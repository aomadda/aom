...
const BWMPartBPage54A: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">TOL Indication and Signals</h2>
              ...
              <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg lg:p-6 p-3 border border-white/10">
                    <h3 className="text-blue-300 font-bold lg:text-2xl text-xl mb-6">3.15.</h3>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              &apos;Train entering block section&apos; signal:
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              <span className="text-green-300 font-semibold">&apos;X&apos;</span> must send the <span className="text-blue-300 font-semibold">&apos;Train entering block section&apos;</span> signal to <span className="text-green-300 font-semibold">&apos;Y&apos;</span> as the train enters the block section. This is in addition to the automatic <span className="text-blue-300 font-semibold">TOL</span> indication appearing on the block instrument and the audible warning bell.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              TOL indication and buzzer – Handle type block instruments:
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              Immediately the train passes the Last Stop Signal at <span className="text-green-300 font-semibold">&apos;X&apos;</span> and enters the <span className="text-green-300 font-semibold">&apos;X&apos;</span> – <span className="text-green-300 font-semibold">&apos;Y&apos;</span> block section, the <span className="text-blue-300 font-semibold">FVT</span> is operated. This brings about the <span className="text-blue-300 font-semibold">&apos;TOL&apos;</span> indication at both the stations and also buzzer sounds automatically at both the stations <span className="text-green-300 font-semibold">&apos;X&apos;</span> and <span className="text-green-300 font-semibold">&apos;Y&apos;</span> until <span className="text-green-300 font-semibold">&apos;Y&apos;</span> acknowledges the <span className="text-blue-300 font-semibold">&apos;train entering block section&apos;</span> signal by pressing <span className="text-blue-300 font-semibold">PB 1</span>.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="group relative bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl lg:p-5 p-3 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20 hover:scale-[1.02]">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <h4 className="text-blue-200 font-bold lg:text-xl text-lg pt-1">
                              &apos;TOL&apos; indication and audible warning in Push button tokenless block instruments:
                            </h4>
                            <p className="text-gray-100 lg:text-lg text-base leading-relaxed">
                              Immediately, the train passes the Last Stop Signal at <span className="text-green-300 font-semibold">&apos;X&apos;</span> and enters the <span className="text-green-300 font-semibold">&apos;X&apos;</span> – <span className="text-green-300 font-semibold">&apos;Y&apos;</span> block section, the <span className="text-blue-300 font-semibold">FVT</span> is operated. This brings about the <span className="text-blue-300 font-semibold">&apos;TOL&apos;</span> indication automatically at both the stations and also audible warning sounds intermittently at the receiving station <span className="text-green-300 font-semibold">&apos;Y&apos;</span>, until <span className="text-green-300 font-semibold">&apos;Y&apos;</span> acknowledges the <span className="text-blue-300 font-semibold">TOL</span> signal by operating <span className="text-blue-300 font-semibold">&apos;Bell code push&apos;</span> button
                            </p>
                          </div>
                        </div>
                      </div>
...
export default BWMPartBPage54A