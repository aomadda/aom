      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4"> 3.9 Precautions before asking &apos;Line clear&apos;</h2>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-4 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="bg-gradient-to-r from-gray-500/10 to-slate-500/10 lg:p-6 py-4 lg:px-6 px-4 rounded-xl border border-gray-400/20">
              <p className="text-gray-200 lg:text-lg text-base leading-relaxed text-center">
                Before &apos;X&apos; asks &apos;Y&apos; for &apos;Line Clear&apos;, he shall examine his Train Signal Register in order to ascertain that—
              </p>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The &apos;Train out of block section&apos; or &apos;Obstruction removed&apos; signal has been received and entered in the Train Signal Register for the previous train that has passed over the &apos;X&apos; – &apos;Y&apos; block section and also the block section is clear.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        &apos;Line Clear&apos; has not been obtained from &apos;Y&apos; for any other train,
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        &apos;Line Clear&apos; has not been given to &apos;Y&apos; for a train in the opposite direction.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-pink-500/10 to-yellow-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-pink-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        A Private Number has been obtained for the train, and
                      </p>
                    </div>
                  </div>
                </div>
...
export default BWMPartAPage21C