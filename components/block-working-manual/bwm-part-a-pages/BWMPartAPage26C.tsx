                      ...
                      <div className="space-y-3 ml-1">
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-gray-200 lg:text-base text-sm">
                            satisfy himself that the train has arrived complete,
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <span className="mt-1 text-indigo-400 font-bold">ii)</span>
                          <span className="text-gray-200 lg:text-base text-sm">
                            ensure that all the reception signals taken &apos;OFF&apos; for the train are put back to &apos;ON&apos;,
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <span className="mt-1 text-blue-400 font-bold">iii)</span>
                          <span className="text-gray-200 lg:text-base text-sm">
                            ensure that the token is correct in all respects and not damaged in any way, and
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <span className="mt-1 text-indigo-400 font-bold">iv)</span>
                          <span className="text-gray-200 lg:text-base text-sm">
                            Remove dirt, if any, from the token.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The Station Master shall then insert the token in the instrument and clear the section as detailed for each instrument.
                      </p>
                    </div>
                  </div>
                </div>
...
export default BWMPartAPage26C