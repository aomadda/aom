      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4"> 3.12 Precautions before giving &apos;Line clear&apos;</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto mb-6 rounded-full"></div>
          </div>

          {/* Introduction Section */}
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-4 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="bg-gradient-to-r from-gray-500/10 to-slate-500/10 lg:p-6 py-4 lg:px-6 px-4 rounded-xl border border-gray-400/20">
              <p className="text-gray-200 lg:text-lg text-base leading-relaxed text-center">
                Before &apos;Y&apos; gives &apos;Line clear&apos; to &apos;X&apos;, he shall examine his Train Signal Register in order to ascertain that –
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The &apos;Train out of block section&apos; or &apos;Obstruction removed&apos; signal has been received and entered in his Train Signal Register for the previous train that has passed over the &apos;X&apos; – &apos;Y&apos; block section and also that the block section is clear,
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        &apos;Line clear&apos; has not been given to &apos;X&apos; for any other train,
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        &apos;Line clear&apos; has not been obtained from &apos;X&apos; for a train in the opposite direction,
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-pink-500/10 to-yellow-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-pink-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        A Private Number has been given for the train; and
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="group hover:bg-white/5 py-3 lg:px-4 px-2 lg:py-6 rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20">
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-yellow-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The Operating handle is in the &apos;Line closed&apos; position and that the Last Stop Signal control key, if provided, is in the instrument in the case of Neale&apos;s ball or tablet instruments.
                      </p>
                    </div>
                  </div>
                </div>
...
export default BWMPartAPage22C