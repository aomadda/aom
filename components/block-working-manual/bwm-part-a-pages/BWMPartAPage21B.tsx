      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4"> 3.8 The &apos;Is line clear&apos; signal – when to be sent</h2>
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The &apos;Is line clear&apos; signal shall be sent only after it has been ascertained according to the procedure laid down in clause (c) of para 3.7, that the station in advance is able to accept the signal.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        The &apos;Is line clear&apos; signal shall not be given until the &apos;Train out of block section&apos; signal has been received for the last preceding train.
                      </p>
                    </div>
                  </div>
                </div>
...
export default BWMPartAPage21B