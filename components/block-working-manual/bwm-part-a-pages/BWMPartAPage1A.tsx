      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4">Description of Token Block Instruments</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Comprehensive guide to token block instruments used in railway operations
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base">
                            The term &apos;Station Master&apos; wherever used in this Manual, also applies to Assistant Station Master, Cabin Assistant Station Master, and any other competent staff who may, for the time being, be in charge of Block Working.
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base">
                            For the purpose of explaining the instructions in this Manual, &apos;W&apos;, &apos;X&apos;, &apos;Y&apos; and &apos;Z&apos; have been taken as consecutive block stations.
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              {/* Provision of Token Block Instruments */}
              <div className="group hover:bg-white/5 py-3 lg:px-4 px-2 lg:py-6 rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20">
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">1.1</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-2xl py-6 px-6 text-white hover:scale-105 transition-all duration-300 group border border-blue-400/20">
              ...
              <p className="text-blue-100 leading-relaxed text-center">
                Neale&apos;s Ball and Tablet token instruments for single line sections
              </p>
            </div>

            {/* Working Time Table Card */}
            <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl shadow-2xl py-6 px-6 text-white hover:scale-105 transition-all duration-300 group border border-indigo-400/20">
              ...
              <p className="text-indigo-100 leading-relaxed text-center">
                Sections with token block instruments are notified in WTT
              </p>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-2 lg:gap-6">
              <div className="space-y-2 lg:space-y-4">
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  ...
                  <span className="text-gray-200 lg:text-lg text-base">Neale&apos;s Ball token instrument</span>
                </div>
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  <span className="text-blue-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">📋</span>
                  <span className="text-gray-200 lg:text-lg text-base">Neale&apos;s Tablet token instrument</span>
                </div>
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  <span className="text-blue-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">🚂</span>
                  <span className="text-gray-200 lg:text-lg text-base">Single line sections</span>
                </div>
              </div>
              <div className="space-y-2 lg:space-y-4">
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  <span className="text-indigo-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">👨‍💼</span>
                  <span className="text-gray-200 lg:text-lg text-base">Station Master terminology</span>
                </div>
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  <span className="text-indigo-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">📍</span>
                  <span className="text-gray-200 lg:text-lg text-base">W, X, Y, Z block stations</span>
                </div>
                <div className="flex items-start group hover:bg-white/5 lg:p-4 p-2 rounded-lg transition-all duration-300">
                  <span className="text-indigo-400 mr-4 mt-1 lg:text-2xl text-xl group-hover:scale-110 transition-transform">📊</span>
                  <span className="text-gray-200 lg:text-lg text-base">Working Time Table notification</span>
                </div>
              </div>
            </div>
          </div>
