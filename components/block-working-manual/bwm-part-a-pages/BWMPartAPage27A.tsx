                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        On arrival of the train or by the removal of the cause of obstruction, the &apos;Train out of block section&apos; or &apos;Obstruction removed&apos; signal shall be given by the block station in advance by giving the prescribed code of bell signals.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      ...
                      <div className="space-y-3 ml-1">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-gray-200 lg:text-base text-sm">
                            that the conditions under which &apos;Line clear&apos; can be given are complied with.
                          </span>
                        </div>
                      </div>
                    </div>
...
export default BWMPartAPage27A