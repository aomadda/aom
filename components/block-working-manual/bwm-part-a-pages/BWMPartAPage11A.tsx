        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="lg:text-5xl text-2xl font-bold bg-gradient-to-r from-white via-blue-100 to-indigo-100 bg-clip-text text-transparent mb-6 animate-fade-in">
              2.8. Preservation of Train Signal Register
            </h1>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">2.8</span>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/20">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h4 className="text-xl font-semibold text-yellow-300 mb-2">Note on Pending Enquiries</h4>
                                <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
...
export default BWMPartAPage11A