            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Repeal and Savings</span>
                </div>
              </h2>
                ...
                <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  <div className="flex-1">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      <span className="font-semibold text-blue-300">The Railway Services (Conduct) Rules, 1966, contained in Appendix VI of the Indian Railways Establishment Code, Volume I, shall cease to be in force except as respects things done or omitted to be done.</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Obligation to abide by all administrative Instructions</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-green-400/30">
                <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  <div className="flex-1">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      <span className="font-semibold text-green-300">Notwithstanding anything contained in these rules, a railway servant shall be governed by all the administrative instruction that may be issued from time to time in regard to the conduct of railway servants.</span>
                    </p>
                  </div>
                </div>
              </div>
...
export default ConductRules1966Rule25