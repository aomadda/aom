            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Connection with press or other media</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                  ...
                  <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        <span className="font-semibold text-cyan-200">No Railway servant shall, except with the previous sanction of the Government, own wholly or in part, or conduct or participate in the editing or management of, any newspaper or other periodical publication or electronic media.</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        <span className="font-semibold text-cyan-200">Nothing in sub-rule (1) shall apply in case a Railway servant in the bonafide discharge of his official duties publishes a book or participates in a public media.</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        <span className="font-semibold text-cyan-200">A Railway Servant publishing a book or participating in a public media shall, at all times, make it clear that the views expressed by him are his own and not that of Government.</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-linear-to-br from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-400/30">
                  <p className="text-gray-300 lg:text-sm text-xs leading-relaxed">
                    <span className="font-semibold text-purple-300">(Authority:</span> Railway Board&apos;s letter No. E (D&A) 95 GS 1-6 dated 14-9-95)
                  </p>
                </div>
...
export default ConductRules1966Rule8