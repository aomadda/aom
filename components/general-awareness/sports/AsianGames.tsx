...
import {
  asianAthleticsChampionshipsSection,
  asianGamesDetailsSection,
  asianGamesPageTitle,
  introParagraphs,
} from '@/assets/general-awareness/sports/asian-games'

type AsianGamesProps = {
  showBackNav?: boolean
}
...
const AsianGames = ({ showBackNav = false }: AsianGamesProps) => {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="space-y-8 sm:space-y-10">
          ...
          <SectionShell>
            ...
            <ArrowBulletList items={asianGamesDetailsSection.sinceBullets} />
            <p className="mt-5 whitespace-pre-line leading-relaxed text-slate-300">
              {asianGamesDetailsSection.sportsDetails}
            </p>
            <SubsectionTitleBar attachListBelow title={asianGamesDetailsSection.block2022Title} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={asianGamesDetailsSection.block2022Bullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{asianAthleticsChampionshipsSection.heading}</SectionHeading>
            </div>
            <p className="leading-relaxed text-slate-300">{asianAthleticsChampionshipsSection.introParagraph}</p>
            <ArrowBulletList items={asianAthleticsChampionshipsSection.sinceBullets} />
            <SubsectionTitleBar attachListBelow title={asianAthleticsChampionshipsSection.block2021Title} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={asianAthleticsChampionshipsSection.block2021Bullets}
            />
          </SectionShell>
        </div>
