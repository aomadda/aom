...
import {
  ...
  chinaOpenSection,
  denmarkOpenSection,
  famousBadmintonPlayersSection,
  indonesiaOpenSection,
  malaysiaOpenSection,
  relatedTermsSection,
  singaporeOpenSection,
  syedModiSection,
  thomasCupSection,
  trophiesSection,
  uberCupSection,
  worldBadmintonChampionshipSection,
} from '@/assets/general-awareness/sports/badminton'
        ...
        <div className="space-y-8 sm:space-y-10">
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{malaysiaOpenSection.heading}</SectionHeading>
            </div>
            {malaysiaOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={malaysiaOpenSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={malaysiaOpenSection.blockTitle}
              items={malaysiaOpenSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{indonesiaOpenSection.heading}</SectionHeading>
            </div>
            {indonesiaOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={indonesiaOpenSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={indonesiaOpenSection.blockTitle}
              items={indonesiaOpenSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{singaporeOpenSection.heading}</SectionHeading>
            </div>
            {singaporeOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={singaporeOpenSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={singaporeOpenSection.blockTitle}
              items={singaporeOpenSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{allEnglandOpenSection.heading}</SectionHeading>
            </div>
            {allEnglandOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={allEnglandOpenSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={allEnglandOpenSection.blockTitle}
              items={allEnglandOpenSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{thomasCupSection.heading}</SectionHeading>
            </div>
            {thomasCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={thomasCupSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={thomasCupSection.blockTitle}
              items={thomasCupSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{uberCupSection.heading}</SectionHeading>
            </div>
            {uberCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={uberCupSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={uberCupSection.blockTitle} items={uberCupSection.blockArrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{syedModiSection.heading}</SectionHeading>
            </div>
            {syedModiSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={syedModiSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={syedModiSection.blockTitle} items={syedModiSection.blockArrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            ...
            <BlockTitleAndCategories
              blockTitle={australianOpenSection.blockTitle}
              items={australianOpenSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{chinaOpenSection.heading}</SectionHeading>
            </div>
            {chinaOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={chinaOpenSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={chinaOpenSection.blockTitle} items={chinaOpenSection.blockArrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{denmarkOpenSection.heading}</SectionHeading>
            </div>
            {denmarkOpenSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <BlockTitleAndCategories
              blockTitle={denmarkOpenSection.blockTitleFor2020}
              items={denmarkOpenSection.for2020ArrowBullets}
            />
            <BlockTitleAndCategories
              blockTitle={denmarkOpenSection.championsHeading}
              items={denmarkOpenSection.championsArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{worldBadmintonChampionshipSection.heading}</SectionHeading>
            </div>
            {worldBadmintonChampionshipSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={[worldBadmintonChampionshipSection.foundedLine]} />
            <BlockTitleAndCategories
              blockTitle={worldBadmintonChampionshipSection.blockTitle}
              items={worldBadmintonChampionshipSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousBadmintonPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousBadmintonPlayersSection.lines} />
          </SectionShell>
        </div>
