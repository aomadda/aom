...
import {
  billiardsOverviewSection,
  famousSnookerPlayersSection,
  relatedTermsSection,
  snookerIntroParagraphs,
  snookerOverviewSection,
  snookerPageTitle,
  trophiesSection,
} from '@/assets/general-awareness/sports/snooker'
...
function OverviewCard({
  ...
  section: {
    ...
    keyFeatures: readonly { label: string; value: string }[]
    basicRulesHeading: string
    basicRules: readonly string[]
  }
}) {
  return (
    <SectionShell>
      <div className="mb-6 flex items-start gap-3 sm:gap-4">
        ...
        <div className="min-w-0 flex-1">
          <SectionHeading className="mb-3">{section.heading}</SectionHeading>
          <p className="text-base leading-relaxed text-slate-200 sm:text-lg">{section.intro}</p>
        </div>
      </div>
      ...
      <div className="mb-2 flex items-center gap-2.5">
        ...
        <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
          {section.keyFeaturesHeading}
        </h3>
      </div>
      <ArrowBulletList className="mt-2" items={section.keyFeatures} />
      ...
      <div className="mt-7 mb-2 flex items-center gap-2.5">
        ...
        <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
          {section.basicRulesHeading}
        </h3>
      </div>
      <NumberedLines lines={section.basicRules} />
    </SectionShell>
  )
}
...
const Snooker = ({ showBackNav = false }: SnookerProps) => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-b from-slate-950 via-slate-900 to-emerald-950/80">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="space-y-8 sm:space-y-10">
          <OverviewCard section={snookerOverviewSection} />
          <OverviewCard section={billiardsOverviewSection} />
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                {snookerIntroParagraphs.map((p, i) => (
                  <p
                    key={i}
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousSnookerPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousSnookerPlayersSection.lines} />
          </SectionShell>
        </div>
