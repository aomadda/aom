...
import {
  famousShootersSection,
  issfWorldCup2021Section,
  relatedTermsSection,
  shootingOverviewSection,
  shootingPageTitle,
} from '@/assets/general-awareness/sports/shooting'
...
const Shooting = ({ showBackNav = false }: ShootingProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {shootingOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={shootingOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {shootingOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={shootingOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{issfWorldCup2021Section.heading}</SectionHeading>
            </div>
            <ArrowBulletList items={issfWorldCup2021Section.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousShootersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousShootersSection.lines} />
          </SectionShell>
        </div>
