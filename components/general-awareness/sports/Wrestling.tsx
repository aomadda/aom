...
import {
  asianWrestlingChampionshipsSection,
  famousWrestlingPlayersSection,
  introParagraph,
  relatedTermsSection,
  worldWrestlingChampionshipsSection,
  wrestlingOverviewSection,
  wrestlingPageTitle,
} from '@/assets/general-awareness/sports/wrestling'
...
const Wrestling = ({ showBackNav = false }: WrestlingProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <p className="min-w-0 flex-1 text-base leading-relaxed text-slate-200 sm:text-lg">
                {wrestlingOverviewSection.intro}
              </p>
            </div>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {wrestlingOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={wrestlingOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {wrestlingOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={wrestlingOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <p className="min-w-0 flex-1 leading-relaxed text-slate-300">{introParagraph}</p>
            </div>
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{worldWrestlingChampionshipsSection.heading}</SectionHeading>
            </div>
            <p className="leading-relaxed text-slate-300">{worldWrestlingChampionshipsSection.introParagraph}</p>
            <ArrowBulletList items={worldWrestlingChampionshipsSection.arrowBullets} />
            <SubsectionTitleBar attachListBelow title={worldWrestlingChampionshipsSection.block2021WwcTitle} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={worldWrestlingChampionshipsSection.block2021WwcBullets}
            />
            <SubsectionTitleBar attachListBelow title={worldWrestlingChampionshipsSection.block2021JuniorTitle} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={worldWrestlingChampionshipsSection.block2021JuniorBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{asianWrestlingChampionshipsSection.heading}</SectionHeading>
            </div>
            {asianWrestlingChampionshipsSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <SubsectionTitleBar attachListBelow title={asianWrestlingChampionshipsSection.block2021Title} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={asianWrestlingChampionshipsSection.block2021Bullets}
            />
            <SubsectionTitleBar attachListBelow title={asianWrestlingChampionshipsSection.championsTitle} />
            <ArrowBulletList
              className="mt-0! rounded-t-none rounded-b-xl border-t-0 [&_li:first-child]:rounded-none"
              items={asianWrestlingChampionshipsSection.championsBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousWrestlingPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousWrestlingPlayersSection.lines} />
          </SectionShell>
        </div>
