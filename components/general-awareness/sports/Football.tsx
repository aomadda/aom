...
import {
  ...
  relatedTermsSection,
  saffSection,
  santoshTrophySection,
  trophiesSection,
  under17WomensWorldCupSection,
} from '@/assets/general-awareness/sports/football'
...
const Football = ({ showBackNav = false }: FootballProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <ArrowBulletList className="mt-0 min-w-0 flex-1" items={footballCoachSection.arrowBullets} />
            </div>
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{santoshTrophySection.heading}</SectionHeading>
            </div>
            {santoshTrophySection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={santoshTrophySection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={santoshTrophySection.blockTitle}
              items={santoshTrophySection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{durandCupSection.heading}</SectionHeading>
            </div>
            {durandCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={durandCupSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={durandCupSection.blockTitle}
              items={durandCupSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{saffSection.heading}</SectionHeading>
            </div>
            {saffSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={saffSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={saffSection.blockTitle} items={saffSection.blockArrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{asianCupSection.heading}</SectionHeading>
            </div>
            {asianCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={asianCupSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={asianCupSection.blockTitle}
              items={asianCupSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{copaAmericaSection.heading}</SectionHeading>
            </div>
            {copaAmericaSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={copaAmericaSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={copaAmericaSection.blockTitle}
              items={copaAmericaSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{euroCupSection.heading}</SectionHeading>
            </div>
            {euroCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={euroCupSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={euroCupSection.blockTitle} items={euroCupSection.blockArrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{fifaWorldCupSection.heading}</SectionHeading>
            </div>
            {fifaWorldCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={fifaWorldCupSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={fifaWorldCupSection.blockTitle}
              items={fifaWorldCupSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{fifaConfederationCupSection.heading}</SectionHeading>
            </div>
            {fifaConfederationCupSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={fifaConfederationCupSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={fifaConfederationCupSection.block2017Title}
              items={fifaConfederationCupSection.block2017ArrowBullets}
            />
            <BlockTitleAndCategories
              blockTitle={fifaConfederationCupSection.block2022Title}
              items={fifaConfederationCupSection.block2022ArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{indianSuperLeagueSection.heading}</SectionHeading>
            </div>
            {indianSuperLeagueSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={indianSuperLeagueSection.arrowBullets} />
            <BlockTitleAndCategories
              blockTitle={indianSuperLeagueSection.blockTitle}
              items={indianSuperLeagueSection.blockArrowBullets}
            />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{under17WomensWorldCupSection.heading}</SectionHeading>
            </div>
            <ArrowBulletList items={under17WomensWorldCupSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousFootballPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousFootballPlayersSection.lines} />
          </SectionShell>
        </div>
