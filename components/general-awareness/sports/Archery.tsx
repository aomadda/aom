...
import {
  archeryIntroParagraphs,
  archeryOverviewSection,
  archeryPageTitle,
  famousArcheryPlayersSection,
  relatedTermsSection,
  trophiesSection,
} from '@/assets/general-awareness/sports/archery'
...
const Archery = ({ showBackNav = false }: ArcheryProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {archeryOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={archeryOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {archeryOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={archeryOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                {archeryIntroParagraphs.map((p, i) => (
                  <p
                    key={i}
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousArcheryPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousArcheryPlayersSection.lines} />
          </SectionShell>
        </div>
