...
import {
  aibaSection,
  asianBoxingChampionshipsSection,
  boxingIntroParagraph,
  boxingOverviewSection,
  boxingPageTitle,
  famousBoxingPlayersSection,
  mensWorldBoxingChampionshipLine,
  relatedTermsSection,
  trophiesSection,
  womensBoxingWorldChampionshipSection,
} from '@/assets/general-awareness/sports/boxing'
...
const Boxing = ({ showBackNav = false }: BoxingProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {boxingOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={boxingOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {boxingOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={boxingOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <p className="min-w-0 flex-1 leading-relaxed text-slate-300">{boxingIntroParagraph}</p>
            </div>
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{aibaSection.heading}</SectionHeading>
            </div>
            <DotBulletList items={aibaSection.lines} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="leading-relaxed text-slate-300">{asianBoxingChampionshipsSection.introParagraph}</p>
                <BlockTitleAndCategories
                  blockTitle={asianBoxingChampionshipsSection.blockTitle}
                  items={asianBoxingChampionshipsSection.blockArrowBullets}
                />
              </div>
            </div>
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">
                {womensBoxingWorldChampionshipSection.heading}
              </SectionHeading>
            </div>
            <ArrowBulletList items={womensBoxingWorldChampionshipSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <p className="min-w-0 flex-1 leading-relaxed text-slate-300">{mensWorldBoxingChampionshipLine}</p>
            </div>
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousBoxingPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousBoxingPlayersSection.lines} />
          </SectionShell>
        </div>
