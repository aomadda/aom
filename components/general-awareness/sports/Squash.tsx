...
import {
  famousSquashPlayersSection,
  relatedTermsSection,
  squashIntroParagraphs,
  squashOverviewSection,
  squashPageTitle,
} from '@/assets/general-awareness/sports/squash'
...
const Squash = ({ showBackNav = false }: SquashProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {squashOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={squashOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {squashOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={squashOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousSquashPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousSquashPlayersSection.lines} />
          </SectionShell>
        </div>
