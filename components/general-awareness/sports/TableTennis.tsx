...
import {
  famousTableTennisPlayersSection,
  relatedTermsSection,
  tableTennisIntroParagraphs,
  tableTennisOverviewSection,
  tableTennisPageTitle,
  trophiesSection,
} from '@/assets/general-awareness/sports/table-tennis'
...
const TableTennis = ({ showBackNav = false }: TableTennisProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <p className="min-w-0 flex-1 text-base leading-relaxed text-slate-200 sm:text-lg">
                {tableTennisOverviewSection.intro}
              </p>
            </div>
            ...
            <div className="mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {tableTennisOverviewSection.keyFeaturesHeading}
              </h3>
            </div>
            <ArrowBulletList className="mt-2" items={tableTennisOverviewSection.keyFeatures} />
            ...
            <div className="mt-7 mb-2 flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold tracking-tight text-emerald-100 sm:text-lg">
                {tableTennisOverviewSection.basicRulesHeading}
              </h3>
            </div>
            <NumberedLines lines={tableTennisOverviewSection.basicRules} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                {tableTennisIntroParagraphs.map((p, i) => (
                  <p
                    key={i}
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{famousTableTennisPlayersSection.heading}</SectionHeading>
            </div>
            <NumberedLines lines={famousTableTennisPlayersSection.lines} />
          </SectionShell>
        </div>
