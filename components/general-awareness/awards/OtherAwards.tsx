...
import { Award, ChevronRight, Globe, Leaf, Medal, ScrollText, Sparkles, Star, Trophy } from 'lucide-react'

import {
  ernstYoungEntrepreneurSection,
  ernstYoungLifetimeSection,
  globalAgricultureLeadershipAwardSection,
  goldenPeacockAwardsSection,
  otherAwardsTitle,
  pritzkerArchitecturePrizeSection,
  pulitzerPrizeSection,
  rightLivelihoodAwardSection,
  tangPrizeSection,
  templetonPrizeSection,
  whitelyAwardsSection,
  worldFoodPrizeSection,
} from '@/assets/general-awareness/awards/other-awards'

type OtherAwardsProps = {
  showBackNav?: boolean
}
...
const OtherAwards = ({ showBackNav = false }: OtherAwardsProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{whitelyAwardsSection.heading}</SectionHeading>
            </div>
            {whitelyAwardsSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={whitelyAwardsSection.arrowBullets} />
            <NumberedLines title={whitelyAwardsSection.for2021Title} lines={whitelyAwardsSection.for2021Lines} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{rightLivelihoodAwardSection.heading}</SectionHeading>
            </div>
            {rightLivelihoodAwardSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={rightLivelihoodAwardSection.arrowBullets} />
            <NumberedLines title={rightLivelihoodAwardSection.for2020Title} lines={rightLivelihoodAwardSection.for2020Lines} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{worldFoodPrizeSection.heading}</SectionHeading>
            </div>
            {worldFoodPrizeSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={worldFoodPrizeSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{pulitzerPrizeSection.heading}</SectionHeading>
            </div>
            {pulitzerPrizeSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={pulitzerPrizeSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{pritzkerArchitecturePrizeSection.heading}</SectionHeading>
            </div>
            {pritzkerArchitecturePrizeSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={pritzkerArchitecturePrizeSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{templetonPrizeSection.heading}</SectionHeading>
            </div>
            {templetonPrizeSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <ArrowBulletList items={templetonPrizeSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{tangPrizeSection.heading}</SectionHeading>
            </div>
            {tangPrizeSection.introParagraphs.map((p, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {p}
              </p>
            ))}
            <NumberedLines lines={tangPrizeSection.categoriesNumbered} />
            <ArrowBulletList items={tangPrizeSection.arrowBullets} />
            <BlockTitleAndCategories blockTitle={tangPrizeSection.blockTitle} items={tangPrizeSection.for2020CategoryBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{goldenPeacockAwardsSection.heading}</SectionHeading>
            </div>
            <p className="leading-relaxed text-slate-300">{goldenPeacockAwardsSection.paragraph}</p>
            <ArrowBulletList items={goldenPeacockAwardsSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{globalAgricultureLeadershipAwardSection.heading}</SectionHeading>
            </div>
            <ArrowBulletList items={globalAgricultureLeadershipAwardSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{ernstYoungEntrepreneurSection.heading}</SectionHeading>
            </div>
            <p className="leading-relaxed text-slate-300">{ernstYoungEntrepreneurSection.paragraph}</p>
            <ArrowBulletList items={ernstYoungEntrepreneurSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{ernstYoungLifetimeSection.heading}</SectionHeading>
            </div>
            <p className="leading-relaxed text-slate-300">{ernstYoungLifetimeSection.paragraph}</p>
            <ArrowBulletList items={ernstYoungLifetimeSection.arrowBullets} />
          </SectionShell>
        </div>
