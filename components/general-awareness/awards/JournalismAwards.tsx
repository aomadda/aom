...
import { Award, ChevronRight, Globe, Medal, Newspaper, ScrollText, Sparkles, Trophy } from 'lucide-react'

import {
  chameliDeviJainAwardSection,
  gkReddyLifetimeAchievementAwardSection,
  homiJBabaMemorialAwardSection,
  journalismAwardsTitle,
  lalBahadurShastriNationalAwardSection,
  ramnathGoenkaSection,
  worldPressFreedomPrizeSection,
} from '@/assets/general-awareness/awards/journalism-awards'

type JournalismAwardsProps = {
  showBackNav?: boolean
}
...
const JournalismAwards = ({ showBackNav = false }: JournalismAwardsProps) => {
  return (
        ...
        <div className="space-y-8 sm:space-y-10">
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{ramnathGoenkaSection.heading}</SectionHeading>
            </div>
            <DotBulletList items={ramnathGoenkaSection.dotBullets} />
            <ArrowBulletList items={ramnathGoenkaSection.arrowBullets} />
            <NumberedLines title={ramnathGoenkaSection.awards2018Title} lines={ramnathGoenkaSection.awards2018Lines} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{chameliDeviJainAwardSection.heading}</SectionHeading>
            </div>
            <DotBulletList items={chameliDeviJainAwardSection.dotBullets} />
            <ArrowBulletList items={chameliDeviJainAwardSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{homiJBabaMemorialAwardSection.heading}</SectionHeading>
            </div>
            <ArrowBulletList items={homiJBabaMemorialAwardSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{lalBahadurShastriNationalAwardSection.heading}</SectionHeading>
            </div>
            <DotBulletList items={lalBahadurShastriNationalAwardSection.dotBullets} />
            <ArrowBulletList items={lalBahadurShastriNationalAwardSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{gkReddyLifetimeAchievementAwardSection.heading}</SectionHeading>
            </div>
            {gkReddyLifetimeAchievementAwardSection.introLines.map((line, i) => (
              <p key={i} className={i === 0 ? 'leading-relaxed text-slate-300' : 'mt-3 leading-relaxed text-slate-300'}>
                {line}
              </p>
            ))}
            <ArrowBulletList items={gkReddyLifetimeAchievementAwardSection.arrowBullets} />
          </SectionShell>
          ...
          <SectionShell>
            <div className="mb-6 flex items-start gap-3 sm:gap-4">
              ...
              <SectionHeading className="mb-0 min-w-0 flex-1">{worldPressFreedomPrizeSection.heading}</SectionHeading>
            </div>
            <DotBulletList items={worldPressFreedomPrizeSection.dotBullets} />
            <ArrowBulletList items={worldPressFreedomPrizeSection.arrowBullets} />
          </SectionShell>
        </div>
...
export default JournalismAwards
