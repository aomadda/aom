...
import { february } from '@/assets/general-awareness/important-days'

type FebruaryProps = {
  showBackNav?: boolean
}

const February = ({ showBackNav = false }: FebruaryProps) => {
  return (
