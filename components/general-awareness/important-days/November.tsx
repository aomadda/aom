...
import { november } from '@/assets/general-awareness/important-days'

type NovemberProps = {
  showBackNav?: boolean
}

const November = ({ showBackNav = false }: NovemberProps) => {
  return (
