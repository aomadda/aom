...
import { december } from '@/assets/general-awareness/important-days'

type DecemberProps = {
  showBackNav?: boolean
}

const December = ({ showBackNav = false }: DecemberProps) => {
  return (
