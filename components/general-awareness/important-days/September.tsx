...
import { september } from '@/assets/general-awareness/important-days'

type SeptemberProps = {
  showBackNav?: boolean
}

const September = ({ showBackNav = false }: SeptemberProps) => {
  return (
