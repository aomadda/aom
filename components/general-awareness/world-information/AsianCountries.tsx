...
import * as AC from '@/assets/general-awareness/world-information/asian-countries'

type AsianCountriesProps = {
  showBackNav?: boolean
}

const detailFields: readonly {
  label: string
  key: keyof AC.AsianCountryRow
...
function CountryCard({ index, row }: { index: number; row: AC.AsianCountryRow }) {
  return (
...
const AsianCountries = ({ showBackNav = false }: AsianCountriesProps) => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-b from-slate-950 via-slate-900 to-emerald-950/80">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="space-y-6 sm:space-y-7">
          {AC.asianCountriesRows.map((row, i) => (
