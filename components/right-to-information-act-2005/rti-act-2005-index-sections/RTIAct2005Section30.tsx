      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Power to remove difficulties Section */}
                  ...
                  <div className="group relative overflow-hidden rounded-xl border border-cyan-300/30 bg-white/10 p-4 lg:p-5 shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/15 hover:shadow-cyan-500/20">
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 lg:gap-4">
                      ...
                      <div className="w-full text-left">
                        ...
                        <div className="mt-1 rounded-lg border border-orange-400/35 bg-orange-500/20 p-3 shadow-sm">
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                            <span className="font-semibold text-orange-300">Provided that</span> no such order shall be made after the expiry of a period of two years from the date of the commencement of this Act.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default RTIAct2005Section30
