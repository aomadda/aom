      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Power to make rules by appropriate Government Section */}
                      ...
                      <div className="w-full text-left">
                        ...
                        <div className="ml-4 space-y-2 border-l border-cyan-300/30 pl-4">
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">a</span>
                            the cost of the medium or print cost price of the materials to be disseminated under sub-section (4) of section 4;
                          </p>
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">b</span>
                            the fee payable under sub-section (1) of section 6;
                          </p>
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">c</span>
                            the fee payable under sub-sections (1) and (5) of section 7;
                          </p>
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <sup className="text-yellow-300 font-semibold">1</sup>{' '}[<span className="inline-flex min-w-10 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-11 sm:px-2.5 sm:text-sm mr-1.5">ca</span>
                          ...
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-10 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-11 sm:px-2.5 sm:text-sm mr-2">cb</span>
                            the salaries, allowances and other terms and conditions of service of the Chief Information Commissioner and the Information Commissioners under sub-section (5) of section 13 and the State Chief Information Commissioner and the State Information Commissioners under sub-section (5) of section 16;]
                          </p>
                          <div className="rounded-lg border border-yellow-400/40 bg-yellow-500/15 p-3 text-yellow-200/95 shadow-sm backdrop-blur-sm">
                            <p className="text-sm leading-relaxed lg:text-base italic">
                              <span className="font-semibold text-yellow-300 not-italic">1.</span> Ins. by Act 24 of 2019, s. 4, (w.e.f. 24-10-2019).
                            </p>
                          </div>
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">d</span>
                          ...
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">e</span>
                          ...
                          <p className="text-gray-300 lg:text-base text-sm leading-relaxed">
                            <span className="inline-flex min-w-9 justify-center rounded-full bg-cyan-500/20 px-2 py-0.5 text-xs font-bold text-cyan-200 sm:min-w-9 sm:px-2 sm:text-sm mr-2">f</span>
...
export default RTIAct2005Section27
