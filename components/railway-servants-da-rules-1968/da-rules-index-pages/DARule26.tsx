                  ...
                  <div className="text-gray-200 lg:text-lg text-base leading-relaxed space-y-3 flex-1">
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center justify-center flex-col gap-2 bg-white/5 rounded-lg p-3 border border-purple-400/20 hover:bg-white/10 transition-colors">
                        ...
                        <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">Secretary, Railway Board/ Joint Secretary/Deputy Secretary.</span>
                      </div>
                      <div className="flex items-center justify-center flex-col gap-2 bg-white/5 rounded-lg p-3 border border-purple-400/20 hover:bg-white/10 transition-colors">
                        ...
                        <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">Executive Director /Director/ Joint Director.</span>
                      </div>
                    </div>
                  </div>
                </div>
