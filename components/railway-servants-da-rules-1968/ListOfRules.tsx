...
import { FileText, ChevronDown, ChevronUp, CheckCircle, BookOpenCheck, Scale, FolderOpen, AlertCircle, Gavel, MessageSquare, RefreshCw, Settings, List } from 'lucide-react'
