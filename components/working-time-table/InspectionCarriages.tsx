        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="lg:text-5xl text-3xl font-bold bg-linear-to-r from-white via-yellow-100 to-orange-100 bg-clip-text text-transparent mb-4 animate-fade-in">
              Attachment of Inspection Carriages
            </h1>
            <p className="text-gray-300 text-lg mb-6">As per Railway Board L.No.88/CHG.II/34/2 dated 16.06.2006</p>
            ...
            <div className="space-y-4">
              <div className="bg-linear-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-green-400/30">
                <div className="text-center">
                  <span className="text-gray-200 text-lg font-medium">NOT MORE THAN ONE INSPECTION CARRIAGE SHALL BE ATTACHED WITH MAIL/EXPRESS TRAINS AT A TIME.</span>
                </div>
              </div>
            </div>
          </div>
...
export default InspectionCarriages