                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc.12</h4>
                        ...
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            ...
                            <div className="text-center">
                              Statement of Class Q.1 accidents for the month of ........................ 20
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Brief particulars of accident indicating Name, Occupation, age and sex</div>
                              <div className="text-center">5</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Cause of Accident</div>
                              <div className="text-center">6</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">No & Class of ticket held and station from and to in case of passengers</div>
...
export default AMAppendixPage208A