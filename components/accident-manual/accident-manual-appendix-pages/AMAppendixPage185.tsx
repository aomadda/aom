                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form ACC.5<br />Report of Fatal / Serious Accident:</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Employee Details:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="grid grid-cols-5 gap-2 font-medium text-center">
                              <div className="p-2 bg-red-800/30 rounded">Name</div>
                              <div className="p-2 bg-red-800/30 rounded">Sex</div>
                              <div className="p-2 bg-red-800/30 rounded">Age</div>
                              <div className="p-2 bg-red-800/30 rounded">Nature of employment</div>
                              <div className="p-2 bg-red-800/30 rounded">Full Postal Address</div>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Report Letter:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div className="text-center font-bold">
                              Report of Fatal / Serious Accident
                            </div>
                            <div>
                              The Commissioner for Workmen&apos;s Compensation Sir,
                            </div>
                            <div>
                              This is to report of an accident which occurred on …..(date)……at .............. (here enter details of premises) and which resulted in the death / serious bodily injuries of the workman / workmen of whom particulars are given in the statement annexed.
                            </div>
                            <div>
                              <strong>2.</strong> The circumstances in which the death / serious bodily injuries to the workman / workmen were as under:-
                            </div>
                            <div className="ml-4 space-y-1">
                              <div><strong>(a)</strong> Time of the accident;</div>
                              <div><strong>(b)</strong> Place where the accident occurred</div>
                              <div><strong>(c)</strong> Manner in which deceased / seriously injured was / were employed at the time;</div>
                              <div><strong>(d)</strong> Cause of the accident</div>
                              <div><strong>(e)</strong> Any other relevant particulars</div>
                            </div>
                            <div>
                              Yours Faithfully,
                            </div>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="border-t border-gray-600 pt-2">
                              <p><strong>……………………………… Signature and designation of the Officer making the report</strong></p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage185
