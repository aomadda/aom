                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc. 9-D<br />Deposition of witness:</h4>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <p><strong>Deposition of Witness No….</strong></p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Witness Information:</h4>
                        ...
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <ul className="text-gray-200 space-y-3">
                            <li className="flex items-start gap-2">
                              ...
                              <span>
                                <strong>Name:</strong> ……………………………………… <strong>Age:</strong> ………………… <strong>Staff No:</strong> ………………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-orange-400 text-lg">💼</span>
                              <span>
                                <strong>Designation:</strong> ……………………… <strong>Salary:</strong> …………… <strong>Grade:</strong> ………… <strong>Headquarters Station:</strong> ………………………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-orange-400 text-lg">⏳</span>
                              <span>
                                <strong>Total Service:</strong> Years ………… Months ………… <strong>In Present Rank:</strong> ………… <strong>Previous Service:</strong> ………………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-orange-400 text-lg">🛡️</span>
                              <span>
                                <strong>On the occasion of the accident, I was on duty as:</strong> …………… at ……………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-orange-400 text-lg">⏰</span>
                              <span>
                                <strong>Duty Hours:</strong> From ………… hours to ………… hours on ………… after ………… hours rest before coming on duty.
                              </span>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              Read over, translated and accepted as correct (only in cases of illiterates or who cannot read English).
                            </div>
                            <div>
                              Signature…………………………… Date………………… of President
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage196
