                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc.10</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="text-center font-semibold text-lg mb-2">
Casualties - Persons fallen from Trains / Knocked down:
                            </div>
                            <div className="text-center">
Statement showing class P.1 & P.3 accidents for the month of ................ 20
                            </div>
                            <div className="text-center text-sm italic mt-2">
N.B: A separate statement should be submitted for each class of accident
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Statement Details:</h4>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Date and Time of accident</div>
                              <div className="text-center">2</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Place of accident</div>
                              <div className="text-center">3</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">No. and description of train, if train is involved</div>
                              <div className="text-center">4</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Brief Description of accident and cause as far as known</div>
                              <div className="text-center">5</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Particulars of persons</div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">No. & Class of Ticket held and station from & to</div>
                              <div className="text-center">10</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Brief particulars of the person killed or injured</div>
...
export default AMAppendixPage206