                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form Acc. 7<br />Statement showing Class &lsquo;A.5&rsquo; accidents for the month of ........... 20</h4>
                    </div>
                  </div>
                </div>
              </div>

              {/* Accident Summary Table Section */}
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    <div className="lg:w-14 lg:h-14 w-10 h-10 bg-gradient-to-r from-red-500 to-orange-600 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Monthly Accident Summary:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="grid grid-cols-8 gap-2 font-medium text-center text-sm">  
                              <div className="p-3 bg-red-800/30 rounded col-span-1">S.No.</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">1</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">2</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">3</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">4</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">5</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">6</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">7</div>
                            </div>
                            <div className="grid grid-cols-8 gap-2 text-center text-sm">
                              <div className="col-span-1"></div>
                              <div className="p-2 bg-red-700/20 rounded">Time and date of accident</div>
                              <div className="p-2 bg-red-700/20 rounded">Place of accident</div>
                              <div className="p-2 bg-red-700/20 rounded">Brief Particulars of accident</div>
                              <div className="p-2 bg-red-700/20 rounded">Cost of damage to engine, rolling stock, permanent way etc.</div>
                              <div className="p-2 bg-red-700/20 rounded">Cause of accident</div>
                              <div className="p-2 bg-red-700/20 rounded">Action taken against staff held responsible</div>
                              <div className="p-2 bg-red-700/20 rounded">Remarks</div>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage190B
