                        ...
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="border-t border-gray-600 pt-2">
                              ...
                              <p><strong>Date:</strong> <strong>Designation:</strong></p>
                              <p><strong>Countersigned by Medical Officer in-charge of the operation at the site of the accident</strong></p>
                              <p><strong>Signature:</strong> <strong>Designation:</strong></p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div>
                              <strong>Date:</strong> <strong>Signature of passenger</strong>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage189
