                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">  
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form Acc 1 (ii)<br />Report of untoward incident:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <h5 className="text-lg font-semibold">REPORT OF UNTOWARD INCIDENT</h5>
                            <div className="text-sm">
                              <p><strong>From:</strong> Station</p>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              <strong>Kilometer at which untoward incident occurred.</strong>
                            </div>
                            <div>
                              <strong>Name of the Loco Pilot of the train with his headquarters</strong>
                            </div>
                            <div>
                              <strong>Name of the Guard of the train with his headquarters.</strong>
                            </div>
                            <div>
                              <strong>Name of the train ticket examiner of the train, if posted, with his headquarters</strong>
                            </div>
                            <div>
                              <strong>5. Nature of the untoward incident.</strong>
                            </div>
                            <div className="ml-4 space-y-1">
                              <div>a. Accidental fall</div>
                              <div>b. Bomb blast</div>
                              <div>c. Rioting/shoot out</div>
                              <div>d. others</div>
                            </div>
                            <div>
                              <strong>6. Time of occurrence</strong>
                            </div>
                            <div>
                              <strong>7. Position of human body in relation to track</strong>
                            </div>
                            <div>
                              <strong>8. Whether medical help was given to the injured.</strong>
                            </div>
                            <div>
                              <strong>9. Whether train stopped or not</strong>
                            </div>
                            <div>
                              <strong>10. Condition of doors and occupation of coach.</strong>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="border-t border-gray-600 pt-2">
                              ...
                              <p><strong>Name of Station Superintendent / Section In charge</strong></p>
...
export default AMAppendixPage178