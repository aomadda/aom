                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc. 9-E<br />Deposition of witness (continuation sheet):</h4>
                          ...
                          <ul className="text-gray-200 space-y-3">
                            <li className="flex items-start gap-2">
                              ...
                              <span>
                                ...
                                <strong>Age:</strong> …………… <strong>Staff No:</strong> ……………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-lg">🏢</span>
                              <span>
                                <strong>Designation:</strong> …………… <strong>Salary:</strong> …………… <strong>Grade:</strong> …………… <br />
                                <strong>Headquarters Station:</strong> ………………………………………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-lg">📅</span>
                              <span>
                                <strong>Total Length of Service:</strong> Years …………… Months ……………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-lg">⏳</span>
                              <span>
                                <strong>Length of Service in Present Rank:</strong> ………………………………………
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                            ...
                            <li className="flex items-start gap-2">
                              <span className="text-lg">⏰</span>
                              <span>
                                <strong>From:</strong> …………… hours <strong>to</strong> …………… hours on …………… <br />
                                after …………… hours rest before coming on duty.
                              </span>
                            </li>
                          </ul>
                        </div>
...
export default AMAppendixPage197
