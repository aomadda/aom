                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">  
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form Acc 1 (i)<br />Report of accident:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <h5 className="text-lg font-semibold">REPORT OF ACCIDENT</h5>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <ol className="space-y-3 list-decimal list-inside">
                              ...
                              <li>Train No. and engine No.</li>
                              <li>System of working</li>
                              <li>Number of tracks</li>
                              <li>Gauge</li>
                              <li>Section.</li>
                              <li>Location</li>
                              <li>Load of train/trains.</li>
                              <li>Nature of accident</li>
                              <li>Weather</li>
                              <li>Division</li>
                              <li>District and State</li>
                              <li>Sectional Speed</li>
                              <li>Brief particulars</li>
                              <li>Casualties.</li>
                            </ol>
                          </div>
                        </div>
...
export default AMAppendixPage177