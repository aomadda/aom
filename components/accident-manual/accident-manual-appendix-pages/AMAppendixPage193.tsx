                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc. 9-A<br />Formation of Inquiry Committee:</h4>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <p><strong>Proceedings of * ……………………………Inquiry, Class of Accident ……….…on………... Held at …………………………………</strong></p>
                            <p><strong>Authority ……………………………… by a committee formed of</strong></p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Committee Members:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              <strong>(1) President</strong>…………………………………….. Name…………………………………….Department………………………………….. Rank…………………………………….
                            </div>
                            <div>
                              <strong>(2) Member</strong>…………………………………….. Name……………………………………Department………………………………….. Rank…………………………………….
                            </div>
                            <div>
                              <strong>(3) Member</strong>…………………………………….. Name……………………………………Department………………………………….. Rank…………………………………….
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Also Present:</h4>
                        ...
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div className="ml-4 space-y-1">
                              <div><strong>(1) Name</strong> ……………………………………….</div>
                              <div>Department…………………………..… Rank…………………………………….</div>
                              <div className="mt-2 p-2 bg-red-800/20 rounded text-sm">
                                *State whether joint, inter-Departmental or Departmental.
                              </div>
                              <div><strong>(2) Name</strong> ………………………………………. Department…………………………….…</div>
                              <div>Rank…………………………………….</div>
                              <div><strong>(3) Name</strong> ………………………………………. Department…………………………….…</div>
                              <div>Rank…………………………………….</div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Not Present:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              Not present, although advised…………………………………….. Name……………………………..…
                            </div>
                            <div>
                              Department………………………………… Rank…………………………………….
                            </div>
...
export default AMAppendixPage193
