                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc. 9-G<br />Joint finding:</h4>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <h5 className="text-lg font-semibold">Joint Finding</h5>
                            <p><strong>(Cause, Responsibility and Rules Violated)</strong></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              The finding should be brief and concise and reference to the Rules violated and by whom should be specifically stated.
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage199
