                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form Acc. 8<br />Statement showing Class B.5 accidents for the month of .................. 20..</h4>
                    </div>
                  </div>
                </div>
              </div>
...
export default AMAppendixPage191
