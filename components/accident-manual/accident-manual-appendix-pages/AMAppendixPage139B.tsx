...
const AMAppendixPage139B = () => {
  const firstAidContents = [
    { number: 1, item: 'Set of splints', quantity: 1 },
    { number: 2, item: 'Roller Bandage', quantity: 10 },
    { number: 3, item: 'Triangular bandages', quantity: 4 },
    { number: 4, item: 'Tourniquet/Rubber bandages', quantity: 2 },
    { number: 5, item: 'Cotton Wool', quantity: 4 },
    { number: 6, item: 'Safety Pins', quantity: 10 },
    { number: 7, item: 'Adhesive Dressing', quantity: 20 },
    { number: 8, item: 'Paracetamol Tab', quantity: 20 },
    { number: 9, item: 'Diazepam Tab', quantity: 10 },
    { number: 10, item: 'Antiseptic Cream', quantity: 1 },
    { number: 11, item: 'Injury Card', quantity: 1 }
  ]
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-6">
                  ...
                  {/* First Aid Contents Grid */}
                  <div className="grid lg:grid-cols-2 gap-4">
                    {firstAidContents.map((item, index) => (
                      <div
                        key={index}
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-3 py-1 rounded-full text-sm font-bold">
                                {item.quantity}
                              </span>
                            </div>
                          </div>
...
export default AMAppendixPage139B