                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Quarterly statement of accidents under Section 113: Form Acc.13</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="text-center">
                              Statement showing summary of accidents under Section 113 of Railways Act 1989 for Quarter ending…………………….
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Date of accident</div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Train/Trains involved</div>
                              <div className="text-center">4</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Whether report sent to CRS. If so reference</div>
                              <div className="text-center">5</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">When likely to be sent</div>
                              <div className="text-center">6</div>
                            </div>
                            <div className="grid grid-cols-1 gap-4">
                              <div className="font-semibold text-center">Namely – Collisions / Derailments / Level Crossing Accidents and Fires in trains / Passenger train running over obstructions.</div>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage208B