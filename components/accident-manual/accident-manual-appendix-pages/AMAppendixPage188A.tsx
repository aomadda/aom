                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">A. Reporter&apos;s Diary:<br />Details of staff ordered to assist the Reporter.</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <h5 className="text-lg font-semibold">Specimen form Acc. 6-A</h5>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Staff Assistance Details:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 lg:p-4 p-2 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="grid grid-cols-7 gap-2 font-medium text-center text-sm">
                              <div className="p-3 bg-red-800/30 rounded col-span-1">Name of staff</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-1">Designation</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-2">Painted No. of Carriage allotted</div>
                              <div className="p-3 bg-red-800/30 rounded col-span-3">Serial Nos. of forms handed over to staff ordered to assist the reporter</div>
                            </div>
                            <div className="grid grid-cols-7 gap-2 text-center text-sm">
                              <div className="col-span-4"></div>
                              <div className="p-2 bg-red-700/20 rounded">Form &lsquo;A&rsquo;</div>
                              <div className="p-2 bg-red-700/20 rounded">Form &lsquo;B&rsquo;</div>
                              <div className="p-2 bg-red-700/20 rounded">Form &lsquo;C&rsquo;</div>
                            </div>
                          </div>
                        </div>
                      </div>
