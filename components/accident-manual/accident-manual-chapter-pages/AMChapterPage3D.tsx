      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-orange-300 mb-4">OTHER TRAIN ACCIDENTS</h2>
            <div className="w-24 h-1 bg-linear-to-r from-amber-500 to-orange-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Classification of accidents not covered under consequential train accidents
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
              {/* Rule 105.7 - Other Train Accidents */}
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-linear-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-amber-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">105.7</span>
                    </div>
                  </div>
                    ...
                    <div className="bg-linear-to-r from-amber-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-amber-400/20">
                      <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-4">
                        <p className="flex items-start gap-3">
                          <span>
                            All other accidents which are not covered under the definition of consequential train accidents are to be treated as other train accidents.
                          </span>
                        </p>
                        <div className="bg-linear-to-r from-red-500/10 to-orange-500/10 p-4 rounded-lg border border-red-400/20">
                          ...
                          <p className="text-gray-200">
                            These include accidents under categories B-5, B-6, C-5 to C-8, D-5 and E-2.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default AMChapterPage3D