      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4">INTERRUPTION</h2>
            <div className="w-24 h-1 bg-linear-to-r from-blue-500 to-indigo-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Understanding interruption duration and restoration criteria in railway accidents
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-linear-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">109</span>
                    </div>
                  </div>
                    ...
                    <div className="bg-linear-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-4">
                        <p className="flex items-start gap-3">
                          ...
                          <span>
                            Duration of interruption is defined as duration from the &quot;time of accident&quot; till &quot;starting of first commercial train&quot;( goods train or passenger train) on Line Clear from adjacent station for movement over the affected line in that section.
                          </span>
                        </p>
                        ...
                        <p className="flex items-start gap-3">
                          ...
                          <span>
                            The time of starting of the first commercial train on line clear shall be reckoned as the time of restoration.
                          </span>
                        </p>
                        
                        <p className="flex items-start gap-3">
                          <span className="mt-1 text-purple-400 text-xl">⚠️</span>
                          <span>
                            In case the time gap between &quot;track/OHE fit time&quot; and the &quot; time of first commercial train passing over the accident spot&quot; is more than 30&quot;, then the restoration will be categorized as &quot;delay in restoration&quot; of traffic.
                          </span>
                        </p>
                        ...
                        <p className="flex items-start gap-3">
                          ...
                          <span>
                            In case the delay is due to non availability of commercial train for starting immediately, the same has to be certified at the level of COM, then that case will not be treated as delay in restoration.
                          </span>
                        </p>
                      </div>
                    </div>
...
export default AMChapterPage6A