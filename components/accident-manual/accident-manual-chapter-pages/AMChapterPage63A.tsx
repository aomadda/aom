                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">601</span>
                    </div>
                  </div>
                ...
                <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-6">
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-200 leading-relaxed">
                      To provide immediate warning to staff of various departments in the event of an accident, Long Range Electric Sirens have been installed at the following stations in their respective divisions:
                    </p>
                  </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <p className="text-gray-200 leading-relaxed">
                                  These sirens provide immediate warning to staff of various departments during accidents.
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <p className="text-gray-200 leading-relaxed">
                                  Long Range Electric Sirens are strategically placed at key stations across all divisions.
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <p className="text-gray-200 leading-relaxed">
                                  Each division has multiple siren locations for comprehensive coverage.
                                </p>
                              </div>
                            </div>
                          </div>
...
export default AMChapterPage63A