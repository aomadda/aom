                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">705</span>
                    </div>
                  </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                              <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">a) Centralized Issue and GM Approval</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              The issue of such complimentary passes may be centralized in the General Manager&apos;s office and should have the approval of the General Manager.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-orange-400/30">
                              <h4 className="text-lg font-bold text-orange-300 mb-3 text-center">b) Limit to Two Relatives</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Such complimentary passes may be issued to not more than two relatives of the injured or deceased passenger.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-cyan-400/30">
                              <h4 className="text-lg font-bold text-cyan-300 mb-3 text-center">c) Safeguards Against Misuse</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Sufficient safeguard may be adopted so that these passes are not misused. Break of journeys on such passes should NOT be allowed.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/30">
                              <h4 className="text-lg font-bold text-yellow-300 mb-3 text-center">d) Half Yearly Statement</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              The complimentary passes so issued may be included in the half yearly statement submitted to the Board.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default AMChapterPage92