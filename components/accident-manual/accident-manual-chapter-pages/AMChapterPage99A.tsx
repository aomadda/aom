                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">901</span>
                    </div>
                  </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-red-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-red-400/30">
                              <h4 className="text-lg font-bold text-red-300 mb-3 text-center">901.1 Suspension of Staff</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Staff alleged to be guilty of offences which, in the opinion of the Divisional Railway Manager or the concerned Divisional Officer would, if proved, amounting in their removal from service /dismissal, shall be placed under suspension, pending the result of the inquiry.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-orange-500/20 to-yellow-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-orange-400/30">
                              <h4 className="text-lg font-bold text-orange-300 mb-3 text-center">901.2 Loco Pilot Vision Test</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              In case of a Loco Pilot passing a fixed stop signal at ON or Engineering Stop Indicator or running into banner flags, and if there are grounds for suspecting that the accident may be due to defective vision, the Loco Pilot shall be placed under suspension and directed immediately for vision test.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                              <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">901.3 Suspension Procedure</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Whenever any member of the staff is placed under suspension in consequence of an accident, the usual procedure regarding suspension of staff shall be observed.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default AMChapterPage99A