                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">924</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="lg:text-2xl text-xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                      ...
                      Matters Brought to Light during the Inquiry
                    </h3>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="space-y-4">
                          <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                            <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">Matters Brought to Light Guidelines</h4>
                          </div>
                          ...
                          <ul className="space-y-3 text-gray-200 leading-relaxed">
                            <li className="flex items-start gap-2">
                              ...
                              <span>
                                Any irregularities in working, which might potentially lead to an accident—even if not directly related to the present accident—should be clearly indicated during the inquiry.
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-green-400 text-xl mt-0.5">📝</span>
                              <span>
                                If no such matters are found, a <b>&apos;nil&apos;</b> entry should be made in Form Acc. 9 (H).
                              </span>
                            </li>
                          </ul>
                        </div>
...
export default AMChapterPage109C