        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              ASSISTANCE OF THE DISTRICT POLICE
            </p>
          </div>
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">941</span>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-6">
                  ...
                  {/* District Police Assistance Content */}
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200 leading-relaxed">Subject to the provisions contained in these rules the further prosecution of the case on the conclusion of the police investigation, shall rest with the Railway Police.</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default AMChapterPage118B