      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4">COLLISIONS</h2>
            <div className="w-24 h-1 bg-linear-to-r from-blue-500 to-indigo-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Detailed explanation of train collision types and exclusions
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-linear-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-red-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">105.3</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    ...
                    <div className="bg-linear-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20">
                      <ul className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 space-y-4 max-w-2xl mx-auto">
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-blue-400 text-xl">🚆</span>
                          <span>
                            Refers to the impact of a train against another train or vehicle.
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span>
                            ...
                            <ul className="ml-6 mt-1 space-y-1">
                              <li className="flex items-center gap-2"><span className="text-pink-400">🔴</span> Head-on collision</li>
                              <li className="flex items-center gap-2"><span className="text-orange-400">🟠</span> Rear collision</li>
                              <li className="flex items-center gap-2"><span className="text-yellow-400">🟡</span> Side collision</li>
                            </ul>
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span>
                            Excludes impact of wagons due to rough shunting without casualties and with negligible damage.
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1 text-indigo-400 text-xl">❌</span>
                          <span>
                            Also excludes accidents at level crossings.
                          </span>
                        </li>
                      </ul>
                    </div>
...
export default AMChapterPage2G