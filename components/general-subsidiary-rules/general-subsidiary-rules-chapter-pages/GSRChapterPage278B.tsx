                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">15.24</span>
                      </div>
                    ...
                    <div className="mt-8 space-y-6 lg:space-y-8">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Ordinary Trollies and Lorries shall be worked only during day light hours.
                            </p>
                            <p>
                              However, during day, when there is rain, thick, foggy or tempestuous weather impairing
                            </p>
                            <p>
                              visibility and always at night, Trollies and Lorries shall be worked under the rules for working
                            </p>
                            <p>
                              of trains.
                            </p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Whenever a Trolley/Lorry is to be worked under block protection on a double
                            </p>
                            <p>
                              line section or on a single line section where tokenless block instruments are provided, the
                            </p>
                            <p>
                              Station Masters on either side of the block section shall adhere to the procedure given in
                            </p>
                            <p>
                              S.R.15.25.7.2. &apos;Trolley/Lorry on line&apos; cap shall be placed at both stations on the plunger of
                            </p>
                            <p>
                              the block instruments to serve as a visual reminder that the section is occupied.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When Trolley/Lorry is to be worked under block protection, if the visibility is
                            </p>
                            <p>
                              impaired, due to rain, thick, foggy or tempestuous weather or any other cause, the
                            </p>
                            <p>
                              Trolley/Lorry shall be removed from the line and not replaced until the visibility is adequate.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center gap-4">
                            <span className="text-base font-semibold tracking-wide text-pink-100 lg:text-lg">
                              S.R. 15.24.2. Placing of Trollies/Lorries in Track Circuited yards:-
                            </span>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-teal-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              A Trolley/Lorry which is not insulated shall not enter or be placed on the line
                            </p>
                            <p>
                              within station limits at stations where track circuits are provided.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The person in-charge of a Trolley or Lorry before placing the Trolley/Lorry on
                            </p>
                            <p>
                              line at such stations shall give in writing to the Station Master concerned that the
                            </p>
                            <p>
                              Trolley/Lorry is insulated.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Station Master shall permit a Trolley/Lorry to be placed on the line only
                            </p>
                            <p>
                              after getting the written advice referred in clause 2.2.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The person in-charge of a Trolley/Lorry should have the insulation of his
                            </p>
                            <p>
                              Trolley tested and certified once in every six months by an Inspector of the S&T department.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage278B