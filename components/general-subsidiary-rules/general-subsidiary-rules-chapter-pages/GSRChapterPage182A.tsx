                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">7.01</span>
                      </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>All trains working between stations shall be worked on one of the following systems, namely:––</p>
                            <div className="space-y-3 pl-4 border-l-2 border-cyan-400/30 mt-4">
                              <div>
                                <span className="font-semibold text-cyan-200">(a)</span> the Absolute Block System,
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(b)</span> the Automatic Block System,
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(c)</span> the Following Trains System,
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(d)</span> the Pilot Guard System,
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(e)</span> the Train-staff and Ticket System, or
                              </div>
                              <div>
                                <span className="font-semibold text-cyan-200">(f)</span> the One Train Only System.
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Absolute Block and the Automatic Block Systems alone shall be used on every railway, except any railway or portion of a railway on which the use of any other system of working mentioned in sub-rule (1) may be sanctioned under special instructions subject to the conditions applicable to each system as described in these rules.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-yellow-100/90 lg:text-lg italic">
                            <p>
                              (SR 7.01 is deleted vide S. No. 1 of AS 07 of G&SR 2020 dated 19.01.2023).
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage182A
