                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">5.21</span>
                      </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              &ldquo;Loose shunting&rdquo; means vehicles being pushed by an engine and being allowed
                            </p>
                            <p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Loose shunting of or against loaded or empty oil tank wagons, vehicles
                            </p>
                            <p>
                              containing petrol or kerosene oil in tins, trucks loaded with heavy machinery, rails or timber,
                            </p>
                            <p>
                              cranes, loaded explosive vans, wagons loaded with live stock or military consignment,
                            </p>
                            <p>
                              articles mentioned in the Indian Explosive Act, wagons labeled &apos;not to be loose shunted&apos; and
                            </p>
                            <p>
                              coaching vehicles, even if empty, is prohibited.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              &ldquo;Fly shunting&rdquo; is a shunt movement in which two or more vehicles to be moved,
                            </p>
                            <p>
                              after being given an impetus by an engine (with or without other vehicles attached) are
                            </p>
                            <p>
                              separated at the points, by the points being reversed smartly between the vehicles, in order
                            </p>
                            <p>
                              to send them on to different lines. Fly shunting is strictly prohibited except for hump shunting
                            </p>
                            <p>
                              in hump yards.
                            </p>
...
export default GSRChapterPage149