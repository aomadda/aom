      ...
      <div className="relative z-10 py-6 px-2 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <div className="mt-4">
              <span className="text-base lg:text-xl font-medium text-blue-200 px-4">
              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">14.13</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Failure of electrical block instruments or track circuits or axle
                      counters.—
                    </p>
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If the electrical block instruments, track circuits or axle counters or
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When Line Clear has been so obtained, an entry to that effect shall be
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              PB 1 or PB 2 is used only with the co-operation of the station ahead. This cooperation
                              is given by pressing PB 3 and indicated by a white light near PB 1 or PB 2 button.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.13.1</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90">Resetting buttons for failure of Analog Axle Counter in IB section.</p>
                          </div>
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-purple-300/30 bg-purple-400/10 text-sm font-semibold tracking-wide text-purple-100 text-center lg:text-base">
                                    PB.1
                                  </span>
                                  <div className="h-[1px] flex-1 bg-gradient-to-r from-purple-300/30 via-pink-300/20 to-transparent"></div>
                                </div>
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    To reset the axle counter whenever the IB Home is passed at &apos;on&apos;.
                                  </p>
                                </div>
                              </div>
                            </div>

                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-pink-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-pink-300/30 bg-pink-400/10 text-sm font-semibold tracking-wide text-pink-100 text-center lg:text-base">
                                    PB.2
                                  </span>
                                  <div className="h-[1px] flex-1 bg-gradient-to-r from-pink-300/30 via-purple-300/20 to-transparent"></div>
                                </div>
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    To reset the axle counter due to failure or improper counting.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    To give co-operation to the station in rear.
                                  </p>
                                </div>
                              </div>
                            </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.13.2.1</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90">Resetting buttons for failure of Digital Axle Counter in IB section.</p>
                          </div>
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    To permit LSS of the rear station to be taken &apos;off&apos; whenever the IB Home is passed at
                                    &apos;on&apos;.
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    To reset the axle counter of rear section due to failure or improper counting.
                                  </p>
                                </div>
                              </div>
                            </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.13.2.2</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              PB 1 is used only with the co-operation of the station ahead. This cooperation
                              is given by pressing PB 3 and indicated by a white light near PB 1 button.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.13.2.3</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                          ...
                          <div className="space-y-6 lg:space-y-8">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    When reset is initiated, Digital Axle Counter of rear section enters into
                                    preparatory reset mode. The first train shall be dealt on authority to pass station LSS at &apos;on&apos;.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-pink-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    On clearing the section by first train on preparatory reset, if the axle counter
                                    shows clear indication at both stations, all subsequent trains can be dealt normally.
                                    However, if again the axle counter does not show clear indication, but &apos;occupied&apos; indication
                                    continuously, the Digital Axle Counter shall be treated as failed.
                                  </p>
                                </div>
                              </div>
                            </div>
...
export default GSRChapterPage247B