      ...
      <div className="relative z-10 py-6 px-2 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative">
              <div className="absolute -top-10 -left-10 w-36 h-36 bg-linear-to-br from-blue-400/30 to-purple-500/30 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-14 -right-14 w-44 h-44 bg-linear-to-br from-blue-500/20 to-indigo-600/20 rounded-full blur-3xl"></div>

              <div className="relative p-2 lg:p-10 space-y-8">
                <div className="group relative flex flex-col gap-8 rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-2 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="grid gap-8 text-base lg:text-lg">
                      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <p>
                            (1) Stations shall, for the purpose of these rules, be divided into two categories––Block stations and Non-Block stations.
                          </p>
                        </div>
                      </div>
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <p>
                            (2) Block stations are those at which the Loco Pilot must obtain an authority to proceed under the system of working to enter the block section with his train; and under the Absolute Block System consist of three classes of Block stations ––
                          </p>
                          <div className="space-y-4">
                            <p>
                              Class ‘A’ stations – where Line Clear may not be given for a train unless the line on which it is intended to receive the train is clear for at least 400 metres beyond the Home signal, or up to the Starter;
                            </p>
                            <p>
                              Class ‘B’ stations– where Line Clear may be given for a train before the line has been cleared for the reception of the train within the station section;
                            </p>
                            <p>
                              and
                            </p>
                            <p>
                              Class ‗C‘ stations – Block Huts, where Line Clear may not be given for a train unless the whole of the last preceding train has passed complete at least 400 metres beyond the Home signal and is continuing its journey. This will also include an Intermediate Block Post.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <p>
                            (3) Non-Block stations or Class ‗D‘ stations are stopping places which are situated between two consecutive block stations, and do not forms the boundary of any block section.
                          </p>
                        </div>
                      </div>
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <p>
                            S.R. 1.03. (1) The classification of a station shall be mentioned in the SWR of that station and also in the Working Time Table (WTT).
                          </p>
                          <p>
                            (2) Any Block Station which cannot be worked under Class ‘A’, Class‘ B’ or Class ‘C’ conditions is termed as Special class.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default GSRChapterPage6