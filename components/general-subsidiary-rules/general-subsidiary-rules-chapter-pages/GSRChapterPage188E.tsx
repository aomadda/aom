                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">8.16</span>
                      </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                      ...
                      <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                        <div className="space-y-6 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                          <p className="font-semibold text-lg lg:text-2xl text-white/90 mb-4">
                            Illustrative diagrams.––
                          </p>
                          <p>
                            Class &apos;A&apos;, &apos;B&apos; and &apos;C&apos; stations on single line and double line are illustrated in the following diagrams, which are not drawn to scale.
                          </p>
                          
                          {/* Images Grid */}
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE189A.png"
                                  alt="Class A Double line station diagram"
                                  fill
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE189B.png"
                                  alt="Class A Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-indigo-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE190A.png"
                                  alt="Class B Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-indigo-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE190B.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE191A.png"
                                  alt="Class B Single line station diagram with signals"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE191B.png"
                                  alt="Class B Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE192A.png"
                                  alt="Class B Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE192B.png"
                                  alt="Class B Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-indigo-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE193A.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-indigo-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE193B.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE193C.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE194A.png"
                                  alt="Class C Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-cyan-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE194B.png"
                                  alt="Class C Double line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-indigo-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE194C.png"
                                  alt="Class C Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                />
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE195A.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/30">
                              <div className="relative w-full aspect-4/3 bg-slate-900/50">
                                <Image
                                  src="/gsr-images/GSRPAGE195B.png"
                                  alt="Class B Single line station diagram"
                                  fill
                                  className="object-contain p-2"
                                  sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
...
export default GSRChapterPage188E