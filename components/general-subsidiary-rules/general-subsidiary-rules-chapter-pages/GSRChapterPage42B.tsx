        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-2xl lg:text-5xl font-bold tracking-wide bg-linear-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent">
              Minimum equipment of fixed signals at stations provided with modified
                  ...
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1 space-y-4">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Modified lower quadrant signalling may be introduced only where it is expressly sanctioned by a special order of the Railway Board. The minimum equipment of fixed signals to be provided for each direction shall be as follows–
                      </p>
                      <div className="space-y-2 ml-0 lg:ml-8">
                        <div className="flex items-start gap-3 lg:gap-4">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            at class &apos;B&apos; stations … a Distant, a Home, a Warner below the Main Home and a Starter and
                          </p>
                        </div>
                        <div className="flex items-start gap-3 lg:gap-4">
                          <div className="shrink-0">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            at class &apos;C&apos; stations … a Distant and a Home.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        <span className="font-semibold text-emerald-300">S.R.3.28.</span> Modified lower quadrant signalling is not provided on this railway.
                      </p>
                    </div>
                  </div>
                </div>
...
export default GSRChapterPage42B