        ...
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative p-2 lg:p-10">
              ...
              <div className="relative z-10 group overflow-hidden rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-6 lg:p-10 transition-all duration-500 hover:border-white/20 hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
...
export default GSRChapterPage10A