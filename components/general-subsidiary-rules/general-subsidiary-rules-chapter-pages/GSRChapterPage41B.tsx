                      ...
                      <div className="space-y-2 ml-0 lg:ml-8">
                        <div className="flex items-start gap-3 lg:gap-4">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            At stations between which trains are worked on the One Train Only System, and
                          </p>
                        </div>
                        <div className="flex items-start gap-3 lg:gap-4">
                          <div className="shrink-0">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            At stations which are exempted from the provision of signals under approved special instructions.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default GSRChapterPage41B