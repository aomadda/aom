              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">8.09</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="mb-4">
                      <p className="font-semibold text-lg lg:text-xl text-purple-200 mb-2">
                        D.2. Class &apos;B&apos; stations
                      </p>
                    </div>
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Obstruction in the face of an approaching train at a class &apos;B&apos; station on single line.––
                    </p>
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The line outside the Home signal in two-aspect signalling territory or outermost facing points in multiple-aspect or modified lower quadrant signalling territory in the direction of a train for which Line Clear has been given, shall only be obstructed when a Shunting Limit Board or an Advanced Starter is provided and under special instructions which take into consideration the speed, weight and brake power of trains, the gradients, the position of the first Stop signal and the distance from which that signal can be seen by the Loco Pilot of an approaching train.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              At stations where obstruction of the line in the face of an approaching train is permitted in accordance with Rule 8.09, it shall be specifically indicated in the SWR.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              A Board shall be provided at these stations in rear of the Outer signal or Home signal, as the case may be, to warn the Loco Pilots of approaching trains that such shunting is permitted. This provision shall also be indicated in the SWR.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If obstruction in the face of an approaching train is permitted under Rule 8.09 in the SWR, shunting shall be carried out adhering strictly to the precautions laid down in Rule 5.20.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-yellow-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              All restrictions required to be observed in performing shunting at the stations concerned shall be incorporated in the SWR and rigidly complied with.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage186C