                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">10.04</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Delivery of authority to proceed to Loco Pilot or Guard on the Following Trains System.—
                    </p>
                    <div className="space-y-4 lg:space-y-6">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-cyan-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Every authority to proceed shall be delivered to the Guard or Loco
                            </p>
                            <p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-indigo-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When such authority to proceed is delivered to the Loco Pilot under
                            </p>
                            <p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-purple-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        <div className="absolute inset-0 bg-linear-to-br from-purple-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center gap-4">
                            <span className="flex lg:h-12 lg:w-12 h-10 w-10 items-center justify-center rounded-full border border-purple-400/40 bg-purple-500/10 text-base font-semibold tracking-wide text-purple-100 text-center lg:text-lg">
                              3
                            </span>
                            <div className="h-px flex-1 bg-linear-to-r from-purple-400/40 via-blue-400/30 to-transparent"></div>
                          </div>
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg mb-4">
                            <p>
                              When an authority to proceed is delivered to the Guard under sub–
                            </p>
                            <p>
                          ...
                          <div className="space-y-4 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-md">
                              <div className="relative flex flex-col gap-3 rounded-xl bg-slate-900/50 px-4 py-4 lg:px-6 lg:py-5">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-purple-400/30 bg-purple-500/10 text-sm font-semibold tracking-wide text-purple-100 text-center lg:text-base">
                                    a
                                  </span>
                                  <div className="h-px flex-1 bg-linear-to-r from-purple-400/30 via-blue-400/20 to-transparent"></div>
                                </div>
                                <div className="space-y-2 text-sm leading-relaxed text-blue-100/90 lg:text-base pl-12 lg:pl-14">
                                  <p>
                                    handed personally by the Guard to the Loco Pilot; or
                                  </p>
                                </div>
                              </div>
                            </div>
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-md">
                              <div className="relative flex flex-col gap-3 rounded-xl bg-slate-900/50 px-4 py-4 lg:px-6 lg:py-5">
                                ...
                                <div className="space-y-2 text-sm leading-relaxed text-blue-100/90 lg:text-base pl-12 lg:pl-14">
                                  <p>
                                    countersigned by the Guard and then handed to the Loco Pilot
                                  </p>
                                  <p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-blue-400/30 hover:bg-white/10">
                        <div className="absolute inset-0 bg-linear-to-br from-blue-500/10 via-blue-500/5 to-cyan-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center gap-4">
                            <span className="flex lg:h-12 lg:w-12 h-10 w-10 items-center justify-center rounded-full border border-blue-400/40 bg-blue-500/10 text-base font-semibold tracking-wide text-blue-100 text-center lg:text-lg">
                              4
                            </span>
                            <div className="h-px flex-1 bg-linear-to-r from-blue-400/40 via-blue-400/30 to-transparent"></div>
                          </div>
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg mb-4">
                            <p>
                              An authority to proceed shall not be handed to the Loco Pilot under
                            </p>
                            <p>
                              sub-rule (2) or (3) -–
                            </p>
                          ...
                          <div className="space-y-4 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-md">
                              <div className="relative flex flex-col gap-3 rounded-xl bg-slate-900/50 px-4 py-4 lg:px-6 lg:py-5">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-blue-400/30 bg-blue-500/10 text-sm font-semibold tracking-wide text-blue-100 text-center lg:text-base">
                                    a
                                  </span>
                                  <div className="h-px flex-1 bg-linear-to-r from-blue-400/30 via-blue-400/20 to-transparent"></div>
                                </div>
                                <div className="space-y-2 text-sm leading-relaxed text-blue-100/90 lg:text-base pl-12 lg:pl-14">
                                  <p>
                                    until the train is ready to start, and
                                  </p>
                                </div>
                              </div>
                            </div>
                            <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-md">
                              <div className="relative flex flex-col gap-3 rounded-xl bg-slate-900/50 px-4 py-4 lg:px-6 lg:py-5">
                                ...
                                <div className="space-y-2 text-sm leading-relaxed text-blue-100/90 lg:text-base pl-12 lg:pl-14">
                                  <p>
                                    if the train is waiting to pass another train, until the whole of the
                                  </p>
                                  <p>
...
export default GSRChapterPage226A