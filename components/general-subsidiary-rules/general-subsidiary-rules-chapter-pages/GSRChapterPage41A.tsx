              ...
              <div className="relative p-5 lg:p-10 space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Every semaphore or disc signal, the light of which cannot be seen from the place from which the signal is worked, shall be provided with a backlight to indicate whether the signal light is burning or not.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Back-lights of signals shall show a small white light when &apos;on&apos; and no light at all in any other position.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Any fixed light used in conjunction with a semaphore signal shall show a back-light.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="flex items-center justify-center flex-col gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Back-lights may not be provided when alternative arrangements are made at the place from which the signal is worked to indicate whether signal lights are burning or not.
                      </p>
                    </div>
                  </div>
                </div>
...
export default GSRChapterPage41A