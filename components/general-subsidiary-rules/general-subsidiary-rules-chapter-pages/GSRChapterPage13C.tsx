          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative">
              ...
              <div className="relative p-2 lg:p-10">
                <div className="group flex flex-col gap-5 rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                    ...
                    in tunnels and in thick, foggy or tempestuous weather impairing visibility.
                  </p>
                </div>
              </div>
            </div>
...
export default GSRChapterPage13C