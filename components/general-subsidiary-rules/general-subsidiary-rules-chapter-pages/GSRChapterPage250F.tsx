              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">14.25</span>
                      </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When owing to failure or non-provision of electrical block instruments the
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Each such ticket shall bear a serial number which shall be recorded in the
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The ticket referred in sub-rules (1) and (2) shall be printed on white paper
                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.25.1</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              On Single line, Double line and Multi line sections, when block instrument is
                              interrupted or suspended, every train shall be stopped, run through trains being stopped out
                              of course and the Station Master shall issue to the Loco Pilot of train a Paper Line Clear
                              Ticket in the prescribed form i.e.T/C 1425 or T/D 1425 which shall be the Combined Authority
                              for the train to proceed and to pass interlocked departure signals/IBS or both at ON or in
                              defective position. (Item No.38 of AS-16 Dt:14.06.24)
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90 mb-3">The prescribed Paper Line Clear form numbers are—</p>
                          </div>
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    Line Clear Enquiry Message for use by train despatching station - T/A 1425.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-pink-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    Line Clear Reply Message for use by train receiving station T/B – 1425.
                                  </p>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90 mb-3">The prescribed Paper Line Clear ticket numbers are—</p>
                          </div>
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-purple-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    Paper Line Clear Ticket – UP T/C 1425
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-pink-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    Paper Line Clear Ticket – DN T/D 1425
                                  </p>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90 mb-3">Note :</p>
                            <p>
                              On double line section between &apos;A&apos; and &apos;B&apos; block stations, in case of partial failure of
                              the Block Instruments, if the Block Instrument is working in, say UP direction (&apos;A&apos; to &apos;B&apos;) the
                              train will be dispatched after taking Line Clear on the Block Instrument from &apos;A&apos; to &apos;B&apos;. In the
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 shadow-xl shadow-purple-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">SR. 14.25.2</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Under special instructions, the formats of Paper Line Clear forms and Paper
                              Line Clear Ticket are as below… (Item No.39 of AS-16 Dt:14.06.24)
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRChapterPage250F