        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-2xl lg:text-5xl font-bold tracking-wide bg-linear-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent">
              Minimum equipment of fixed signals at other stations provided with twoaspect
signalling.—
            </h1>
          </div>
                      ...
                      <div className="space-y-3 ml-0 lg:ml-8">
                        <div className="flex items-start gap-3 lg:gap-4">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            at class &apos;A&apos; stations … a Warner, a Home and a Starter.
                          </p>
                        </div>
                        <div className="flex items-start gap-3 lg:gap-4">
                          <div className="shrink-0">
                          ...
                          <div className="flex-1 pt-0.5 space-y-2">
                            ...
                            <div className="space-y-2 ml-0 lg:ml-8">
                              <div className="flex items-start gap-3 lg:gap-4">
                                <div className="shrink-0">
                                  <div className="w-5 h-5 lg:w-7 lg:h-7 rounded-full border border-white/20 bg-linear-to-br from-purple-600/90 via-pink-600/90 to-rose-600/90 backdrop-blur-sm flex items-center justify-center shadow-md">
                              ...
                              <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide ml-4 lg:ml-8">
                                both on a single and a double line, a Warner shall be provided in accordance with Rule 3.06, if trains run through at a speed exceeding 50 kilometres an hour without stopping, and
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3 lg:gap-4">
                          ...
                          <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                            at class &apos;C&apos; stations … a Warner and a Home.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default GSRChapterPage42C