      ...
      <div className="relative z-10 py-6 px-2 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-2xl lg:text-4xl font-bold tracking-wide bg-linear-to-r from-white via-rose-100 to-amber-200 bg-clip-text text-transparent animate-[fade-in_1s_ease-out_forwards]">
              Banner flags.—
            </h1>
          </div>
...
export default GSRChapterPage65A