                  ...
                  <div className="pt-14 lg:pt-12 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-slate-900/70 p-5 lg:p-8 transition-all duration-500 hover:border-purple-400/30 hover:shadow-lg hover:shadow-purple-500/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-slate-950/80 hover:to-slate-900/80">
                      <div className="flex items-center justify-center flex-col gap-4 mb-4">
                        ...
                        <div className="flex-1 pt-1">
                          <div className="mb-2">
                            <span className="text-sm font-semibold text-purple-300/90">S.R.4.48.1.</span>
                          </div>
                          <p className="text-base lg:text-lg leading-relaxed text-purple-100/90 tracking-wide">
                            The engine of a train carrying passengers shall not be detached outside station limits except in an emergency. If it is required to be detached in an emergency the following precautions shall be taken.––
                          </p>
                        </div>
                      </div>
                      <div className="ml-0 space-y-4">
                        <div className="group rounded-lg border border-white/10 bg-linear-to-br from-slate-800/70 via-slate-900/70 to-slate-800/70 p-4 transition-all duration-500 hover:border-purple-300/20 hover:shadow-md hover:shadow-purple-400/10">
                          <div className="flex items-start gap-3">
                            <div className="shrink-0 mt-0.5">
                              <div className="w-8 h-8 rounded-full bg-linear-to-br from-purple-400/70 to-pink-500/70 border border-purple-300/20 flex items-center justify-center shadow-md shadow-purple-400/10">
                                <span className="text-sm font-bold text-white">1</span>
                              </div>
                            </div>
                            <div className="flex-1">
                              <p className="text-sm lg:text-base leading-relaxed text-purple-50/90 tracking-wide">
                                Hand brakes of all brake-vans and goods and coaching vehicles on train shall be securely applied.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="group rounded-lg border border-white/10 bg-linear-to-br from-slate-800/70 via-slate-900/70 to-slate-800/70 p-4 transition-all duration-500 hover:border-purple-300/20 hover:shadow-md hover:shadow-purple-400/10">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm lg:text-base leading-relaxed text-purple-50/90 tracking-wide">
                                The Skids/wedges shall be securely jammed under the farthermost wheels of the rake in the direction of the falling gradient
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-slate-900/70 p-5 lg:p-8 transition-all duration-500 hover:border-indigo-400/30 hover:shadow-lg hover:shadow-indigo-500/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-slate-950/80 hover:to-slate-900/80">
                      <div className="flex items-center justify-center flex-col gap-4">
                        ...
                        <div className="flex-1 pt-1">
                          <div className="mb-2">
                            <span className="text-sm font-semibold text-indigo-300/90">S.R.4.48.3.</span>
                          </div>
                          <p className="text-base lg:text-lg leading-relaxed text-indigo-100/90 tracking-wide">
                            Loco Pilot should apply the train brake (A9) to ensure that brakes are holding effectively on the wheels of the coaches/wagons before allowing detaching the locomotive in any case.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default GSRChapterPage126F