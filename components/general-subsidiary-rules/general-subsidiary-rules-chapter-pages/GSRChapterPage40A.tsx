      ...
      <div className="relative z-10 py-6 px-2 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-3xl lg:text-5xl font-bold tracking-wide bg-linear-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent">
              Signals on bracket post or signal bridge or gantry.—
            </h1>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 lg:gap-4">
                      ...
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                        so grouped that the respective signals are easily distinguishable for each running line and are placed as nearly as possible over the running lines to which they refer,
                      </p>
                    </div>
                    <div className="flex items-start gap-3 lg:gap-4">
                      <div className="shrink-0">
                      ...
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                        so placed that the signal referring to the main line is higher than the signal or signals referring to the other running line or lines and
                      </p>
                    </div>
                    <div className="flex items-start gap-3 lg:gap-4">
                      <div className="shrink-0">
                        <div className="w-6 h-6 lg:w-8 lg:h-8 rounded-full border border-white/20 bg-linear-to-br from-cyan-600/90 via-blue-600/90 to-indigo-600/90 backdrop-blur-sm flex items-center justify-center shadow-md">
                          <span className="text-xs lg:text-sm font-bold text-white">c</span>
                        </div>
                      </div>
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide flex-1 pt-0.5">
                        so arranged that the extreme left hand signal refers to the extreme left hand line and the second signal from the left refers to the next line from the left and so on.
                      </p>
                    </div>
                  </div>
                </div>
...
export default GSRChapterPage40A
