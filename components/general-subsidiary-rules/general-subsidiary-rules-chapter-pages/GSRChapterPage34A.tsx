              ...
              <div className="relative p-5 lg:p-10 space-y-6">
                  ...
                  <div className="flex items-start gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Co-acting signals are duplicate signals fixed below ordinary signals and are provided where, in consequence of the height of the signal post, or of there being an over-bridge or other obstacle, the main arm or light is not in view of the Loco Pilot during the whole time that he is approaching it.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group rounded-xl border border-white/10 bg-linear-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-5 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-linear-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="flex items-start gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 pt-1">
                      <p className="text-base lg:text-lg leading-relaxed text-blue-100/90 tracking-wide">
                        Co-acting signals shall be fitted at such height that either the main arm or light or the co-acting arm or light, is always visible.
                      </p>
                    </div>
                  </div>
                </div>
...
export default GSRChapterPage34A