                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">14.12</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Special responsibility as to electrical token instruments and to the
                      token.–
                    </p>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The Station Master shall be responsible to ensure that –
                            </p>
                          </div>
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-indigo-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-indigo-300/30 bg-indigo-400/10 text-sm font-semibold tracking-wide text-indigo-100 text-center lg:text-base">
                                    a
                                  </span>
                                  <div className="h-[1px] flex-1 bg-gradient-to-r from-indigo-300/30 via-blue-300/20 to-transparent"></div>
                                </div>
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    no one but himself operates the electrical block instruments,
                                  </p>
                                </div>
                              </div>
                            </div>

                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-cyan-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                <div className="flex items-center gap-3">
                                  <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-cyan-300/30 bg-cyan-400/10 text-sm font-semibold tracking-wide text-cyan-100 text-center lg:text-base">
                                    b
                                  </span>
                                  <div className="h-[1px] flex-1 bg-gradient-to-r from-cyan-300/30 via-blue-300/20 to-transparent"></div>
                                </div>
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    the procedure regarding bell signals and, in addition any
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-indigo-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    in the case of stopping trains, the incoming token is surrendered
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-cyan-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    when he receives the token of an incoming train, it is put in the
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-indigo-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    no one except the person authorized by special instructions
                          ...
                          <div className="space-y-6 lg:space-y-8 mt-4">
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-cyan-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    A token shall not be taken out of an electrical block instrument
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-indigo-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    On arrival of the train at the block station in advance, the Loco
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/3 shadow-md transition-all duration-500 hover:border-cyan-300/20">
                              <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/30 px-4 py-5 lg:px-6 lg:py-6">
                                ...
                                <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  <p>
                                    If the train has to return to the block station from which it started,
...
export default GSRChapterPage247A