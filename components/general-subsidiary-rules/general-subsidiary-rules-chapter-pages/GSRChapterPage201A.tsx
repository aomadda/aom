                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-2xl text-lg font-bold text-white/90">9.04</span>
                      </div>
                    ...
                    <div className="space-y-6 lg:space-y-8">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20">
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>The minimum equipment of fixed signals to be provided for each direction shall be as follows––</p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center justify-center flex-col gap-4">
                            <div className="flex items-center gap-4 w-full">
                              <span className="flex lg:h-12 lg:w-12 h-10 w-10 items-center justify-center rounded-full border border-cyan-400/40 bg-linear-to-br from-cyan-500/30 to-indigo-500/30 shadow-lg shadow-cyan-900/20 hover:scale-110 transition-transform duration-300 text-base font-semibold tracking-wide text-cyan-100 text-center lg:text-lg">
                                a
                              </span>
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-cyan-200 mb-2">Manual or Semi-automatic Stop signals at a station -</p>
                            <div className="pl-0 space-y-3">
                              <div className="relative flex gap-4 group/item">
                                <div className="shrink-0">
                                  <div className="flex items-center justify-center w-7 h-7 rounded-full bg-linear-to-br from-indigo-500/30 to-purple-500/30 border border-indigo-400/50 shadow-lg shadow-indigo-900/20 group-hover/item:scale-110 transition-transform duration-300">
                                    <span className="text-xs font-bold text-indigo-200">i</span>
                                  </div>
                                </div>
                                <div className="flex-1 pt-1 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  a Home,
                                </div>
                              </div>
                              <div className="relative flex gap-4 group/item">
                                <div className="shrink-0">
                                  <div className="flex items-center justify-center w-7 h-7 rounded-full bg-linear-to-br from-indigo-500/30 to-purple-500/30 border border-indigo-400/50 shadow-lg shadow-indigo-900/20 group-hover/item:scale-110 transition-transform duration-300">
                                    <span className="text-xs font-bold text-indigo-200">ii</span>
                                  </div>
                                </div>
                                <div className="flex-1 pt-1 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                                  a Starter.
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center justify-center flex-col gap-4">
                            <div className="flex items-center gap-4 w-full">
                              <span className="flex lg:h-12 lg:w-12 h-10 w-10 items-center justify-center rounded-full border border-indigo-400/40 bg-linear-to-br from-indigo-500/30 to-purple-500/30 shadow-lg shadow-indigo-900/20 hover:scale-110 transition-transform duration-300 text-base font-semibold tracking-wide text-indigo-100 text-center lg:text-lg">
                                b
                              </span>
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>An Automatic Stop signal in rear of the Home signal of the station.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-purple-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="flex items-center justify-center flex-col gap-4">
                            <div className="flex items-center gap-4 w-full">
                              <span className="flex lg:h-12 lg:w-12 h-10 w-10 items-center justify-center rounded-full border border-purple-400/40 bg-linear-to-br from-purple-500/30 to-pink-500/30 shadow-lg shadow-purple-900/20 hover:scale-110 transition-transform duration-300 text-base font-semibold tracking-wide text-purple-100 text-center lg:text-lg">
                                Note
                              </span>
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>Under approved special Instructions, the Automatic Stop signal may be dispensed with.</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default GSRChapterPage201A