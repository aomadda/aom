                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              An abbreviated procedure, to be adopted in case of accidents, laid down in section 24
                            ...
                            <p>
                              When an accident has occurred on a railway resulting in a temporary suspension of
                              traffic and either the original lines of rails and works have been restored to their original
                              standard or a temporary diversion has been laid for the purpose of restoring
                              communication, the original lines of rails and works so restored, or the temporary
                              diversion, as the case may be, may, without prior inspection by the Commissioner, be
                              opened for the public carriage of passengers, subject to the following conditions,
                              namely-
                            </p>
                            <div className="space-y-3 pl-4 lg:pl-6">
                              <div className="flex items-start gap-3">
                                ...
                                <p>
                                  the railway servant in-charge of the works undertaken by reason of the accident
                                  has certified in writing that the opening of the restored lines of rails and works or of
                                  the temporary diversion will not in his opinion be attended with danger to the
                                  public; and
                                </p>
                              </div>
                              <div className="flex items-start gap-3">
                                ...
                                <p>
                                  a notice of the opening of the lines of rails and works or the diversion shall be sent
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The certificate shall be signed by the representative of the works branch in charge of
                              the work before opening it. This certificate shall be despatched to the officers
                              concerned. The Engineering representative shall hand over a copy of the certificate
                              to the representative of the Transportation (Traffic) branch at the site of the accident;
                              and the latter shall not permit the passage of traffic over the restored line or the
...
export default GSRAppendixPage402A