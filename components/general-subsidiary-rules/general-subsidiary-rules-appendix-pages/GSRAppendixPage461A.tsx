            ...
            <div className="relative">
              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                <div className="space-y-4 lg:space-y-5">
                  {[
                    { num: 1, text: "Work on track circuits without causing disconnection of leads, terminals etc." },
                    { num: 2, text: "Cleaning of terminals/contacts of circuit controllers without causing energisation of lever locks." },
                    { num: 3, text: "Maintenance of reversers and signal machines without changing any parts." },
                    { num: 4, text: "Opening of covers of block instruments for visual inspection or token balancing." },
                    { num: 5, text: "Testing of points." },
                    { num: 6, text: "Testing of signals." },
                    { num: 7, text: "Lubrication and cleaning of internal parts" },
                    { num: 8, text: "Change of batteries which cause disconnection of signalling circuits." },
                    { num: 9, text: "*Cleaning of lenses inside colour light signals, by opening the doors of CLS unit." },
                    { num: 10, text: "Changing of lenses of colour light signals as well as the roundels of semaphore signals." },
                    { num: 11, text: "*Adjustment of staggering of axle counter." },
                    { num: 12, text: "*Testing and measurement of wheel dip of outdoor equipment of axle counter." }
                  ].map((item, index) => (
                  ...
                  {/* Note about asterisk items */}
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-indigo-900/20 transition-all duration-500 hover:border-indigo-400/30 hover:bg-white/10 mt-6">
                    ...
                    <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <div className="space-y-3 text-sm leading-relaxed text-blue-200/80 italic lg:text-base">
                        <p>
                          (*) These works apart from taking the consent of Station Master should be done in between
                          train timings.
                        </p>
                      </div>
                    </div>
...
export default GSRAppendixPage461A