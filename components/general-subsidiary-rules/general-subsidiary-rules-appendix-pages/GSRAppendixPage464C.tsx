                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                    ...
                    <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      ...
                      <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                        <p>The executing supervisor shall not leave the relay room to contractor staff.</p>
                      </div>
                    </div>
                  </div>

                  {/* Point 4.2 with sub-points */}
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                    <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                        <p>
                          On completion of work in Relay Room, the concerned Signal Maintainer/ Signal
                          Supervisor shall handover SM&apos;s key to the Station Master, after locking the
                          Relay Room with both keys, as per the procedure given below, and making
                          necessary entries in the Relay Room Key Register.
                        </p>
                        <div className="space-y-3 mt-4 ml-4">
                          <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <p>First properly close Relay Room / Cabin Basement door and lock it with both the keys.</p>
                            </div>
                          </div>
                          <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <p>Then return the SM Relay Room key to the SM on duty and make the entry in the Relay Room Key Register. Confirming that both locks have been properly placed.</p>
                            </div>
                          </div>
                          <div className="relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <p>Advise Section Engineer (Signal) and Divisional Signal Control Office, of the time of closing the Relay Room.</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default GSRAppendixPage464C