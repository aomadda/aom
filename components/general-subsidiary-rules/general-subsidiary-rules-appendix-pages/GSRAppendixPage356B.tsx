          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative">
              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                {/* Classification of Level Crossings Section */}
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="space-y-4 lg:space-y-5">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                        <div className="relative overflow-x-auto rounded-2xl bg-slate-900/50">
                          <table className="w-full border-collapse">
                            <thead>
                              <tr className="border-b border-white/10">
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">S. No.</th>
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">CLASS</th>
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">CRITERIA</th>
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">INTERLOCKING</th>
                              </tr>
                            </thead>
                            <tbody className="text-blue-100/90">
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base">1.</td>
                                <td className="px-4 py-3 text-sm lg:text-base">Special Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">TVUs greater than 50,000</td>
                                <td className="px-4 py-3 text-sm lg:text-base">Compulsory</td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base">2.</td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;A&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  TVUs between 50,000-30000 or line
                                  capacity utilization 80% (on single line)
                                  and number of road vehicles greater
                                  than 1000
                                </td>
                                <td className="px-4 py-3 text-sm lg:text-base">Compulsory</td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base">3.</td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;B&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  TVUs between 30,000 and 20,000 and
                                  number of road vehicles are greater
                                  than 750.
                                </td>
                                <td className="px-4 py-3 text-sm lg:text-base">- - - -</td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base"></td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;B1&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">TVUs between 30,000 and 25,000</td>
                                <td className="px-4 py-3 text-sm lg:text-base">Compulsory</td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base"></td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;B2&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">TVUs between 25,000 and 20,000</td>
                                <td className="px-4 py-3 text-sm lg:text-base">- - - -</td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base">4.</td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;C&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  All other level crossings not covered in
                                  above classes
                                </td>
                                <td className="px-4 py-3 text-sm lg:text-base">- - - -</td>
                              </tr>
                              <tr className="hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base">5.</td>
                                <td className="px-4 py-3 text-sm lg:text-base">&apos;D&apos; Class</td>
                                <td className="px-4 py-3 text-sm lg:text-base">For cattle crossings</td>
                                <td className="px-4 py-3 text-sm lg:text-base">- - - -</td>
                              </tr>
                            </tbody>
                          </table>
...
export default GSRAppendixPage356B