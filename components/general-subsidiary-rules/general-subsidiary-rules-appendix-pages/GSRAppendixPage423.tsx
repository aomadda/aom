            ...
            <div className="relative">
              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="space-y-4 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="text-base lg:text-lg text-blue-100/90">
                      Precautions to be observed during marshalling of wagons containing explosives and other dangerous goods etc.
                    </p>
                    <p className="text-base lg:text-lg text-blue-100/90">
                      The rules laid down in the I. R. C. A., Red Tariff No. 20 in regard to marshalling of explosives and other dangerous goods should be rigidly complied with. The following instructions are issued for the guidance of all concerned:–
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">1</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Precautions to be observed during marshalling of carriages/wagons containing explosives:
                    </p>
                    ...
                    <div className="space-y-4 lg:space-y-5">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>The maximum number of carriages/wagons containing explosives which may at any one time be attached to or be hauled by a train shall be ten by a goods train and three by a mixed or parcel train.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>Carriages or wagons containing explosives should be placed as far away as practicable from the train locomotive, grouping together those carriages/wagons which are permitted to be so grouped.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>Carriages/wagons containing explosives shall be separated by not less than three carriages/wagons not containing explosives or other dangerous goods or articles of inflammable nature from –</p>
                            <div className="pl-4 space-y-2 mt-4">
                              <p className="flex items-start gap-2">
                                <span className="text-cyan-400 font-semibold">1.</span>
                                <span>the locomotive, provided that when an electric or diesel locomotive is used, only one such carriage/wagon need intervene between the carriages/wagons containing explosives and the locomotives;</span>
                              </p>
                              <p className="flex items-start gap-2">
                                <span className="text-cyan-400 font-semibold">2.</span>
                                <span>the passenger carriages or the brake-van;</span>
                              </p>
                              <p className="flex items-start gap-2">
                                <span className="text-cyan-400 font-semibold">3.</span>
                                <span>any other carriages/wagons containing other dangerous goods or articles of inflammable nature.</span>
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>Carriages/wagons containing explosives shall be close coupled to the adjoining carriages/wagons and each other.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>Wagons containing explosives shall not be transported by any train other than goods train. However, explosives may be transported by mixed or parcel train in vans specially designed (powder vans) on any line or section on which goods trains are not running subject to the condition that immediately on entering any section on which goods trains are running, the vans containing explosives shall be detached from the mixed or parcel trains.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90">Restriction on conveyance of explosives by trains carrying liquid air or liquid oxygen––</p>
                            <p>Explosives 907.18 Kg shall not be conveyed by the same train by which consignment of liquid oxygen or liquid air is being conveyed.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p className="font-semibold text-white/90">Guard or dummy wagons:</p>
                            <p>Whenever the requisite number of carriages/wagons not containing explosives or other dangerous goods or articles of inflammable nature are not available, empty wagons shall be used as guard or dummy wagons for separating as required the carriages/wagons containing explosives from the train locomotives, the passenger carriages or the brake-van or any other carriages/wagons containing other dangerous goods or articles of inflammable nature.</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default GSRAppendixPage423