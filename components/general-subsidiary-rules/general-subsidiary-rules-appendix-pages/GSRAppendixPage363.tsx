                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Special Instructions for different types of level crossings:
                    </p>
                          ...
                          <table className="w-full border-collapse">
                            <thead>
                              <tr className="border-b border-white/10">
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Annexure</th>
                                <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Description</th>
                              </tr>
                            </thead>
                            <tbody className="text-blue-100/90">
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">I</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Engineering level crossing gate, interlocked with gate signals, provided with
                                  telephone, with normal position &apos;open to road traffic&apos;.
                                </td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">II</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Traffic level crossing gate, interlocked with stop signals of the station, provided
                                  with telephone, with normal position &apos;open to road traffic&apos;.
                                </td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">III</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Traffic level crossing gate, non-interlocked, provided with telephone, with normal
                                  position &apos;closed to road traffic&apos;.
                                </td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">IV</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Engineering level crossing gate, non-interlocked, provided with telephone, with
                                  normal position &apos;open to road traffic&apos;.
                                </td>
                              </tr>
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">V</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Engineering level crossing gate, non-interlocked, provided with telephone, with
                              ...
                              <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">VI</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Engineering level crossing gate, non-interlocked, not provided with telephone,
                                  with normal position &apos;closed to road traffic&apos;.
                                </td>
                              </tr>
                              <tr className="hover:bg-white/5 transition-colors">
                                <td className="px-4 py-3 text-sm lg:text-base font-semibold text-white/90">VII</td>
                                <td className="px-4 py-3 text-sm lg:text-base">
                                  Proforma of the register, to be maintained at station / gate lodge and proforma
...
export default GSRAppendixPage363
