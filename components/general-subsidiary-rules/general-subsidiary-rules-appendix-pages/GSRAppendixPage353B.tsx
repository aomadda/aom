                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">7</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90 text-center">
                      In case of train originating from station other than &apos;Notice Stations&apos;:
                    </p>
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              ...
                              shall consult the SCOR or the &apos;Notice Station&apos; in rear on double line or the &apos;Notice Stations&apos;
                              on either side on single line and issue Caution Order upto the &apos;Notice Station&apos; in advance.
                              However, when such information cannot be collected by the station due to failure of
                              communications with the control or the &apos;Notice Station&apos; in rear or the &apos;Notice Station&apos; in
                              advance and it becomes necessary to start the train, it should be started after issuing a
                              Caution Order for restrictions, if any, or a &apos;nil&apos; Caution Order upto the block station in advance
                              giving a written advice to the Loco Pilot to stop at the block station in advance and act upon
                              the instructions available there. This procedure will be followed till a station is reached where
                              particulars of all restrictions can be obtained up to the &apos;Notice Station&apos; in advance.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRAppendixPage353B