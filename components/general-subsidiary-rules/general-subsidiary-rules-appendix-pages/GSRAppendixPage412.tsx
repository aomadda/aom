                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">412</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p className="text-center lg:text-left">
                        Replacement page no. 412 to G&SR including and upto AS no. 12
                      </p>
                      <div className="pt-4 space-y-3">
                        <p className="font-semibold text-lg lg:text-xl text-white/90 text-center lg:text-left">
                          Deleted.
                        </p>
                        <p className="text-sm lg:text-base text-blue-200/80 italic">
                          (Duly incorporating required paras as SRs under respective GRs)
                        </p>
                        <p className="text-sm lg:text-base text-blue-200/80 italic">
                          (Item no. 27 of AS-12 dt. 28.12.2023)
                        </p>
                      </div>
                    </div>
                  </div>
...
export default GSRAppendixPage412