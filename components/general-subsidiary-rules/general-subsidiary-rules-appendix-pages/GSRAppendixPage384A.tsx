          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="relative">
              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                {/* Section 3: Engineering & S&T Joint works */}
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">3.1</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p>
                        3.1. Engineering and S&T officials (Sr.DSTE/DSTE & Sr.DEN/DEN) responsible for
                        carrying out the work shall send a Circular Notice to the Sr.DOM/DOM at least 15
                        days before the work is due to commence. It shall be advised when the work will be
                        undertaken with a request to issue special instructions. A copy of the Circular Notice
                        shall also be sent to the Station Master of the station concerned. The Sr.DOM/DOM
                        on receiving such Circular Notice shall at once prepare special instructions and issue
                        them to all concerned. Only after the issue of special instructions, the work shall
                        commence and the Station Master will be responsible for ensuring that all staff at the
                        station responsible for the working of trains understand them and carry them out
                        meticulously.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">3.2</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p>
                        3.2. A notification showing the date and time, when the work would be taken in hand, its
                        probable duration and the instructions for the Station Master to issue Caution Order
                        and Chief Crew Controller to advise Loco Pilots for observing the temporary speed
                        restrictions, must be issued jointly by the Sr.DOM/DOM and Sr.DSTE/DSTE [SEM
                        Para 1014 (b)].
                      </p>
                    </div>
                  </div>
...
export default GSRAppendixPage384A