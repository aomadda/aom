...
const GSRAppendixPage435 = () => {
  const tableData = [
    ...
    { chapter: 'III', subject: 'Signals', generalRules: 'Entire chapter except 3.04 (2), 3.25, 3.26, 3.35, 3.78, 3.79, 3.81, 3.83 & 3.84', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'IV', subject: 'Working of trains generally', generalRules: '4.01, 4.02, 4.05, 4.06, 4.10, 4.12, 4.13, 4.14, 4.15, 4.16, 4.17, 4.23, 4.28, 4.29, 4.35, 4.37, 4.39, 4.42, 4.44, 4.50, 4.56, 4.58, 4.62, 4.64, 4.65 and 4.66.', subsidiaryRules: 'All SRs under to these rules' },
    ...
    { chapter: 'IX', subject: 'Block working', generalRules: 'Entire chapter', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'XV', subject: 'Permanent Way and Works', generalRules: 'GRs.15.08, 15.09, 15.16, 15.18, 15.24, 15.25, 15.26 &15.27.', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'XVII', subject: 'Working of trains on electrified sections of railways', generalRules: 'GRs.17.02,17.03(4)(ix), 17.04(4)(x) & 17.08', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'Appendices', subject: '', generalRules: '-', subsidiaryRules: 'II, III, VI, VII, VIII, XI, XII' },
  ]
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="text-base lg:text-lg text-blue-100/90 text-center">
                      The following chapters of General and Subsidiary rules apply particularly to the SWITCHMEN
                    </p>
                  </div>
                </div>
...
export default GSRAppendixPage435