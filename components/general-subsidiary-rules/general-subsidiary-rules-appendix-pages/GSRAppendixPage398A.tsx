                    ...
                    <div className="space-y-4">
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The instructions in this Appendix apply to works arising subsequent to the first
                              opening of a railway or section of a railway. Works constructed prior to the opening of
                              a railway are governed by the Indian Railways - General Rules for working railways
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The safety of the travelling public is ensured by the rules laid down in–
                            </p>
                            <div className="space-y-3 pl-4 lg:pl-6">
                              <div className="flex items-start gap-3">
                                <span className="text-cyan-400 font-semibold">1.</span>
                                <p>The Railways Act, 1989 (24 of 1989);</p>
                              </div>
                              <div className="flex items-start gap-3">
                                <span className="text-cyan-400 font-semibold">2.</span>
                                <p>The General Rules for Indian Railways (Open Lines) 1976;</p>
                              </div>
                              <div className="flex items-start gap-3">
                                <span className="text-cyan-400 font-semibold">3.</span>
                                <p>The rules for the opening of a railway or section of a railway for the public carriage
                                  of passengers 1983; and</p>
                              </div>
                              <div className="flex items-start gap-3">
                                <span className="text-cyan-400 font-semibold">4.</span>
                                <p>The Indian Railways Schedule of Dimensions.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The rules provide for the legal authorisation that must be obtained for any work which
...
export default GSRAppendixPage398A