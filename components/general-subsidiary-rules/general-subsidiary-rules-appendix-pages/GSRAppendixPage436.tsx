...
const GSRAppendixPage436 = () => {
  const tableData = [
    ...
    { chapter: 'III', subject: 'Signals', generalRules: 'Entire chapter except 3.13, 3.20, 3.21, 3.22, 3.25, 3.26, 3.30. 3.33, 3.74, 3.75, 3.78, 3.79, 3.83 & 3.85.', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'IV', subject: 'Working of trains generally', generalRules: '4.10, 4.13, 4.15, 4.16, 4.17, 4.22, 4.24, 4.26, 4.29, 4.35, 4.42, 4.48, 4.50 & 4.64.', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'V', subject: 'Control and working of stations', generalRules: 'Entire chapter', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'VI', subject: 'Accidents and unusual occurrence', generalRules: '6.10 & 6.11', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'VII', subject: 'Systems of working', generalRules: 'Entire chapter', subsidiaryRules: 'All Subsidiary rules' },
    { chapter: 'VIII', subject: 'Absolute Block system', generalRules: '8.05, 8.06, 8.07, 8.08, 8.09, 8.10, 8.12, 8.13 & 8.15.', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'XIV', subject: 'Block working', generalRules: '14.10, 14.11 & 14.17.', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'XVII', subject: 'Working of trains on electrified sections of railways', generalRules: '17.02, 17.05 & 17.08.', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'Appendices', subject: '', generalRules: '-', subsidiaryRules: 'Appendix I – para 11, 14 and 15, Appendix VII' },
  ]
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">IV</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="text-base lg:text-lg text-blue-100/90 text-center">
                      The following chapters of General and Subsidiary rules apply particularly to the CABINMEN, POINTSMEN and SHUNTING STAFF.
                    </p>
                  </div>
                </div>
...
export default GSRAppendixPage436