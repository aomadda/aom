              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="space-y-4">
                      <p className="text-base lg:text-lg text-blue-100/90 leading-relaxed">
                        Panel interlocking is a modern signalling system provided at the stations wherein both points and signals are operated from a centrally located panel by means of push buttons or knobs. This system essentially provides for relay interlocking and has augmented safety features because of consolidation of interlocking. The panel operations, apart from providing ease of operation also eliminates time loss and confusion which invariably occur when the operations of a number of agencies are to be coordinated when the operational work is delegated to a number of agencies. The status of the points, signals and the reception lines is readily available on hand to the Station Master, which makes for smoother operation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">1.1</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-4 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      1.1 The Principal of the Zonal Railway Training Institute / Moula-ali is responsible for the proper initial/refresher training of the staff in the rules connected with the operation of panels. After the staff are examined and certified fit, only then he shall grant the necessary Competency Certificate in respect of all the panels. Such certificate shall be valid for a period of three years from the date of issue.
                    </p>
                  </div>
                </div>

                {/* 2. Types of Panels Section */}
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      2. Types of Panels: On South Central Railway, there are two types of panel interlocking systems:
                    </p>

                    <div className="space-y-3 lg:space-y-4">
                      {[
                        { letter: 'a', text: "Siemen&apos;s panel and [German system]" },
                        { letter: 'b', text: "Podanur workshop panel [British system]" }
                      ].map((item, index) => (
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-4 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="text-base lg:text-lg text-blue-100/90">
                      3. In any panel interlocking system first the points have to be operated and set individually to the desired route. Then only then the signal can be taken &apos;off&apos;.
                    </p>
                  </div>
                </div>
              </div>
...
export default GSRAppendixPage447A
