                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">14</span>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              On receipt of sanction to open a new work, the DEN or the DSTE shall arrange with
                              the DOM, the date on which the new work is to be handed and taken over. After the
                              new work is handed over, the DEN or the DSTE shall advise the CE.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When the work is important and affects a running line, the DOM as well as the
                              Engineering and/or Signal officer(s) should be present at the time of handing over.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              When the work is not important and does not affect a running line, the Engineering
                              and/or Signal officer(s) may authorise the PWI and/or the Signal Inspector to hand
                              over the work and the DOM may authorise the Traffic Inspector or Station Master to
                              take over the work.
                            </p>
                            <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/5 shadow-md mt-4">
                              <div className="relative flex flex-col gap-3 rounded-xl bg-slate-900/40 px-4 py-4 lg:px-6 lg:py-5">
                                <div className="space-y-3 text-sm leading-relaxed text-blue-200/80 italic lg:text-base">
                                  <p className="font-semibold text-white/90 not-italic">Note: -</p>
                                  <div className="space-y-3 pl-2">
                                    <div className="flex items-start gap-3">
                                      <span className="text-cyan-400 font-semibold not-italic">(i)</span>
                                      <p>
                                        The Transportation officer or Inspector, who takes over a new work, should
                                        satisfy himself that the knobs/buttons, signals, points and connections work
                                        freely and properly and that the installation fulfils its object. He should also
                                        see that the signal lights are property focused, that the back lights are
                                        clearly visible from the place required by the rules, and that the electric
                                        repeaters, where provided, correctly represent the indication of the signals
                                        which they repeat.
                                      </p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                      <span className="text-cyan-400 font-semibold not-italic">(ii)</span>
                                      <p>
                                        Before issue of the certificate and taking any interlocking installation, the
                                        Transportation officer or Inspector should instruct the station staff
                                        responsible for working the interlocking installation and test them in their
                                        knowledge of the diagram of the arrangements exhibited at the station and
                                        of the rules and working instructions in connection therewith.
                                      </p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                      <span className="text-cyan-400 font-semibold not-italic">(iii)</span>
                                      <p>
                                        No person should be placed in charge at stations where interlocking
                                        installations have been provided unless the transportation officer or
                                        Inspector has satisfied himself that such a person has full knowledge of the
                                        working of those stations.
                                      </p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                      <span className="text-cyan-400 font-semibold not-italic">(iv)</span>
                                      <p>
                                        After the new interlocking arrangements have been brought into use, the
                                        Signal Inspector or the Signal and Interlocking Maintainer (Mechanical/
                                        Electrical) according to the importance of the work, should remain at the
                                        site for at least the remaining part of the day to ensure that the installation
                                        works smoothly.
                                      </p>
                                    </div>
                                  </div>
...
export default GSRAppendixPage402B