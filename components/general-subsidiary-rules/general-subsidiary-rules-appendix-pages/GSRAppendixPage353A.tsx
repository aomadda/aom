                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="space-y-4 lg:space-y-5">
                      {[
                        { 
                          num: 1, 
                          text: "On receipt of information of imposition / modification of speed restriction, the Station Master of the 'Notice Station' shall acknowledge and shall not allow any train, from the time of receipt of speed restriction, which has to pass through the affected block section, to leave his station unless he has warned the Loco Pilot and the Guard of the speed restriction and its location through the issue of a Caution Order."
                        },
                        { 
                          num: 2, 
                          text: "If the Station Master of a 'Notice Station' has received no intimation of any speed restriction to be observed between his station and the next 'Notice Station' of the train in the direction of movement, he shall issue 'nil' Caution Order to the Loco Pilots and the Guards of all trains leaving his station."
                        },
                        { 
                          num: 3, 
                          text: "The Loco Pilot shall not start the train from a 'Notice Station' and the Guard shall not give signal to start the train until they have received either the divisional Caution Order for restrictions or 'nil' caution order."
                        },
                        { 
                          num: 4, 
...
export default GSRAppendixPage353A