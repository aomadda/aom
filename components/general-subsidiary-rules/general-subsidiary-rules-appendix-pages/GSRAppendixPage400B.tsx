                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              The CRS in according his sanction may or may not propose to inspect the works.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            ...
                            <div className="mt-4 space-y-4">
                              <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/5 shadow-md transition-all duration-500 hover:border-cyan-400/20">
                                <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/40 px-4 py-5 lg:px-6 lg:py-6">
                                  <div className="flex items-center gap-3">
                                    <span className="flex lg:h-10 lg:w-10 h-8 w-8 items-center justify-center rounded-full border border-cyan-400/30 bg-cyan-500/10 text-sm font-semibold text-cyan-100 text-center lg:text-base">
                                      8.2.1
                                    </span>
                                    <div className="h-[1px] flex-1 bg-gradient-to-r from-cyan-400/30 via-blue-400/20 to-transparent"></div>
                                  </div>
                                  <div className="space-y-3 text-sm leading-relaxed text-blue-100/90 lg:text-base">
                                    <p>
                                      If the CRS decides not to inspect the work prior to opening, the Safety Certificate
                                      together with the certificates referred to therein, should be completed and submitted
                                      before the work is opened by the Engineer (s) in-charge and a telegram, when so
                                      required despatched to the CRS, copies of the Safety Certificate shall be sent to the
                                      DRM, CE & CSTE.
                                    </p>
                                  </div>
                                </div>
                              ...
                              <div className="relative overflow-hidden rounded-xl border border-white/5 bg-white/5 shadow-md transition-all duration-500 hover:border-cyan-400/20">
                                <div className="relative flex flex-col gap-4 rounded-xl bg-slate-900/40 px-4 py-5 lg:px-6 lg:py-6">
                                  ...
                                  <div className="space-y-3 text-sm leading-relaxed text-blue-100/90 lg:text-base">
                                    <p>
                                      The Safety Certificate for engineering works shall ordinarily be signed by the AEN,
                                      except in special cases, as may be specified, when the DEN shall sign it. In the case
                                      of works involving tracks and bridges and/or signalling and interlocking, the Safety
                                      Certificate should be signed jointly by the Engineers concerned.
                                    </p>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              If the CRS decides to inspect the work prior to opening, he will after inspection in the
                              company of the Officers concerned, communicate in writing his sanction to open the
                              work.
                            </p>
                          </div>
                        </div>
...
export default GSRAppendixPage400B