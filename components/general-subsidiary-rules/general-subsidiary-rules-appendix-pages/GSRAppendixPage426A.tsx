                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>For marshalling of wagons containing gases (rule 227.1), inflammable solids (rule 425.1) oxidizing substances (rule 524.1), acid and corrosives (rule 826.1) and poisonous (toxic) substances (rule 624.1) of the IRCA Red Tariff No. 20 must be observed.</p>
                          </div>
                        </div>
                      </div>

                      {/* Note Section */}
                      <div className="relative overflow-hidden rounded-2xl border border-yellow-500/30 bg-yellow-500/10 shadow-lg shadow-yellow-900/20">
                        <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/10 via-orange-500/5 to-red-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                        <div className="relative flex flex-col gap-4 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <p className="text-base lg:text-lg text-yellow-100/90">
                            <span className="font-semibold text-yellow-300">Note:</span> The Red Tariff in force is number 20, which was brought into force with effect from 16.8.2000.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default GSRAppendixPage426A