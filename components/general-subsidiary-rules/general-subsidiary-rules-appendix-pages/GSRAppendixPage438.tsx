...
const GSRAppendixPage438 = () => {
  const tableData = [
    ...
    { chapter: 'IV', subject: 'Working of trains generally', generalRules: '4.10 & 4.11', subsidiaryRules: 'All SRs under to these rules' },
    { chapter: 'V', subject: 'Control and working of stations', generalRules: 'Entire chapter', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'VI', subject: 'Accidents and unusual occurrences', generalRules: '6.01, 6.02 & 6.10', subsidiaryRules: 'All SRs under to these rules' },
    ...
    { chapter: 'XV', subject: 'Permanent Way and Works', generalRules: 'Entire chapter', subsidiaryRules: 'All Subsidiary Rules' },
    { chapter: 'XVII', subject: 'Working of trains on electrified sections of railways', generalRules: '17.02, 17.04, 17.05 & 17.06', subsidiaryRules: 'All SRs under to these rules' },
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-indigo-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">VI</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="text-base lg:text-lg text-blue-100/90 text-center">
                      The following chapters of General and Subsidiary rules apply particularly to the SIGNALLING STAFF.
                    </p>
                  </div>
                </div>
...
export default GSRAppendixPage438