                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="space-y-4 mt-6">
                      ...
                      <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg pl-4">
                        <p>
                          In the event of fire on any part of the electrical equipment, the affected part is first to
                          be completely isolated from the distribution system, if this has not been done
                          automatically. If arching continues due to feed from adjacent sub-stations, this feed
                          shall be interrupted by means of the supervisory control equipment by direct
                          telephone communication to the adjacent sub-stations. The fire shall be extinguished
                          by means of the extinguishers provided.
                        </p>
                      </div>

                      {/* Section 9.1.1 */}
                      <div className="space-y-3 mt-4 pl-4">
                        <p className="font-semibold text-sm lg:text-lg text-white/90">
                      ...
                      <div className="space-y-3 mt-4 pl-4">
                        <p className="font-semibold text-sm lg:text-lg text-white/90">
                          ...
                          commence operations until all electrical equipment adjacent to the fire has been made
                          dead.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 mt-6">
                      <p className="font-semibold text-base lg:text-xl text-white/90">
                        9.2. In the event of fire on EMU/MEMU, the Loco Pilot/Motorman shall immediately switch
                        off the circuit breaker and lower the pantograph. The train shall then be brought to a
                        stop at once.
                      </p>
                    </div>
                  </div>
...
export default GSRAppendixPage480C