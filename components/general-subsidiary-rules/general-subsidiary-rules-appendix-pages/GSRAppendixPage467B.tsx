              ...
              <div className="relative p-3 lg:p-10 space-y-6">
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">4.1</span>
                      </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p>
                        The Standard of interlocking, type of signalling (MLQ/TALQ/MAUQ/MACLS), method
                        of operating the signals/points from lever frames/control panel/VDU/CTC, provision of
                        axle counters/track circuits on running lines, Calling-on signals/IBS, special signalling
                        features such as fixed Warner, stop boards at terminal stations, emergency
                        crossovers, permanently locked points, motor operated points at an otherwise
                        mechanically worked stations, emergency/crank handle keys and their custody,
                        indications (electric/banner type) of points/trap points/signals/track circuits/axle
                        counters need to be mentioned. The detailed description of the lever frame/control
                        panel/Video Display Unit for route setting using point/signal/gate control switches,
                        individual operation of points, operations of gates within the station limits, setting of
                        points using the crank handle and the maintenance of proper records of emergency
                        operation counters provided on the panel need to be mentioned here. Procedure for
                        working of stations provided with Train Protection and Warning System and Anti
                        Collision Device need to be mentioned. The procedure for resetting of the system in
                        case of failure of axle counter on berthing portion as well as IBS section, emergency
                        operation of points, emergency route cancellation, clearing of block etc., also need to
                        be mentioned from operations point of view.
                      </p>
                      <div className="relative overflow-hidden rounded-xl border border-indigo-400/30 bg-indigo-500/10 p-4 mt-4">
                        <p className="text-sm italic text-indigo-100/90">
                          (Details of signaling and interlocking should, however, be given in Appendix &apos;B&apos; and
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">4.2</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p>
                        Custody of Relay Room key and procedure for its handing over and taking over
                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="relative flex items-center justify-center">
                      <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 shadow-xl shadow-cyan-900/40 flex items-center justify-center">
                        <span className="lg:text-xl text-base font-bold text-white/90">4.3</span>
                      </div>
                      <div className="absolute -inset-2 rounded-full border border-white/10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none"></div>
                    </div>
                  </div>
...
export default GSRAppendixPage467B