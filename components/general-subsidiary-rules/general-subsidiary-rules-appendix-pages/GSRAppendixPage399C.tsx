                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      5. Repetition of application to obtain the sanction of the CRS shall be avoided:
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              Only one application for the sanction of the CRS for each work shall be submitted
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              For the purpose of para 5.1. above, works envisaged as per any separate proposal or
                              sanctioned estimate and required to be carried out at any block station, non-block
                              station, level crossings or other independent location shall be considered as a
                              separate work and separate applications should be submitted for each such work.
                              When works are required to be done over a block section continuously, in addition to
                              or without works at associated block and non-block stations, level crossings, etc., a
                              separate application should also be submitted for each such block section. However,
                              notwithstanding the above, a common application for several works covered by
                              different estimates or proposals and to be executed at one station, level crossing or
                              other independent location or over the same block section may be submitted,
                              provided it is intended to execute such works simultaneously or in close succession to
                              each other.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          ...
                          <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              A safety certificate in the prescribed form shall, however, be submitted for each stage.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default GSRAppendixPage399C