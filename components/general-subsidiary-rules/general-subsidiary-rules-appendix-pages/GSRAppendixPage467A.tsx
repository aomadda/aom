                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                      <p>
                        ...
                        line/token/tokenless block instruments, whether cooperative or non-co-operative, the
                        staff responsible for their operation and custody of keys should be clearly mentioned.
                      </p>
                      <p>
                        Mention should also be made of the availability of block telephone at the station and
                        telephone provided at IBS posts to establish contact by the Loco Pilot with Station
...
export default GSRAppendixPage467A