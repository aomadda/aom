...
const subsections = [
  {
    num: '1',
    text: 'The Central Government may, by notification in the Official Gazette, constitute a fund to be called the National Disaster Response Fund for meeting any threatening disaster situation or disaster and there shall be credited thereto—',
    subItems: [
      {
        label: 'a',
        text: 'an amount which the Central Government may, after due appropriation made by Parliament by law in this behalf provide;',
      },
      {
        label: 'b',
        text: 'any grants that may be made by any person or institution for the purpose of disaster management.',
      },
    ],
  },
  {
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">CHAPTER IX</h2>
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">FINANCE, ACCOUNTS AND AUDIT</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">National Disaster Response Fund</span>
              </h2>
