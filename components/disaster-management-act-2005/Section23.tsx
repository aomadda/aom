...
const subsections = [
  {
    num: '1',
    text: 'There shall be a plan for disaster management for every State to be called the State Disaster Management Plan.',
  },
  {
    num: '2',
    text: 'The State Plan shall be prepared by the State Executive Committee having regard to the guidelines laid down by the National Authority and after such consultation with local authorities, district authorities and the people\'s representatives as the State Executive Committee may deem fit.',
  },
  {
    num: '3',
    text: 'The State Plan prepared by the State Executive Committee under sub-section (2) shall be approved by the State Authority.',
  },
  {
    num: '4',
    text: 'The State Plan shall include,—',
    subItems: [
      {
        label: 'a',
        text: 'the vulnerability of different parts of the State to different forms of disasters;',
      },
      {
        label: 'b',
        text: 'the measures to be adopted for prevention and mitigation of disasters;',
      },
      {
        label: 'c',
        text: 'the manner in which the mitigation measures shall be integrated with the development plans and projects;',
      },
      {
        label: 'd',
        text: 'the capacity-building and preparedness measures to be taken;',
      },
      {
        label: 'e',
        text: 'the roles and responsibilities of each Department of the Government of the State in relation to the measures specified in clauses (b), (c) and (d) above;',
      },
      {
        label: 'f',
        text: 'the roles and responsibilities of different Departments of the Government of the State in responding to any threatening disaster situation or disaster.',
      },
    ],
  },
  {
    num: '5',
    text: 'The State Plan shall be reviewed and updated annually.',
  },
  {
    num: '6',
    text: 'Appropriate provisions shall be made by the State Government for financing for the measures to be carried out under the State Plan.',
  },
  {
    num: '7',
    text: 'Copies of the State Plan referred to in sub-sections (2) and (5) shall be made available to the Departments of the Government of the State and such Departments shall draw up their own plans in accordance with the State Plan.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">State Plan</span>
              </h2>
