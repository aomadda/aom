...
const subsections = [
  {
    num: '1',
    text: 'There shall be constituted a National Disaster Response Force for the purpose of specialist response to a threatening disaster situation or disaster.',
  },
  {
    num: '2',
    text: 'Subject to the provisions of this Act, the Force shall be constituted in such manner and, the conditions of service of the members of the Force, including disciplinary provisions therefore, be such as may be prescribed.',
  },
]
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">NATIONAL DISASTER RESPONSE FORCE</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">National Disaster Response Force</span>
              </h2>
