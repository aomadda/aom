...
const subsections = [
  {
    num: '1',
    text: 'The Central Government shall, immediately after issue of notification under sub-section (1) of section 3, constitute a National Executive Committee to assist the National Authority in the performance of its functions under this Act.',
  },
  {
    num: '2',
    text: 'The National Executive Committee shall consist of the following members, namely:—',
    subItems: [
      {
        label: 'a',
        text: 'the Secretary to the Government of India in charge of the Ministry or Department of the Central Government having administrative control of the disaster management, who shall be Chairperson, ex officio;',
      },
      {
        label: 'b',
        text: 'the Secretaries to the Government of India in the Ministries or Departments having administrative control of the agriculture, atomic energy, defence, drinking water supply, environment and forests, finance (expenditure), health, power, rural development, science and technology, space, telecommunication, urban development, water resources and the Chief of the Integrated Defence Staff of the Chiefs of Staff Committee, ex officio.',
      },
    ],
  },
  {
    num: '3',
    text: 'The Chairperson of the National Executive Committee may invite any other officer of the Central Government or a State Government for taking part in any meeting of the National Executive Committee and shall exercise such powers and perform such functions as may be prescribed by the Central Government in consultation with the National Authority.',
  },
  {
    num: '4',
    text: 'The procedure to be followed by the National Executive Committee in exercise of its powers and discharge of its functions shall be such as may be prescribed by the Central Government.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Constitution of National Executive Committee</span>
              </h2>
