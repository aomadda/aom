...
const subsections = [
  {
    num: '1',
    text: 'The District Authority may, as and when it considers necessary, constitute one or more advisory committees and other committees for the efficient discharge of its functions.',
  },
  {
    num: '2',
    text: 'The District Authority shall, from amongst its members, appoint the Chairperson of the Committee referred to in sub-section (1).',
  },
  {
    num: '3',
    text: 'Any person associated as an expert with any committee or sub-committee constituted under sub-section (1) may be paid such allowances as may be prescribed by the State Government.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Constitution of advisory committees and other committees</span>
              </h2>
