...
const subItems2 = [
  {
    label: 'a',
    text: 'the composition and number of the members of the State Authority under sub-section (2), and the term of office and conditions of service of the members of the State Authority under sub-section (5), of section 14;',
  },
  {
    label: 'b',
    text: 'the allowances to be paid to the members of the advisory committee under sub-section (2) of section 17;',
  },
  {
    label: 'c',
    text: 'the powers and functions of the Chairperson of the State Executive Committee under sub-section (3), and the procedure to be followed by the State Executive Committee in exercise of its powers and discharge of its functions under sub-section (4) of section 20;',
  },
  {
    label: 'd',
    text: 'allowances to be paid to the persons associated with the sub-committee constituted by the State Executive Committee under sub-section (3) of section 21;',
  },
  {
    label: 'e',
    text: 'the composition and the number of members of the District Authority under sub-section (2), and the powers and functions to be exercised and discharged by the Chief Executive Officer of the District Authority under sub-section (3) of section 25;',
  },
  {
    label: 'f',
    text: 'allowances payable to the persons associated with any committee constituted by the District Authority as experts under sub-section (3) of section 28;',
  },
  {
    label: 'g',
    text: 'any other matter which is to be, or may be, prescribed, or in respect of which provision is to be made by rules.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Power of State Government to make rules</span>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <ul className="space-y-6">
                  ...
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    <span
                      className={`bg-linear-to-br ${badgeGradients[2]} text-white lg:w-10 lg:h-10 w-8 h-8 rounded-full flex items-center justify-center font-bold lg:text-lg text-base shadow-lg ring-2 shrink-0 mt-0.5 group-hover:scale-110 transition-transform`}
                    >
                      3
                    </span>
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center w-full">
