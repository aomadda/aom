...
const subsections = [
  {
    num: '1',
    text: 'The National Authority may constitute an advisory committee consisting of experts in the field of disaster management and having practical experience of disaster management at the national, State or district level to make recommendations on different aspects of disaster management.',
  },
  {
    num: '2',
    text: 'The members of the advisory committee shall be paid such allowances as may be prescribed by the Central Government in consultation with the National Authority.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Constitution of advisory committee by National Authority</span>
              </h2>
