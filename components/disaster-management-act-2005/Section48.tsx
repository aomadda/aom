...
const subsections = [
  {
    num: '1',
    text: 'The State Government shall, immediately after notifications issued for constituting the State Authority and the District Authorities, establish for the purposes of this Act the following funds, namely:—',
    subItems: [
      {
        label: 'a',
        text: 'the fund to be called the State Disaster Response Fund;',
      },
      {
        label: 'b',
        text: 'the fund to be called the District Disaster Response Fund;',
      },
      {
        label: 'c',
        text: 'the fund to be called the State Disaster Mitigation Fund;',
      },
      {
        label: 'd',
        text: 'the fund to be called the District Disaster Mitigation Fund.',
      },
    ],
  },
  {
    num: '2',
    text: 'The State Government shall ensure that the funds established—',
    subItems: [
      {
        label: 'i',
        text: 'under clause (a) of sub-section (1) is available to the State Executive Committee;',
      },
      {
        label: 'ii',
        text: 'under sub-clause (c) of sub-section (1) is available to the State Authority;',
      },
      {
        label: 'iii',
        text: 'under clauses (b) and (d) of sub-section (1) are available to the District Authority.',
      },
    ],
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Establishment of funds by State Government</span>
              </h2>
