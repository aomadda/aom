...
const subsections = [
  {
    num: '1',
    text: 'With effect from such date as the Central Government may, by notification in the Official Gazette appoint in this behalf, there shall be established for the purposes of this Act, an authority to be known as the National Disaster Management Authority.',
  },
  {
    num: '2',
    text: 'The National Authority shall consist of the Chairperson and such number of other members, not exceeding nine, as may be prescribed by the Central Government and, unless the rules otherwise provide, the National Authority shall consist of the following:—',
    subItems: [
      {
        label: 'a',
        text: 'the Prime Minister of India, who shall be the Chairperson of the National Authority, ex officio;',
      },
      {
        label: 'b',
        text: 'other members, not exceeding nine, to be nominated by the Chairperson of the National Authority.',
      },
    ],
  },
  {
    num: '3',
    text: 'The Chairperson of the National Authority may designate one of the members nominated under clause (b) of sub-section (2) to be the Vice-Chairperson of the National Authority.',
  },
  {
    num: '4',
    text: 'The term of office and conditions of service of members of the National Authority shall be such as may be prescribed.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Establishment of National Disaster Management Authority</span>
              </h2>
