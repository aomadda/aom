...
const subsections = [
  {
    num: '1',
    text: 'Where an offence under this Act has been committed by a company or body corporate, every person who at the time the offence was committed, was in charge of, and was responsible to, the company, for the conduct of the business of the company, as well as the company, shall be deemed to be guilty of the contravention and shall be liable to be proceeded against and punished accordingly:',
    provisos: [
...
const explanationItems = [
  {
    label: 'a',
    text: '\u201Ccompany\u201D means any body corporate and includes a firm or other association of individuals; and',
  },
  {
    label: 'b',
    text: '\u201Cdirector\u201D, in relation to a firm, means a partner in the firm.',
  },
]
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">CHAPTER X</h2>
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">OFFENCES AND PENALTIES</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Offence by companies</span>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                ...
                <div className="mt-6 flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center w-full">
                    <span className="font-semibold text-cyan-200">
                      Explanation.—For the purpose of this section—
                    </span>
                    <ul className="mt-4 space-y-3">
                      {explanationItems.map((sub) => (
                        <li
                          key={sub.label}
                          className="flex items-center justify-center flex-col gap-3 group/item hover:bg-white/5 p-2 rounded-lg transition-all duration-300"
                        >
