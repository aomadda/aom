...
const subsections = [
  ...
  {
    num: '2',
    text: 'A State Authority shall consist of the Chairperson and such number of other members, not exceeding nine, as may be prescribed by the State Government and, unless the rules otherwise provide, the State Authority shall consist of the following members, namely:—',
    subItems: [
      {
        label: 'a',
        text: 'the Chief Minister of the State, who shall be Chairperson, ex officio;',
      },
      {
        label: 'b',
        text: 'other members, not exceeding eight, to be nominated by the Chairperson of the State Authority;',
      },
      {
        label: 'c',
        text: 'the Chairperson of the State Executive Committee, ex officio.',
      },
    ],
  },
  {
    num: '3',
    text: 'The Chairperson of the State Authority may designate one of the members nominated under clause (b) of sub-section (2) to be the Vice-Chairperson of the State Authority.',
  },
  {
    num: '4',
    text: 'The Chairperson of the State Executive Committee shall be the Chief Executive Officer of the State Authority, ex officio:',
    provisos: [
  ...
  {
    num: '5',
    text: 'The term of office and conditions of service of members of the State Authority shall be such as may be prescribed.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Establishment of State Disaster Management Authority</span>
              </h2>
