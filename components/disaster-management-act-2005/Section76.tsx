...
const subItems2 = [
  {
    label: 'a',
    text: 'powers and functions to be exercised and discharged by the governing body;',
  },
  {
    label: 'b',
    text: 'procedure to be followed by the governing body in exercise of the powers and discharge of its functions;',
  },
  {
    label: 'c',
    text: 'any other matter for which under this Act provision may be made by the regulations.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Power to make regulations</span>
              </h2>
                  ...
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center w-full">
                      <span className="font-semibold text-cyan-200">
                        The National Institute of Disaster Management, with the previous approval of the Central Government may, by notification in the Official Gazette, make regulations consistent with this Act and the rules made thereunder to carry out the purposes of this Act.
                      </span>
                    </div>
                  </li>
