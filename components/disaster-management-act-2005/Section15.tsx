...
const subsections = [
  {
    num: '1',
    text: 'The State Authority shall meet as and when necessary and at such time and place as the Chairperson of the State Authority may think fit.',
  },
  {
    num: '2',
    text: 'The Chairperson of the State Authority shall preside over the meetings of the State Authority.',
  },
  {
    num: '3',
    text: 'If for any reason, the Chairperson of the State Authority is unable to attend the meeting of the State Authority, the Vice-Chairperson of the State Authority shall preside at the meeting.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Meetings of the State Authority</span>
              </h2>
