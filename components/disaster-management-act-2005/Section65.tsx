...
const subItems1 = [
  {
    label: 'a',
    text: 'any resources with any authority or person are needed for the purpose of prompt response;',
  },
  {
    label: 'b',
    text: 'any premises are needed or likely to be needed for the purpose of rescue operations; or',
  },
  {
    label: 'c',
    text: "any vehicle is needed or is likely to be needed for the purposes of transport of' resources from disaster affected areas or transport of resources to the affected area or transport in connection with rescue, rehabilitation or reconstruction,",
  },
]
...
const subItems3 = [
  {
    label: 'a',
    text: '\u201Cresources\u201D includes men and material resources;',
  },
  {
    label: 'b',
    text: '\u201Cservices\u201D includes facilities;',
  },
  {
    label: 'c',
    text: '\u201Cpremises\u201D means any land, building or part of a building and includes a hut, shed or other structure or any part thereof;',
  },
  {
    label: 'd',
    text: '\u201Cvehicle\u201D means any vehicle used or capable of being used for the purpose of transport, whether propelled by mechanical power or otherwise.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Power of requisition of resources, provisions, vehicles, etc., for rescue operations, etc.</span>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <ul className="space-y-6">
                  ...
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center w-full">
                      <span className="font-semibold text-cyan-200">
                        If it appears to the National Executive Committee, State Executive Committee or District Authority or any officer as may be authorised by it in this behalf that—
                      </span>
                  ...
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center w-full">
                      <span className="font-semibold text-cyan-200">
                        Whenever any resource, premises or vehicle is requisitioned under sub-section (1), the period of such requisition shall not extend beyond the period for which such resource, premises or vehicle is required for any of the purposes mentioned in that sub-section.
                      </span>
                    </div>
                  </li>
