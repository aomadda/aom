...
const subsections = [
  {
    num: '1',
    text: 'Every Ministry or Department of the Government of India shall make provisions, in its annual budget, for funds for the purposes of carrying out the activities and programmes set out in its disaster management plan.',
  },
  {
    num: '2',
    text: 'The provisions of sub-section (1) shall, mutatis mutandis, apply to departments of the Government of the State.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Allocation of funds by Ministries and Departments</span>
              </h2>
