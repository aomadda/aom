...
const subsections = [
  {
    num: '1',
    text: 'The Chairperson of the District Authority shall, in addition to presiding over the meetings of the District Authority, exercise and discharge such powers and functions of the District Authority as the District Authority may delegate to him.',
  },
  {
    num: '2',
    text: 'The Chairperson of the District Authority shall, in the case of an emergency, have power to exercise all or any of the powers of the District Authority but the exercise of such powers shall be subject to ex post facto ratification of the District Authority.',
  },
  {
    num: '3',
    text: 'The District Authority or the Chairperson of the District Authority may, by general or special order, in writing, delegate such of its or his powers and functions, under sub-section (1) or (2), as the case may be, to the Chief Executive Officer of the District Authority, subject to such conditions and limitations, if any, as it or he deems fit.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Powers of Chairperson of District Authority</span>
              </h2>
