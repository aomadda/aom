          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Short title, extent and commencement</span>
              </h2>
                ...
                <ul className="space-y-6">
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center">
                      <span className="font-semibold text-cyan-200">This Act may be called the Disaster Management Act, 2005.</span>
                    </span>
                  </li>
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center">
                      <span className="font-semibold text-cyan-200">It extends to the whole of India.</span>
                    </span>
                  </li>
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 text-center">
                      <span className="font-semibold text-cyan-200">It shall come into force on such date1 as the Central Government may, by notification in the Official Gazette appoint; and different dates* may be appointed for different provisions of this Act and for different States, and any reference to commencement in any provision of this Act in relation to any State shall be construed as a reference to the commencement of that provision in that State.</span>
                    </span>
                  </li>
                </ul>
              </div>
