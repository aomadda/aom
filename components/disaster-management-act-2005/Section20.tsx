...
const subsections = [
  ...
  {
    num: '2',
    text: 'The State Executive Committee shall consist of the following members, namely:—',
    subItems: [
      {
        label: 'a',
        text: 'the Chief Secretary to the State Government, who shall be Chairperson, ex officio;',
      },
      {
        label: 'b',
        text: 'four Secretaries to the Government of the State of such departments as the State Government may think fit, ex officio.',
      },
    ],
  },
  {
    num: '3',
    text: 'The Chairperson of the State Executive Committee shall exercise such powers and perform such functions as may be prescribed by the State Government and such other powers and functions as may be delegated to him by the State Authority.',
  },
  {
    num: '4',
    text: 'The procedure to be followed by the State Executive Committee in exercise of its powers and discharge of its functions shall be such as may be prescribed by the State Government.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Constitution of State Executive Committee</span>
              </h2>
