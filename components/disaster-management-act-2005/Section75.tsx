...
const subItems2 = [
  {
    label: 'a',
    text: 'the composition and number of the members of the National Authority under sub-section (2), and the term of office and conditions of service of members of the National Authority under sub-section (4), of section 3;',
  },
  {
    label: 'b',
    text: 'the allowances to be paid to the members of the advisory committee under sub-section (2) of section 7;',
  },
  {
    label: 'c',
    text: 'the powers and functions of the Chairperson of the National Executive Committee under sub-section (3) of section 8 and the procedure to be followed by the National Executive Committee in exercise of its powers and discharge of its functions under sub-section (4) of section 8;',
  },
  {
    label: 'd',
    text: 'allowances to be paid to the persons associated with the sub-committee constituted by the National Executive Committee under sub-section (3) of section 9;',
  },
  {
    label: 'e',
    text: 'the number of members of the National Institute of Disaster Management under sub-section (2), the term of the office and vacancies among members and the manner of filling such vacancies under sub-section (3) and the manner of constituting the Governing Body of the National Institute of Disaster Management under sub-section (4) of section 42;',
  },
  {
    label: 'f',
    text: 'the manner of constitution of the Force, the conditions of service of the members of the Force, including disciplinary provisions under sub-section (2) of section 44;',
  },
  {
    label: 'g',
    text: 'the manner in which notice of the offence and of the intention to make a complaint to the National Authority, the State Authority, the Central Government, the State Government or the other authority or officer under clause (b) of section 60;',
  },
  {
    label: 'h',
    text: 'the form in which and the time within which annual report is to be prepared under section 70;',
  },
  {
    label: 'i',
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Power of Central Government to make rules</span>
              </h2>
