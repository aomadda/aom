...
const subsections = [
  {
    num: '1',
    text: 'Subject to the provisions of this Act, the National Authority shall have the responsibility for laying down the policies, plans and guidelines for disaster management for ensuring timely and effective response to disaster.',
  },
  {
    num: '2',
    text: 'Without prejudice to generality of the provisions contained in sub-section (1), the National Authority may —',
    subItems: [
      { label: 'a', text: 'lay down policies on disaster management;' },
      { label: 'b', text: 'approve the National Plan;' },
      {
        label: 'c',
        text: 'approve plans prepared by the Ministries or Departments of the Government of India in accordance with the National Plan;',
      },
      {
        label: 'd',
        text: 'lay down guidelines to be followed by the State Authorities in drawing up the State Plan;',
      },
      {
        label: 'e',
        text: 'lay down guidelines to be followed by the different Ministries or Departments of the Government of India for the purpose of integrating the measures for prevention of disaster or the mitigation of its effects in their development plans and projects;',
      },
      {
        label: 'f',
        text: 'coordinate the enforcement and implementation of the policy and plan for disaster management;',
      },
      { label: 'g', text: 'recommend provision of funds for the purpose of mitigation;' },
      {
        label: 'h',
        text: 'provide such support to other countries affected by major disasters as may be determined by the Central Government;',
      },
      {
        label: 'i',
        text: 'take such other measures for the prevention of disaster, or the mitigation, or preparedness and capacity building for dealing with the threatening disaster situation or disaster as it may consider necessary;',
      },
      {
        label: 'j',
        text: 'lay down broad policies and guidelines for the functioning of the National Institute of Disaster Management.',
      },
    ],
  },
  {
    num: '3',
    text: 'The Chairperson of the National Authority shall, in the case of emergency, have power to exercise all or any of the powers of the National Authority but exercise of such powers shall be subject to ex post facto ratification by the National Authority.',
  },
]
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center pr-12 lg:pr-14">
                <span className="text-center">Powers and functions of National Authority</span>
              </h2>
