          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                143. Prohibition for unauthorized carrying on of business of procuring and supplying of railway tickets
              </h2>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <div className="flex-1 space-y-3">
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            If any person, not being a railway servant or an agent authorized in this behalf;-
                          </p>
                          <div className="space-y-3 ml-4">
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                carries on the business of procuring and supplying tickets for travel on a railway or fro reserved accommodation for journey in a train; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                purchases or sells or attempts to purchase or sell tickets with a view to carrying on any such business either by himself or by any other person,
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                          Whoever abets any offence punishable under this section shall, whether or not such offence is committed, be punishable with the same punishment as is provided for the offence.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 143 provides for penalty for unauthorized carrying on of business of procuring and supply of railway tickets.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section143