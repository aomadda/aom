            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Exhibition against traveling without pass or ticket.</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      No person shall enter or remain in any carriage on a railway for the purpose traveling therein as passenger unless he has with him a proper pass or ticket or obtained permission of a railway servant authorized in this behalf for such travel.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      A person obtaining permission under sub-section (1) shall ordinarily get a certificate from the railway servant referred to in that sub-section that he has been permitted to travel in such carriage on condition that he subsequently pays the fare payable for the distance to be traveled.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 55 prohibits the entry and traveling in any carriage without proper pass or ticket.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section55