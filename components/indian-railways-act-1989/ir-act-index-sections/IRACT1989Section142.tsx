                ...
                <div className="space-y-4">
                        ...
                        <div className="flex-1 space-y-3">
                          ...
                          <div className="space-y-3 ml-4">
                            ...
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                parts or attempts to part with the possession of a ticket against which reservation of a seat or berth has been made or any half of a return ticket or a season ticket,
                              </p>
                            </div>
                          </div>
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                            in order to enable any other person to travel therewith, he shall be punishable with imprisonment for a term which may extend to three months, or with fine which may extend to five hundred rupees, or with both, and shall also forfeit the ticket which he sells or attempts to sell or parts of attempts to part.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <div className="flex-1 space-y-3">
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            If any person purchases any ticket referred to in Cl. (a) of sub-section (1) or obtains the possession of any ticket referred to in Cl. (b) or that sub-section from any person other than a railway servant or an agent authorized in this behalf, he shall be punishable with imprisonment for a term which may extend to three months and with fine which may extend to five hundred rupees and if the purchaser or holder of any ticker aforesaid travels or attempts to travel therewith, he shall forfeit the ticker which he so purchased or obtained and shall be deemed to be traveling without a proper ticket and shall be liable to be dealt with U/Sec.138:
                          </p>
                          <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/10 ml-4">
                            <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                              Provided that in the absence of special and adequate reasons to the contrary to be mentioned in the judgement of the court, the punishment under seb-section (1) or sub-section (2) shall not be less than a fine of two hundred and fifty rupees.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 142 provides for penalty for unauthorized sale or transfer of ticket.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed font-semibold">
                        Penal provision:
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Penal provision is to be construed rigidly.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section142