            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Power to make rules in respect of matters in this Chapter</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="flex-1 w-full">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1 mb-4">
                        In particular, and without prejudice to the generality of the force going power. Such rules may provide for all or any of the following matters . namely:
                      </p>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-center flex-col gap-3 group/item hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                            for regulating the made n which, and the speed at which rolling stock used on railway is to be moved or propelled ; and
                          </span>
                        </div>
                        <div className="flex items-center justify-center flex-col gap-3 group/item hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                            the case in which and the extent to which the procedure provided in this Chapter may be dispensed with.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30 mt-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="mt-3 pt-3 border-t border-blue-400/30">
                        <p className="text-blue-200 font-semibold lg:text-base text-sm mb-2">Rules – Whether validity framed.</p>
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          The question whether rules are validity framed to carry out the purposes of the Act can be determined on the analysis of the provisions of the Act.
                        </p>
                      </div>
                    </div>
                  </div>
...
export default IRACT1989Section29