            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Powers of Commissioner in relation to the enquiries.</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300 mb-4">
                      ...
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        For the purpose of conducting an inquiry under this chapter into the causes of any accident on a a railway, the Commissioner shall, in addition to the powers specified in sec. 7, have the powers as are vested in a civil court while trying a suit under the Code of Civil Procedure, 1908 (5 of 1908), in respect of the following matters, namely :-
                      </span>
                    </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The Commissioner while conducting an enquiry under this Chapter shall be deemed to be a Civil Court for the purpose of Sec. And Chapter XXVI of the Code of Criminal Procedure, 1973(2 of 1974).
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 116 empowers the commissioner with the powers of the Civil Court under the Code of Civil Procedure, 1908 (5 of 1908) in respect of the matters enumerated therein.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section116
