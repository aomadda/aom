            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Railway administration against which application for compensation for personal injury is to be filed.</span>
                </div>
              </h2>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        &quot;Entertain &quot; – means of : The expression &quot;Entertain&quot; does not mean same thing as filing of the application. The aforesaid view was expressed by the Allahabad High Court in Kundan Lal v. Jagannath shargza. A similar view was again taken in Dhoom Chand chain V. Chaman lal gupta, in which the learned Chief Justice Mr. Desai and Mr. Justice Dwivedi gave the same meaning to the expression &quot;Entertain&quot; .
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section109
