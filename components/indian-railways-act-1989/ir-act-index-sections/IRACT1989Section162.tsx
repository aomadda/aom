                ...
                <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            enters such carriage, compartment, room or other place,, or having entered such carriage, compartment, room or place, remains therein ; or
                          </p>
                        </div>
                        <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            occupies any such berth or seat having been required by any railway servant to vacate it,
                          </p>
                        </div>
                      </div>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        he shall in addition to being liable to forfeiture of his pass or ticket, be punishable with fine which may extend to five hundred rupees and may also removed by any railway servant.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 162 provides for punishment for entering a carriage or other ploace reserved for females.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section162