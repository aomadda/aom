                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any person required to furnish an account of goods under Sec. 66 gives an account which is materially false he and, if he is not the owner also shall, without prejudice to his liability to pay any freight or other charge under any provision of this Act, be punishable with fine which may extend to five hundred rupees every quintal or part thereof of such goods.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed font-semibold">
                        Estoppel, doctrine does not apply when fraud has been played authorities.- The doctrine of promissory estoppal does not apply when a false certificate has been obtained and fraud has been played on the authorities.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section163