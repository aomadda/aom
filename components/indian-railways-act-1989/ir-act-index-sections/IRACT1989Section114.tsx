            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Inquiry by Commissioner</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300 mb-4">
                      ...
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        On the receipt of a notice under Sec. 113 of the occurrence of an accident to a train carrying passengers resulting in loss of human life or grievous hurt causing total or partial disablement of permanent nature to a passenger or serious damage to railway property, the Commissioner shall, as soon as may be, notify the railway administration in whose jurisdiction the accident occurred of his intention hold an inquiry into the causes that led to the accident and shall at the same time fix and communicate the date, time and place of inquiry;
                      </span>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3 border-l-4 border-cyan-400">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        it shall be open to the Commissioner to hold an inquiry into any other accident which, in his opinion, requires the holding of such a inquiry.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      If for any reason, the Commissioner is not able to hold an inquiry as soon as may be after the occurrence of the accident, he shall notify the railway administration accordingly.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 114 empowers the Commissioner to hold inquiry into any railway accident resulting in the loss of human life or grevious hurt to a passenger or serious damage to railway property.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section114
