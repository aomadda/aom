            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Proof of entries in records and documents</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      Entries made in record or other documents of a railway administration shall be admitted in evidence in all proceedings by or against the railway administration, and all such entries may be proved either by the production of the records or other documents of the railway administration containing such entries or by production of a copy of the entries certified by the officer having custody of the records or other documents under his signature and stating that it is a true copy of the original entries and that such original entries are contained in the records or other documents of the railway administration in his possession.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 191 provides that entries in the records or other documents of the railway administration shall be admitted in evidence and the method of their proof.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section191