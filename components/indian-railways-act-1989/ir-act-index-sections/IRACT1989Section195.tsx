            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Representation of railway administration</span>
                </div>
              </h2>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          A railway administration may, by order in writing, authorise any railway servant or other person to act for, or represent it, as the case may be, in any proceeding before any civil, criminal or other court.
                        </span>
                      </div>
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          A person authorized by a railway administration to conduct prosecution on it s behalf shall, notwithstanding anything in Sec. 302 of the Code of Criminal procedure, 1973 (2 of 1974), be entitled to conduct such prosecution without the permission of the magistrate.
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 195 provides for representation of railway administration in proceedings before Civil, Criminal and other Courts.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section195