            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Maintenance of rate-books, etc., for carriage of goods.</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed text-center">
                      Every railway administration shall maintain, at each station and at such other places where goods are received for carriage, the rate-books or other documents which shall contain the rate authorized for the carriage of goods from one station to another and make them available for the reference of any parson during all reasonable hours without payment of any fee.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 61 imposes an obligation on every railway administration to maintain the rate-books or other documents relating to rates and make them available for reference to any person without payment of any fee.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section61