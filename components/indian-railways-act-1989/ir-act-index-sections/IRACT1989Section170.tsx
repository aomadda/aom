                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Any penalty imposed by the Central Government under Sec. 169, shall be recoverable by a suit in the district Court having jurisdiction in the place where the head office of the non-Government railway is situated.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section170