            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Railway servants to be public servants for the purposes of Chapter IX and Sec.409 of the Indian Penal Code</span>
                </div>
              </h2>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          Any railway servant, who is not a public servant within the meaning of Sec.21 of the Indian Penal Code(45 of 1860) shall be deemed to be a public servant for purposes of Chapter IX and Sec.409 of that code.
                        </span>
                      </div>
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          In the definition of &apos;legal remuneration&quot; in Sec.161 of the Indian Penal Code(45 of 1860), the word &quot;Government&quot;
                        </span>
                      </div>
                    </div>
                  </div>
...
export default IRACT1989Section188