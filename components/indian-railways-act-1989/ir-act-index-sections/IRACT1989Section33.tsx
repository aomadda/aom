            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Constitution of the Railway Rates Tribunal</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      There shall be a Tribunal, to be called the Railway Rates Tribunal, for the purpose of discharing the functions specified in this Chapter.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      A person shall not be qualified for appointment as the Chairman of the Tribunal unless he is, or has been, a judge of the Supreme Court or a High Court and of the other two members, one shall be a person, who in the opinion of the Central Government, has special knowledge of the commercial, industrial or economic conditions of the country and the other shall be a person, who, in the commercial working of the railways.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      Incase the Chairman or any other member is, by infirmity or otherwise, rendered incapable of carrying out his duties or absent on leave or otherwise in circumstances not involving the vacation of his office , the Central Government may appoint another person to act in his place during his absence.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30 mt-6">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 33 provides for establishment pf a Railway Rates Tribunal and qualification of persons who may be Chairman and members of such Tribunal
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section33