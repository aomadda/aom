                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            pulls down or willfully damages any board or document set up or posted by the order of a railway administration on a railway or any rolling stock ; or
                          </p>
                        </div>
                        <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            obliterates or alters any letters of figures upon any such board or document or upon any rolling stock,
                          </p>
                        </div>
                      </div>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
...
export default IRACT1989Section166