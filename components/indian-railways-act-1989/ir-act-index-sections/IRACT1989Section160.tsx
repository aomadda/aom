                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                          if any person, other than a railway servant or a person authorized in this behalf, opens any gate or chain or barrier set up on either side of a level crossing which is closed to road traffic, he shall be punishable with imprisonment for a term which may extend to three years.
                        </p>
                      </div>
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 160 provides for punishment for a person opening or breaking a level crossing gate.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section160