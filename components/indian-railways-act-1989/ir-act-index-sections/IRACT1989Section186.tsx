            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Protection of action taken in good faith</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      No suit, prosecution or other legal proceeding shall lie against the Central Government, any railway administration, a railway servant or any other person for anything which is in good faith done or intended to be done in pursuance of this Act or any rules or orders made there under.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 186 provides that no suit, prosecution or other legal proceedings shall lie against the Central Government, railway administration, railway servant or any other person for anything done in good faith or intended to be done in pursuance of this Act.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section186