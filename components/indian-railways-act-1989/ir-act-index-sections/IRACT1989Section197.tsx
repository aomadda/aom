            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Matters supplemental to the definitions of &quot;railway&quot; and &quot;railway servant&quot;</span>
                </div>
              </h2>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          for the purposes of Secs. 67, 113, 121, 123, 147, 151 to 154, 160, 164, 166, 168, 170, 171, 173 to 176, 179, 180, 184, 185, 1878 to 190, 192, 193, 195 and of this section, the word &quot;railway&quot; whether it occurs alone or as a prefix to another word, as reference to the railway r portion of a railway under construction and to a railway or portion of a railway not used for the public carriage of passengers, animals or goods as well as to a railway falling within the definition of that word in Cl. (31) of Sec. 2.
                        </span>
                      </div>
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          For the purposes of Secs. 7, 24, 113, 146, 172 to 176 and 188 to 190, the expression &quot;railway servant&quot; includes a person employed under a railway in connection with the service thereof by a person fulfilling a contact with the railway administration.
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 197 provides for the matters supplemental to the definition of railway and railway servant.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section197