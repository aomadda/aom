...
const IRACT1989Section6 = () => {
  const duties = [
    {
      label: "a)",
      content: "inspect any railway with a view to determine whether it is fit to be opened for the public carriage of passengers and report thereon to the Central Government as required by or under Railway Act;"
    },
    {
      label: "b)",
      content: "make such periodical or other inspections of any railway or of any rolling stock used thereon as the Central Government may direct;"
    },
    {
      label: "(c)",
      content: "make an enquiry under this Act into the cause of any accident on a railway; and"
    },
    {
      label: "(d)",
      content: "discharge such other duties as are conferred on him by or under this Act."
    }
  ]
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Duties of Commissioner Section */}
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Duties of Commissioner</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-teal-400/30">
                <p className="text-gray-200 lg:text-lg text-base font-semibold mb-6 text-center">
                  The Commissioner shall -
                </p>
                <div className="space-y-4">
                  {duties.map((duty, index) => {
                    const label = duty.label.replace(/[()]/g, '').toLowerCase();
                    return (
...
export default IRACT1989Section6