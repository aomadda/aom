            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Powers of the Tribunal.</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The Tribunal shall have the powers of a civil court under the Civil Procedure, 1908(5 of 1908), for the purposes of taking evidence on oath, enforcing the attendance of witness, compelling the discovery and production of documents, issuing commissions for the examination of witness and of review and shall be deemed to be a Civil Court for all the purpos4es of Sec. 195 and Chapter XXXV of the code of Criminal Procedure, 1973 (2 of 1974) and any reference in such section of Chapter to the presiding Officer of a court shall be deemed to include a reference to the Chairman of the Tribunal.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The Tribunal shall also have power to pass such interim and final orders as the circumstances may require, including orders for the payment of costs.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30 mt-6">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 38 provides that the Tribunal shall be a Civil Court under the Code of Civil Procedure, 1908; for the purpose of taking evidence on oath, etc,. and shall also be deemed to be a civil Court for all the purposes of Sec. 195 and Chapter XXXV of the code of Criminal Procedure. 1973.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section38