                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any railway servant is in a state of intoxication while on duty, he shall be punishable with fine which may extend to five hundred rupees and when the performance of any duty in such state is likely to endanger the safety of any person traveling on or being upon a railway, such railway servant shall bne punishable with imprisonment for a term which may extend to one year, or with fine, or with both.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 172 provides for punishment for a railway servant for drunkenness on duty.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section172