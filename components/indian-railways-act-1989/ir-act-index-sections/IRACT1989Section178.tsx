            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Making a false report by a railway servant</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      If any railway servant who is required by a railway administration to inquire into a claim for loss, distruction, damage, deterioration or non-delivery of any consignment makes a report which is false or which he knows or believes to be false or does not believe to be true, he shall be punishable with imprisonment for a term which may extend to two years, or with fine which may extend to one thousand rupees, or with both.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 178 provides punishment for a railway servant for making a false report in claims enquiry.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section178