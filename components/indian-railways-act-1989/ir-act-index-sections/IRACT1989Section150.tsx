                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                        ...
                        <div className="flex-1 space-y-3">
                          ...
                          <div className="space-y-3 ml-4">
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                puts or throws upon or across any railways, any wood, stone or other matter or thing; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                takes up, removes, loosens or displaces any rail, sleeper or other matter or things matter or things belonging to any railway; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                turns, moves, unlocks or diverts any points or other machinery belonging to any railway; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              <span className="bg-linear-to-br from-cyan-500 to-blue-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-cyan-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                makes or shows, or hides or removes, any signal or light upon or near to any railway; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                does or causes to be done or attempts to do any other act or thing in relation to any railway,
                              </p>
                            </div>
                          </div>
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                            with intent or with knowledge that he is likely to endanger the safety of any person traveling on or being upon the railway, he shall be punishable with imprisonment for life, or with rigorous imprisonment for a term which may extend to ten years:
                          </p>
                          <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/10 ml-4">
                            ...
                            <div className="space-y-3 ml-4">
                              ...
                              <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                                ...
                                <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                  seven years, in the case of conviction for the second or subsequent offence.
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <div className="flex-1 space-y-3">
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            If any person unlawfully does any act or thing referred to in any of the clauses of sub-section (1) -
                          </p>
                          <div className="space-y-3 ml-4">
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                with interest to cause the death of any person and the doing of such act or thing causes the death of any person ; or
                              </p>
                            </div>
                            <div className="flex items-start gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                              <span className="bg-linear-to-br from-cyan-500 to-blue-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-cyan-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                              ...
                              <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                with knowledge that such act of thing is so immediately dangerous that it must in all probability cause the death of any person or such bodily injury to any person as is likely to cause the death of such person,
                              </p>
                            </div>
                          </div>
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
...
export default IRACT1989Section150