                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any driver or conductor of any vehicle while upon the premises of a railway disobeys the reasonable directions of any railway servant or police officer, he shall be punishable with imprisonment for a term which may extent to one month, or with fine which may extend to five hundred rupees, or with both.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 159 provides for punishment for driver or conductor of any vehicle on the premises of a railway for disobeying direction given by the railway servant.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section159