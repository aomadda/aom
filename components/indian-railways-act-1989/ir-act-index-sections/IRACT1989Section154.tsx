          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                154. Endangering safety of persons traveling by railway by rash of negligent act or omission
              </h2>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any person in rash and negligent manner does any act, or omits to do what he is legally bound to do, and the act of omission is likely to endanger the safety of any person traveling or being upon any railway, he shall be punishable with imprisonment for a term which may extend to one year, or with fine of with both.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 153 and 154 respectively provide for punishment for endangering safety of persons traveling by railway by willful act or omission or negligent act or omission.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section154