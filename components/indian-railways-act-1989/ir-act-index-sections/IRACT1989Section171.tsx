                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Nothing in Sec. 169 or 170 shall precluded the Central Government from resorting to any other action to compel a non-Government railway to discharge any obligation imposed upon it by or under this Act.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 169, 170 and 171 provide for levy of penalty on non-Government railways, mode of recovery of the penalty and that levy of penalty shall not preclude the Central Government from restoring to any other action against such railway.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section171