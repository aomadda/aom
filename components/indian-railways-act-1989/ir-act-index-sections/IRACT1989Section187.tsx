            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Restriction on execution against railway property</span>
                </div>
              </h2>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          No rolling stock, machinery, plant, tools, fittings, materials or effects used or provided by a railway administration for the purpose of traffic on its railway, or of its station or workshop, shall be liable to be taken in execution of any decree or order of any court or of any local authority or person having by law the power to attach or distrain property or otherwise to cause property to be taken in execution, without the pervious sanction of the Central Government.
                        </span>
                      </div>
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          Nothing in sub-section (1) shall be construed to affect the authority of any court to attach the earnings of a railway in execution of a decree or order.
                        </span>
                      </div>
                    </div>
                  </div>
...
export default IRACT1989Section187