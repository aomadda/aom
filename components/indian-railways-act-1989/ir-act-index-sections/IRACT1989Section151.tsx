                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                          If any person, with intent to cause or knowing that he is likely to cause damage or destruction to any property of a of a railway referred to in sub-section (2), causes by fire, explosive substance or otherwise, damage to such property or destruction of such property, he shall be punishable with imprisonment for term which may extend to five years, or with fine, or with both.
                        </p>
                      </div>
                      <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 150 and 152 respectively provide for punishment for maliciously wrecking or attempting to wreck a train for causing any damage or destruction of railway property.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section151