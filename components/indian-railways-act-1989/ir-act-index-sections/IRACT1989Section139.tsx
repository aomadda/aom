                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        any person falling or refusing to pay the fare and the excess charge referred t in Sec. 138 may be removed by any railway servant authorized in this behalf who may call to his aid any other person to effect such removal.
                      </p>
                      <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/10">
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          Provided that nothing in this section shall be deemed to prcelude a person removed from a carriage of a higher class from continuing his journey in a carriage of a class for which he holds a pass or ticket.
                        </p>
                      </div>
                      <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/10">
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 139 empowers the railway servant to remove persons from railway on failure or refusal to [ay fare and excess charge.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section139