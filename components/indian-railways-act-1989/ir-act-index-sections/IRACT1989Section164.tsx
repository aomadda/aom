          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                ...
                164. Unlawfully bringing dangerous goods on a railways
              </h2>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any person, in contravention of Sec. 67, takes with him any dangerous goods or entrusts such goods for carriage to the railway administration, he shall be punishable with imprisonment for a term which m ay extended to three years, or with fine which may extended to one thousand rupees or with both and shall also be liable for any loss, injury or damage which may be caused by reason of bringing such goods on railway.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section164