            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Lien for freight or any other sum due.-</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    ...
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed mt-4 text-center">
                      Such consignment or part thereof, as may be necessary to realize a sum equal to the freight or other charges:
                    </p>
                    <div className="bg-white/5 rounded-lg p-3 border-l-4 border-cyan-400 mt-4">
                      ...
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        where a railway administration for reasons to be recorded in writing is of the opinion that it is not expedient to hold the auction, such consignment or part thereof may be sold in such manner as may be prescribed.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The railway administration may, shall give a notice of not less than seven days of the public auction under Cl. (b) of sub-section (2) in one or ,ore local news papers or where there are no such manner as may be prescribed.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 83 provides for detention of consignment, part thereof or any other consignment of a person from whom any charges are recoverable by a railway administration and the manner of disposal of such consignment and rendering thje surplus of sale proceeds to the person entitled thereto.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section83