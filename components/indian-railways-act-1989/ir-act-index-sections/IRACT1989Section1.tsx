      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-cyan-300 mb-4">Railway Administration</h2>
            <div className="w-24 h-1 bg-linear-to-r from-blue-500 to-purple-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Preliminary provisions covering the short title, commencement, and foundational aspects of the Railway Act, 1989.
            </p>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Short title and Commencement</span>
                </div>
              </h2>
                ...
                <ul className="space-y-6">
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      <span className="font-semibold text-cyan-200">This Act may be called the Railway Act, 1989.</span>
                    </span>
                  </li>
                  <li className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      <span className="font-semibold text-cyan-200">Shall come into force on such date as the Central Government may, by notification in the Official Gazette, appoint :</span>
                      <div className="mt-3 p-4 bg-linear-to-br from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-400/30">
                        <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                          <span className="font-semibold text-purple-300">Provided that</span> different dates may be appointed for different provisions of this Act, and any reference in any such provision to the commencement on this Act shall be constructed as a reference to the coming into force of that provision.
                        </p>
                      </div>
                    </div>
                  </li>
                ...
                <div className="flex items-center justify-center flex-col gap-4 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                  <div className="flex-1">
                    <p className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The act came into force <span className="font-semibold text-orange-300">w.e.f. July 1, 1990</span> vide Noti. No. <span className="font-semibold text-orange-300">S.O. 475(E)</span> dated <span className="font-semibold text-orange-300">12th June 1990</span>.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Indian Railways Act 1989 - Chapter I
            </p>
          </div>
        </div>
      </div>
...
export default IRACT1989Section1