                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any person, in contravention of Sec. 67, takes with him any offensive goods entrusts such goods for carriage to the railway administration, he shall be punishable with fine which may extend to five hundred rupees and shall also be liable for any loss, injury or damage which may be caused by reason of bringing such goods on a railway.
                      </p>
                    </div>
                  </div>
...
export default IRACT1989Section165