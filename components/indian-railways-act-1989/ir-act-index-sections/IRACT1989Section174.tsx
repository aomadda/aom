                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any railway servant (whether on duty of otherwise) or any other person obstructs or causes to be obstructed or attempts to obstruct any train or other rolling stock upon a railway, -
                      </p>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <p className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                            by tampering with, disconnecting or interfering in any other manner with its hose pipe or tampering with signal gear or otherwise, he shall be punishable with imprisonment for a term which may extend to two years, or with fine which may extend to two thousand rupees or with both.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 174 provides for punishment for any person including a railway servant for causing obstruction to trains.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section174