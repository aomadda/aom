                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any passenger or any other person, after being warned by a railway servant to desist, persist in traveling on the roof, step or foot-board of any carriage or on an engine, or in any other part if a train not intended for the use of passengers, he shall be punishable with imprisonment fir a term which may extend to three months, or with the which may extend to five hundred rupees, or with both and may be removed from the railway by any railway servant.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 156 provides for punishment for traveling on roof, steps or engine of a train.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section156