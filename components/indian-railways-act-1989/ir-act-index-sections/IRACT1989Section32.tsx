            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Power of railway administration to charge certain rates,</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <p className="text-gray-200 lg:text-base text-sm leading-relaxed mb-4">
                      Notwithstanding anything continues I this Chapter, a railway administration may, in respect of the carriage of any commodity and subject to such conditions as may be specified,-
                    </p>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30 mt-6">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 32 empowers a railway administration to charge station to station rate, increase, reduce or cancel such rates and withdraw, alter or amend the conditions attached to such rate and to charge any lump-sum rate.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section32