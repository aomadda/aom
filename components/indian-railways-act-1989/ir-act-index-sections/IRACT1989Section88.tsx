                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                      ...
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        &quot;essential commodity&quot; means an essential commodity as defined in Cl. (a) of Sec. 2 of the Essential Commodities Act, 1955 (10 of 1955)
                      </span>
                    </div>
                    <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                      ...
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        &quot;notified station &quot; means a station declared to be a notified station under Sec. 89 ;
                      </span>
                    </div>
                    <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                      <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-10 lg:h-10 w-8 h-8 rounded-full flex items-center justify-center font-bold lg:text-lg text-base shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                      ...
                      <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                        &quot;State Government&quot; in relation to a notified station, means the government of the State in which such station is situated, or where such station is situated in a Union territory, the administration of that Union territory appointed under Art. 239 of the Constitution.
                      </span>
                    </div>
                  </div>
...
export default IRACT1989Section88
