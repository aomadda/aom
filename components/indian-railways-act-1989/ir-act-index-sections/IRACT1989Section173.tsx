                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        If any railway servant, when on duty, is entrusted with any responsibility connected with the running of a train, or of any other rolling stock from one station or place to another station or place, and he abandons his duty before reaching such station or place without authority or without properly handing over such train or rolling stock to another authorized railway servant, he shall be punishable with imprisonment for a term which may extend to two years, or with fine which may extend to one thousand rupees, or with both.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 173 provides for punishment for a railway servant on duty for abandoning train without authority.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section173