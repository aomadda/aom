            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Extent of liability in respect of goods carried in open wagon</span>
                </div>
              </h2>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Doctrine of promissory estoppel, cannot be applied in teeth of an obligation or liability imposed by law. – The doctrine of promissory estoppel cannot be invoked foe preventing the Government from acting in discharge of its duty under the law. The doctrine of promissory estoppel cannot be applied in teeth of an obligation or liability imposed by law.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Doctrine of estoppel, applies when there is clear and unequivocal promise. – The doctrine of promissory estoppel applies when, inter alia, there is a clear and unequivocal promise relying on which the other act was to his prejudice.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section104
