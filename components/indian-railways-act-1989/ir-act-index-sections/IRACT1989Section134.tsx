                ...
                <div className="space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                    <div className="flex-1 space-y-4">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Nothing in this chapter or the rules made there under shall, where due provision has been made for the relief of a railway servant, authorise him to leave his duty until he has been relieved.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3 ml-9">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Ssection 134 lays down that a railway servant shall remain on duty until he is relieved.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section134