            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Maximum carrying capacity for wagons and trucks.</span>
                </div>
              </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      The gross weight of every wagon of truck bearing on the axles when the wagon of truck is loaded to its maximum carrying capacity shall not exceed such limit as may be fixed by the Central Government for the class of axle under the wagon or truck.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      Subject to the limit fixed under sub0section 91) every railway administration shall determine the normal carrying capacity for every wagon or truck in its possession and shall exhibit in words and figures the normal carrying capacity so determined in a conspicuous manner on the outside of every such wagon or truck.
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      Every person owning a wagon or truck which passes over a railway shall determine and exhibit the normal carrying capacity for the wagon or truck in the manner specified in sub-section.
                    </span>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 72 empowers the Central Government to fix the maximum carrying capacity of a wagon or truck.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section72