                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                        ...
                        <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                          &quot;accident&quot; means an accident of the nature described in Sec.124:
                        </span>
                      </div>
                      <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300 border border-white/10">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                            ...
                            <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                              the wife, husband , son and daughter, and in case the deceased passenger is unmarried or is a minor, his parent:
                            </span>
                          </div>
                          <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                            ...
                            <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                              the parent, minor brother or unmarried sister, widowed sister, widowed daughter-in-law and a minor child or a predeceased son, if dependent wholly or partly on ;lthe deceased passenger:
                            </span>
                          </div>
                          <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                            <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                            ...
                            <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                              a minor child of a pre-deceased daughter, if wholly dependent on the deceased passenger:
                            </span>
                          </div>
                          <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                            <span className="bg-linear-to-br from-cyan-500 to-blue-600 text-white lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center font-bold lg:text-sm text-xs shadow-lg ring-2 ring-cyan-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                        ...
                        <div className="space-y-3">
                          <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/10">
                            <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300 mb-3">
                              ...
                              <span className="text-gray-200 lg:text-base text-sm leading-relaxed pt-1">
                                (i) the commission of a terrorist act within the meaning of sub-section (1) of sec. 3 of the Terrorist and Disruptive Activities (Prevention)Act,1987 (28 of 1987), or
                              </span>
                            </div>
                            <div className="space-y-2">
                              <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                                <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-6 lg:h-6 w-5 h-5 rounded-full flex items-center justify-center font-bold lg:text-xs text-[10px] shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                                  i
                                </span>
                                <span className="text-gray-200 lg:text-sm text-xs leading-relaxed pt-1">
                                  the commission of a terrorist act within the meaning of sub-section (1) of sec. 3 of the Terrorist and Disruptive Activities (Prevention)Act,1987 (28 of 1987), or
                                </span>
                              </div>
                              <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                                <span className="bg-linear-to-br from-cyan-500 to-blue-600 text-white lg:w-6 lg:h-6 w-5 h-5 rounded-full flex items-center justify-center font-bold lg:text-xs text-[10px] shadow-lg ring-2 ring-cyan-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                                  ii
                                </span>
                                <span className="text-gray-200 lg:text-sm text-xs leading-relaxed pt-1">
                                  the making of violent attack or the commission of robbery or dacoity; or
                                </span>
                              </div>
                              <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-2 rounded-lg transition-all duration-300">
                                <span className="bg-linear-to-br from-blue-500 to-cyan-600 text-white lg:w-6 lg:h-6 w-5 h-5 rounded-full flex items-center justify-center font-bold lg:text-xs text-[10px] shadow-lg ring-2 ring-blue-400/50 shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                            ...
                            <p className="text-gray-200 lg:text-base text-sm leading-relaxed mt-3 text-center">
...
export default IRACT1989Section123
