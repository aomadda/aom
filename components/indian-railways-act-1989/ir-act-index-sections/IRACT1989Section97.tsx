            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Goods carried at owner&apos;s risk rate. –</span>
                </div>
              </h2>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                            where the whole of such consignment or the whole of nay package forming part of such consignment is not delivered to the consignee or the endorsee and such non-delivery is not provided by the railway administration to have been due to fire or to any accident to the train ; or
                          </span>
                        </div>
                        <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                          ...
                          <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                            where in respect of any such consignment or of any package forming part of such consignment which had been so covered or protected that the covering or protection was not readily removable by hand, it is pointed out to the railway administration on or before delivery that any part of the consignment or package had been pilfered in transit, the railway administration shall be bound to disclose the consignor, the consignee or the endorsee how the consignment or the package was dealt with throughout the time it was in its possession or control, but if negligence or misconduct on the part of the railway administration or of any of the servants cannot be fairly inferred from such disclosure, the burden of proving such negligence or misconduct shall lie on the consignor, the consignee or the endorsee.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-linear-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Section 97 absolves a railway administration from responsibility in the absence of negligence or misconduct on its part for any loss, destruction, etc. of the consignment carried at owners risk rate.
                      </p>
                      <p className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        Question of impleading the parties – procedure of – it is well settled law that the question of impleading the parties can be entertained only before the original Court and not before the Appellate Court.
                      </p>
                    </div>
                  </div>
                </div>
...
export default IRACT1989Section97
