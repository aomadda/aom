            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <div className="flex items-center justify-center flex-col gap-3">
                  ...
                  <span className="text-center">Provisions for case in which ticket is issued for class or train not having accommodation.</span>
                </div>
              </h2>
              <div className="bg-linear-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center flex-col gap-3 group hover:bg-white/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed pt-1">
                      If no accommodation is available in the class of carriage for which a ticket is issued, and the holder thereof travels in a carriage of a lower class, he shall, on returning such ticket, be entitled to a refund of the difference between the fare paid and the fare payable for the class of carriage in which he travels.
                    </span>
                  </div>
                </div>
              </div>
...
export default IRACT1989Section51